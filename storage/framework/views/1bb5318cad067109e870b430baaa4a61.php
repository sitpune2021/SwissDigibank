...
<body class="vertical bg-secondary/5 ">
    ...
    <div class="relative min-h-screen bg-secondary/5 ">
        <img src="<?php echo e(asset('assets/images/ellipse1.png')); ?>" class="absolute top-16 md:top-5 ltr:right-10 rtl:left-10" alt="ellipse" />
        <img src="<?php echo e(asset('assets/images/ellipse2.png')); ?>"
            ...
            <div class="relative z-[2] max-w-[1416px] mx-auto px-3 pb-10">
                <div
                    ...
                    <div class="col-span-12 lg:col-span-6">
                        <div
                            ...
                            <div class="max-w-[400px] mx-auto box  rounded-xl border dark:border-n500 p-6 lg:p-8">
                                <img src="<?php echo e(asset('assets/images/qrcode.png')); ?>" class="qrcode-img" width="336" height="349"
                                    alt="qrcode" />
                            </div>
                    ...
                    <div class="col-span-12 lg:col-start-8 lg:col-span-5">
                        <img src="<?php echo e(asset('assets/images/auth.png')); ?>" alt="img" width="533" height="560" />
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views\authentication\signin-qrcode.blade.php ENDPATH**/ ?>