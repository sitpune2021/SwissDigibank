    ...
    <div class="main-inner">
        <div class="mb-6 flex flex-wrap items-center  justify-between gap-4 lg:mb-8">
            <div class="flex items-start flex-col  gap-2">
                ...
                LOAN AGAINST DEPOSITE - AUDDIT TRAIL
                </h1>
            </div>
        </div>
  ...
  <div class="grid grid-cols-1 gap-6">
    ...
    <div class="bg-white shadow-md rounded overflow-hidden p-2">
      ...
      <div class="flex items-center justify-between rounded-10 bg-secondary/5 px-4 py-3 cursor-pointer"
        ...
        <h3 class="text-lg text-black font-semibold">LOAN AGAINST DEPOSITE ACCOUNT AUDIT TRAIL</h3>
    ...
    <div class="bg-white shadow-md rounded p-2 overflow-hidden">
      ...
      <div class="flex items-center justify-between rounded-10 bg-secondary/5 px-4 py-3 cursor-pointer"
           onclick="this.nextElementSibling.classList.toggle('hidden')">
        <h3 class="text-lg font-semibold">LOAN AGAINST DEPOSITE APPLICATION AUDIT TRAIL</h3>
