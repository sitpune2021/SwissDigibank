      ...
      <div class="col-span-2 md:col-span-1 bg-white dark:bg-bg3 rounded-2xl p-6">
        <form id="loanForm" action="{{ route('loanagainst.calculator.calculate') }}" method="POST" target="_blank" class="space-y-6">
          ...
          <div id="interestOptions" style="display:none; margin-top:10px;">
              ...
              <!-- Checkbox 2 -->
              <div class="flex gap-2 items-center mt-3" id="chk_first_box">
                <label class="flex items-center gap-2 mt-2" >
                  <input type="checkbox" name="option_interest_first" id="option_interest_first" value="1" class="w-42 px-2" style="height: 20px !important; width: 20px !important;">
          ...
          <div id="ratioFields" style="display:none; margin-top:10px;">
              ...
              <div class="flex gap-3">
                  <input type="number" id="emi_ratio_1" class="w-full bg-secondary/5 rounded-10 border p-2" min="1">
                  <input type="number" id="emi_ratio_2" class="w-full bg-secondary/5 rounded-10 border p-2 bg-gray-100" readonly>
              </div>
              ...
              <div class="flex gap-3">
                  <input type="number" id="amt_ratio_1" class="w-full bg-secondary/5 rounded-10 border p-2" min="1" max="100">
                  <input type="number" id="amt_ratio_2" class="w-full bg-secondary/5 rounded-10 border p-2 bg-gray-100" readonly>
              </div>
          ...
          <p id="emiRatioError" class="text-red-600 text-sm mt-1 hidden">
           ...
           <!-- Buttons -->
          <div class="flex justify-center mt-4 gap-4 mt-5 pt-6">
          ...
          <div class="overflow-x-auto">
            <table class="w-full text-sm text-left">
              <tbody>
                ...
                <tr class="border-b"><td class="font-semibold uppercase py-2 pr-4">Maximum Loan Limit Against Security</td><td class="py-2" id="schemeLimit">-</td></tr>
                <tr class="border-b"><td class="font-semibold uppercase py-2 pr-4">Minimum Loan Amount</td><td class="py-2" id="schemeMin">-</td></tr>
