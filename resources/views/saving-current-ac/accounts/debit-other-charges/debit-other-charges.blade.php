...
<div class="main-inner">
        ...
        <div class="flex items-start flex-col gap-2">
            <div class="flex items-center gap-2">
                <h3 class="uppercase font-semibold">
                    Saving Account - {{$account->account_no}}
                </h3>
            </div>
        </div>
    </div>
    ...
    <div class="flex flex-col  dark:bg-bg3 lg:flex-row justify-between mt-7 gap-5">
        <div class=" w-full  box overflow-hidden">
            <form action="{{route('storeOtherCharges',$account->id)}}" method="post">
                @csrf
        ...
        <div class=" w-full  overflow-hidden">
            ...
            <div class="box bg-white dark:bg-bg3 border shadow-md rounded-lg">
                ...
                <div class="flex justify-between items-center px-4 py-2 bg-secondary/5 text-black rounded-10">
                    <h3 class="text-black uppercase font-semibold text-lg">Saving Account Info</h3>
                    ...
                    <table class="w-full text-sm whitespace-nowrap text-gray-700 rounded-md">
                        <tbody>
                            <tr class="border-b border-gray-200">
                                ...
                                <td class="px-3 py-2">{{$account->members->member_info_first_name??''}}</td>
                            </tr>
                            <tr class="border-b border-gray-200">
                                <td class="uppercase font-semibold px-3 py-2">Pan No</td>
                                <td class="px-3 py-2">{{$account->members->kyc->member_kyc_pan_no??''}}</td>
                            </tr>
                            <tr class="border-b border-gray-200">
                                <td class="uppercase font-semibold px-3 py-2">Joint Account</td>
                                <td class="px-3 py-2">
                            ...
                            <tr class="border-b border-gray-200">
                                <td class="uppercase font-semibold px-3 py-2">Account No</td>
                            ...
                            <tr class="border-b border-gray-200">
                                ...
                                <td class="px-3 py-2">{{$account->open_date??''}}</td>
                            </tr>
                            <tr class="border-b border-gray-200">
                            ...
                            <tr class="border-b border-gray-200">
                                <td class="uppercase font-semibold px-3 py-2">Lock Balance (A)</td>
                                <td class="px-3 py-2">
                                    {{$account->scheme->lock_in_balance??''}}
                                </td>
                            </tr>
                            <tr class="border-b border-gray-200">
                                <td class="uppercase font-semibold px-3 py-2">Hold Balance (B)</td>
                                <td class="px-3 py-2">

                                </td>
                            </tr>
                            <tr class="border-b border-gray-200">
                                <td class="uppercase font-semibold px-3 py-2">Available Balance (C)</td>
                                <td class="px-3 py-2">

                                </td>
                            </tr>
                            <tr class="border-b border-gray-200">
                                <td class="uppercase font-semibold px-3 py-2">Sweep In Balance (D)</td>
                                <td class="px-3 py-2">

                                </td>
                            </tr>
                            <tr class="border-b border-gray-200">
                                <td class="uppercase font-semibold px-3 py-2">Combined Balance (A + B + C + D)</td>
                                <td class="px-3 py-2">

                                </td>
                            </tr>
                            <tr class="border-b border-gray-200">
                                <td class="uppercase font-semibold px-3 py-2">Branch Name</td>
                                <td class="px-3 py-2">
