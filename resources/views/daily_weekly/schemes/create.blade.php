        ...
        <div class="box">
            <div class="col-span-12  lg:col-span-12">
                <form class="grid grid-cols-2 gap-4 mt-6"
                    action="{{ isset($scheme) ? route('daily_weekly.schemes.update', $scheme->id) : route('daily_weekly.schemes.store') }}"
                    method="POST">
                    @csrf
                    @if (isset($scheme))
                        @method('PUT')
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        @php
                            $selectedValue = strtolower(old('gold_loan_setting', $scheme->gold_loan_setting ?? ''));
                        @endphp

                        <select name="gold_loan_setting"
                            class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 py-3">
                            ...
                            <option value="monthly" {{ $selectedValue == 'monthly' ? 'selected' : '' }}>MONTHLY</option>
                        </select>
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <input type="number" id="no_of_emi" name="no_of_emi"
                            value="{{ old('no_of_emi', $scheme->no_of_emi ?? '') }}"
                            class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-2 md:py-3"
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <input type="number" id="emi_amount" name="emi_amount"
                            value="{{ old('emi_amount', $scheme->emi_amount ?? '') }}"
                            class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-2 md:py-3"
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <select name="overdue_type" id="overdue_type"
                                ...
                                <option value="TYPE_1"
                                    {{ old('overdue_type', $scheme->overdue_type ?? '') == 'TYPE_1' ? 'selected' : '' }}>
                                    TYPE_1</option>
                                <option value="TYPE_2"
                                    {{ old('overdue_type', $scheme->overdue_type ?? '') == 'TYPE_2' ? 'selected' : '' }}>
                                    TYPE_2</option>
                            </select>
                            <!-- Main Input -->
                            <input type="number" id="overdue_rate" name="overdue_rate"
                                value="{{ old('overdue_rate', $scheme->overdue_rate ?? '') }}"
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <input type="number" id="fitness_fee" name="fitness_fee"
                                    value="{{ old('fitness_fee', $scheme->fitness_fee ?? '') }}"
                                    class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-3 md:py-3"
                                    placeholder="Enter Fore Closure Charges">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <input type="number" id="credit_period" name="credit_period"
                                    value="{{ old('credit_period', $scheme->credit_period ?? '1') }}"
                                    class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-3 md:py-3"
                                    placeholder="Enter Fore Closure Charges">
                            </div>
                        </div>
