...
class DdsAccountsController extends Controller
{
    ...
    {
        try {
            Log::info('DDS Store request started', ['data' => $request->all()]);
            ...
            Log::info('Installments calculated', ['installments' => $installments]);
            ...
            Log::info('Bonus calculated', ['bonusRate' => $bonusRate, 'fixedBonus' => $fixedBonus]);
            ...
            Log::info('Maturity calculation completed', ['calculation' => $calculation]);
