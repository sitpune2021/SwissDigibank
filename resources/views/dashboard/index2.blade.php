                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="flex justify-center">
                                        <img src="{{ asset('assets/images/my-wallet-1.png') }}" width="296"
                                            class="rounded-xl" height="200" alt="card img" />
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="flex justify-center">
                                        <img src="{{ asset('assets/images/my-wallet-2.png') }}" width="296"
                                            class="rounded-xl" height="200" alt="card img" />
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="flex justify-center">
                                        <img src="{{ asset('assets/images/my-wallet-3.png') }}" width="296"
                                            class="rounded-xl" height="200" alt="card img" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <tr class="even:bg-secondary/5 dark:even:bg-bg3">
                                    ...
                                    <td class="px-6 py-2">
                                        <div class="flex items-center gap-3">
                                            <img src="{{ asset('assets/images/paypal.png') }}" width="32"
