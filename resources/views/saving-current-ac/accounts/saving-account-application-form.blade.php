...
@section('content')
  ...
  <div class="main-inner">
    ...
    <div class="text-center flex justify-center gap-5 mt-4">
      <a href="{{ route('account.print', base64_encode($account->id)) }}" class="px-4 py-2 btn-primary uppercase"
        target="_blank">
      ...
      <div class="form-container">
        ...
        <div style="width:100%; font-family: dejavusans; border-bottom: 2px solid #000 ; padding: 5px;">
          ...
          <div style="float:left; width:30%; text-align:left;">
            <img src="{{asset('assets/images/SBC_Logo_gpg.jpg') }}" alt="logo" style=" width:auto; height:50px;">
            {{-- @if($logo) --}}
        ...
        <table>
          ...
          <td style="width: 20%;  border: 1px solid #000;vertical-align: top; ">
            {{$account->members->kyc->member_kyc_pan_no ?? ''}}</td>
          <td colspan="2"></td>
    ...
    'checked' : '' }}> : Yearly
            ...
            <td>
              <label style="display:flex; align-items:center;">
                <input type="checkbox" style="width: 20px; height: 20px;" {{ !in_array(
