    ...
    <div class="box col-span-12 lg:col-span-6">
        ...
        <div class="overflow-x-auto pb-4 lg:pb-6">
            <table class="w-full whitespace-nowrap select-all-table" id="transactionTable1">
                ...
                <tbody>
                    ...
                    <tr class="even:bg-secondary/5 dark:even:bg-bg3">
                        <td class="py-2"><?php echo e($s=$s+1); ?></td>
                        <td class="py-2">
                            <div>
                                <p class="font-medium mb-1"><?php echo e($company->company_name); ?></p>
                                <!-- <span class="text-xs"><?php echo e(\Carbon\Carbon::parse($company->created_at)->format('d M, y h:i A')); ?></span> -->
                            </div>
                        </td>
                        <td class="py-2"><?php echo e($company->contact_email); ?></td>
                        <td class="py-2"><?php echo e($company->mobile_no); ?></td>
                        <td class="py-2"><?php echo e($company->city); ?></td>
                        <td class="py-2"> <?php echo e($company->stateData->name ?? ''); ?></td>
                        <td class="py-2">
                            <div class="flex justify-center">
                                <a href="<?php echo e(route('company.view', $company->id)); ?>" class="border-green-500 text-green-500 hover:bg-green-500 hover:text-white rounded-full transition duration-150"><i class="las la-eye"></i></a>
                                <a href="<?php echo e(route('company.edit', $company->id)); ?>" class="border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white rounded-full transition duration-150"><i class="las la-edit"></i></a>
                                <form action="<?php echo e(route('company.delete', $company->id)); ?>" method="POST" style="display:inline-block;">
                                    <?php echo csrf_field(); ?>
        ...
        <div class="flex col-span-12 gap-4 sm:justify-between justify-center items-center flex-wrap">
            <ul class="flex gap-2 md:gap-3 flex-wrap md:font-semibold items-center">
                ...
                <?php else: ?>
                <li>
                    <a href="<?php echo e($companies->previousPageUrl()); ?>"
                ...
                <?php for($i = 1; $i <= $companies->lastPage(); $i++): ?>
                    <?php if($i == $companies->currentPage()): ?>
                    <li>
                        <button
                    ...
                    <?php else: ?>
                    <li>
                        <a href="<?php echo e($companies->url($i)); ?>"
                    ...
                    <li>
                        <a href="<?php echo e($companies->nextPageUrl()); ?>"
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views\company-profile\manage-profile.blade.php ENDPATH**/ ?>