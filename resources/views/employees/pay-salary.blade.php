                ...
                <div class="box dark:bg-bg3 border mb-4 border-gray-200 shadow-md rounded-lg">
                    <form action="">
                            ...
                            <div class=" ">
                                <div class="">
                                    <label for="" class="flex  items-center space-x-2 cursor-pointer">
                                        ...
                                        <span class="p-2"> ( Check this if you want to pay advance )</span>
                                    </label>
                                </div>
                       ...
                       <div class="col-span-2 md:col-span-1 mb-2">
                        ...
                        <x-paymode :amount="$misaccount->amount ?? ''" :showSaving="true" id="amount"
                                        :readonly="false" :amountClass="true" :bgColor="false" :hiddenheading="true"
                                        :checkedDefault="'cash'" groupName="disburse_Mode" />
                        <!-- Buttons -->
