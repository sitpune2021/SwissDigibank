...
<div class="main-inner">
    ...
    <div class="flex flex-col  dark:bg-bg3 lg:flex-row justify-between mt-7 gap-5">
        ...
        <div class=" w-full  box overflow-hidden">
            ...
            <div class="col-span-2 md:col-span-1 mb-4 border-b">
                <p class="uppercase text-lg font-semibold"> Link member saving account to loan for auto debit EMI on due date</p>
            </div>

            <form action="{{ route('gold-loan.account.storeSavingAccount', $goldLoan->id) }}" method="POST">
            @csrf
