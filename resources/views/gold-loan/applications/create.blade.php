        ...
        <div class="mb-6 flex flex-wrap items-center  justify-between gap-4 lg:mb-8">
            <div class="flex items-start flex-col  gap-2">
                ...
                <h1 class="text-xl font-semibold">
                    {{ isset($application) ? 'UPDATE GOLD LOAN APPLICATION' : 'NEW GOLD LOAN APPLICATION' }}</h1>
            </div>
        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-6 xl:mt-8 xxxxxl:gap-6">
                            ...
                            <div class="col-span-2 md:col-span-1">
                                ...
                                <select id="emi_collection" name="emi_collection"
                                    class="w-full text-sm bg-secondary/5 dark:bg-bg3 border rounded-10 px-3 md:px-6 py-2 md:py-3 mt-7 capitalize">
                                                        ...
                                                        @if (!empty($score->report_file))
                                                            ...
                                                            @if (in_array(strtolower($extension), ['jpg', 'jpeg', 'png', 'gif', 'webp']))
                                                                ...
                                                                <a href="{{ asset($filePath) }}" target="_blank">
                                                                    <img src="{{ asset($filePath) }}" alt="Credit Report"
                            ...
                            @if (isset($ornaments) && count($ornaments))
                                @foreach ($ornaments as $key => $item)
                                    <tr>
                                        ...
                                        <td class="px-2 py-2">
                                            <select name="item_type[]"
                                                ...
                                                <option {{ $item->item_type == 'Silver Coin' ? 'selected' : '' }}>Silver
                                                    Coin</option>
                                                <option {{ $item->item_type == 'Silver Biscuit' ? 'selected' : '' }}>
                                                    Silver Biscuit</option>
                                        ...
                                        <td class="px-2 py-2">
                                            <input type="number" name="value_per_gram[]"
                                        ...
                                        <td class="px-2 py-2">
                                            <input type="number" name="gross_weight[]"
                                                class="grossWeight w-full rounded px-2 py-2 border bg-secondary/5 text-center text-sm"
                                        ...
                                        <td class="px-2 py-2">
                                            <input type="number" name="tunch[]"
                                                class="tunch w-full rounded bg-secondary/5 px-2 py-2 border text-center text-sm"
                                                value="{{ $item->tunch }}">
                                        </td>
                                        <td class="px-2 py-2">
                                            <input type="number" name="fine_weight[]"
                                                class="fineWeight w-full rounded px-2 py-2 border bg-secondary/5 text-center text-sm bg-gray-100"
                                                value="{{ $item->fine_weight }}" readonly>
                                        </td>
                                        <td class="px-2 py-2">
                                            <input type="number" name="total_value[]"
                                                class="totalValue w-full rounded px-2 py-2 border bg-secondary/5 text-center text-sm bg-gray-100"
                                                value="{{ $item->total_value }}" readonly>
                                        </td>
                                        <td class="px-2 py-2">
                                            @if ($item->item_image)
                                                <a href="{{ asset('storage/' . $item->item_image) }}" target="_blank"
                                                    class="text-blue-600 underline block mb-1">View</a>
                                            @endif
                                            <input type="file" name="item_image[]"
                                                class="w-full rounded px-2 py-2 border bg-secondary/5 text-center text-sm">
                                        </td>
                                        <td class="px-2 py-2 text-center">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            calculateBtn.addEventListener("click", function(e) {
                ...
                if (!isCalculated) {
                    ...
                    rows.forEach(row => {
                        let valuePerGram = parseFloat(row.querySelector(".valuePerGram")?.value) ||
                            0;
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            schemeSelect.addEventListener("change", function() {
                ...
                loanAmountInput.addEventListener("input", function() {
                    let max = parseFloat(schemeSelect.options[schemeSelect.selectedIndex]
                        .getAttribute("data-max")) || 0;
                    let min = parseFloat(schemeSelect.options[schemeSelect.selectedIndex]
                        .getAttribute("data-min")) || 0;
