<?php $__env->startSection('content'); ?>
    <div class="main-inner">
        <div class="mb-6 flex flex-wrap items-center justify-between gap-4 lg:mb-8">
            <h3 class="h2"><?php echo e(isset($branch) ? (!empty($show) ? 'View' : 'Edit') : 'Add'); ?> Branch</h3>
            <?php if(isset($show) && $show): ?>
            <a href="<?php echo e(route('branch.edit', $encryptedId)); ?>"
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <?php if($type === 'select'): ?>
                            <select name="<?php echo e($name); ?>" id="<?php echo e($id); ?>"
                                class="w-full text-sm  bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-2 md:py-3" <?php echo e(empty($show) ? '' : 'disabled'); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-span-2 flex gap-4 md:gap-6 mt-4">
                    ...
                    <button class="btn-outline" type="reset"
                        onclick="window.location.href='<?php echo e(route('branch.index')); ?>'">Back</button>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views/company/branch/add-branch.blade.php ENDPATH**/ ?>