                        ...
                        <table class="w-full whitespace-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr key="Ben Abramov - Metal" class="even:bg-secondary/5 dark:even:bg-bg3">
                                    <td class="px-6 py-2">
                                        <div class="flex items-center gap-3">
                                            <img src="<?php echo e(asset('assets/images/card-sm-3.png')); ?>" width="60" height="40"
                                                class="rounded" alt="payment medium icon" />
                                            <div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views\dashboard\index4.blade.php ENDPATH**/ ?>