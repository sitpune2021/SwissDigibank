...
<div class="main-inner">
    ...
    <div class="box mb-4 xxxl:mb-6">
        <form action="{{route('promotor.update', $promoter->id)}}" method="POST" class="grid grid-cols-2 gap-4 xxxl:gap-6">
            @csrf
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input name="middle_name" id="middle_name" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter address line 1" value="{{$promoter->middle_name}}">
                    @error('middle_name')
                    <span class="text-red-500 text-xs">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="occupation" id="occupation" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter occupation" value="{{$promoter->occupation}}">
                    @error('occupation')
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="mother_name" id="mother_name" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter mother name" value="{{$promoter->mother_name}}">
                    @error('mother_name')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="spouse" id="spouse" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter Spouse" value="{{$promoter->husband_wife_name}}">
                    @error('spouse')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="landline_no" id="landline_no" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter branch landline no" value="{{$promoter->landline_no}}">
                    @error('landline_no')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="email" id="email" placeholder="Enter Email" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{$promoter->email}}">
                    @error('email')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="mobile_no" id="mobile_no" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter mobile no" value="{{$promoter->mobile}}">
                    @error('mobile_no')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="voter_no" id="voter_no" placeholder="Enter Voter ID No" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{$promoter->voter_id_no}}">
                    @error('voter_no')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="pan_no" id="pan_no" placeholder="Enter PAN No" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{$promoter->pan_no}}">
                    @error('pan_no')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="ration_no" id="ration_no" placeholder="Enter Ration Card No" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{$promoter->ration_card_no}}">
                    @error('ration_no')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="meter_no" id="meter_no" placeholder="Enter Meter No." class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{$promoter->meter_no}}">
                    @error('meter_no')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="ci_no" id="ci_no" placeholder="Enter CI No." class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ $promoter->ci_no }}">
                    @error('ci_no')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="ci_relation" id="ci_relation" placeholder="Enter CI Relation." class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ $promoter->ci_relation }}">
                    @error('ci_relation')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="dl_no" id="dl_no" placeholder="Enter DL No." class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{  $promoter->dl_no }}">
                    @error('dl_no')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="nomine_name" id="nomine_name" placeholder="Enter Nominee Name" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{  $promoter->nominee_name }}">
                    @error('nomine_name')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="nomine_relation" id="nomine_relation" placeholder="Enter Nominee Relation" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{  $promoter->nominee_relation }}">
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="nomine_mobile" id="nomine_mobile" placeholder="Enter Nominee Mobile" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ $promoter->nominee_mobile_no }}">
                    @error('nomine_mobile')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="nomine_aadhar" id="nomine_aadhar" placeholder="Enter Nominee Aadhar No." class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ $promoter->nominee_aadhaar_no }}">
                    @error('nomine_aadhar')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="nomine_voter" id="nomine_voter" placeholder="Enter Nominee Voter ID No." class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ $promoter->nominee_voter_id_no }}">
                    @error('nomine_voter')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="nomine_pan" id="nomine_pan" placeholder="Enter Nominee Pan No." class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ $promoter->nominee_pan_no }}">
                    @error('nomine_pan')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="nomine_address" id="nomine_address" placeholder="Enter Nominee Address" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ $promoter->nominee_address }}">
            ...
            <div class="col-span-2 flex gap-4 md:gap-6 mt-2">
                ...
                <button class="btn-outline" type="reset" onclick="window.location.href='{{ route('ManagePromotor') }}'">
                    Back
                </button>
