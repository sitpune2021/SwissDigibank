  ...
  <div class="form-container">
    ...
    <table style="width:100%; border-collapse:collapse;">
      <tr>
        ...
        <td style="width:33.33%; vertical-align:top;">
          <div style="width:100%;">
            <div style="float:left; width:25%;">
              <input type="checkbox" style="width:18px; height:18px;" {{ $account->account_type == 'single' ? 'checked'
              : '' }}>
            </div>
        ...
        <td style="width:33.33%; vertical-align:top;">
          <div style="width:100%;">
            <div style="float:left; width:25%;">
              <input type="checkbox" style="width:18px; height:18px;" {{ $account->account_type == 'joint' ? 'checked' :
              '' }}>
            </div>
            <div style="float:left; width:75%; padding-top:2px;">
              : Jointly
        ...
        <td style="width:33.33%; vertical-align:top;">
          <div style="width:100%;">
            <div style="float:left; width:25%;">
              <input type="checkbox" style="width:18px; height:18px;" {{ $account->account_type == 'either' ? 'checked'
              : '' }}>
            </div>
            <div style="float:left; width:75%; padding-top:2px;">
              : Either of Survivor
    ...
    <table style="width:100%; border-collapse:collapse;">
      <tr>
        ...
        <td style="width:20%; vertical-align:top;">
          <div style="width:100%;">
            <div style="float:left; width:25%;">
              <input type="checkbox" style="width:18px; height:18px;" {{ $account->interest_payout_type == 'monthly' ?
              'checked' : '' }}>
            </div>
            <div style="float:left; width:75%; padding-top:2px;">
              : Monthly
        ...
        <td style="width:20%; vertical-align:top;">
          <div style="width:100%;">
            <div style="float:left; width:25%;">
              <input type="checkbox" style="width:18px; height:18px;" {{ $account->interest_payout_type == 'Quarterly' ?
              'checked' : '' }}>
            </div>
            <div style="float:left; width:75%; padding-top:2px;">
              : Quarterly
        ...
        <td style="width:20%; vertical-align:top;">
          <div style="width:100%;">
            <div style="float:left; width:25%;">
              <input type="checkbox" style="width:18px; height:18px;" {{ $account->interest_payout_type == 'Half Yearly'
              ? 'checked' : '' }}>
            </div>
            <div style="float:left; width:75%; padding-top:2px;">
              : Half Yearly
        ...
        <td style="width:20%; vertical-align:top;">
          <div style="width:100%;">
            <div style="float:left; width:25%;">
              <input type="checkbox" style="width:18px; height:18px;" {{ $account->interest_payout_type == 'Yearly' ?
              'checked' : '' }}>
            </div>
            <div style="float:left; width:75%; padding-top:2px;">
              : Yearly
        ...
        <td style="width:20%; vertical-align:top;">
          <div style="width:100%;">
            <div style="float:left; width:25%;">
              <input type="checkbox" style="width:18px; height:18px;" {{ !in_array($account->interest_payout_type,
              ['monthly','Quarterly','Half Yearly','Yearly']) ? 'checked' : '' }}>
            </div>
            <div style="float:left; width:75%; padding-top:2px;">
              : End of Term
            </div>
    ...
    <div style="width:100%; font-size:12px; margin-top:12px;">
      ...
      <div style="float:left; width:22%; margin-right:1%;">
        <span style="display:inline-block; width:45%; font-weight:600;">Term of DD</span>
        <span style="display:inline-block; width:50%; border:1px solid #000; height:18px;"></span>
      </div>

      <!-- FD -->
      <div style="float:left; width:26%; margin-right:1%;">
        <span style="display:inline-block; width:40%; font-weight:600;">Term of FD</span>
        <span style="display:inline-block; width:55%; border:1px solid #000; height:18px;"></span>
      </div>
    ...
    {{-- <table>
      <tr>
        ...
        <td>
          <label style="display:flex; align-items:center;">
            <input type="checkbox" style="width: 20px; height: 20px;" {{ !in_array($account->interest_payout_type,
    ...
    <div class="declaration" style="">
      ...
      {{-- bank name --}}
      - {{ strtoupper( $account->scheme->scheme_name ?? '') }} scheme, the rules related to which/ we have read and
      understood and accept the rules of the scheme and agree to abide by any future amendments/ changes in the scheme.
      I/ We hereby declare that the amount deposited here with is not out of any funds acquired by me/us borrowing or
      accepting deposits from any other person. I/We declare that I/We are reside in India and am /are not depositing
      this amount as nominee(s) of any non resident. I/We declare that the forth named depositor should be treated as
      the pay purpose of deduction of tax under section 194A of the Income Tax Act, 1961. I/We have gone through the
      financial and other declarations furnished by company and after careful consideration I/ We am are making the
      deposit with the company at my/ our own risk and volition.
    </div>
