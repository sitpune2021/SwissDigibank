    ...
    <div class="main-inner">
        <div class="main-inner">
            ...
            <div class="box mb-4 xxxl:mb-6">
                <form action="<?php echo e(route('share-certificates.create')); ?>" method="POST"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-span-2 flex gap-4 md:gap-6 mt-2">
                        ...
                        <button class="btn-outline" type="reset"
                            onclick="window.location.href='<?php echo e(route('manage.promotor')); ?>'">
                            Back
                        </button>
                        <button class="btn-outline" type="reset">
                            Reset
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views\share-certificates\create.blade.php ENDPATH**/ ?>