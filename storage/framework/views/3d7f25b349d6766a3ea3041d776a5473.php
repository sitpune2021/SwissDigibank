        ...
        <div class="mb-6 flex flex-wrap items-center justify-between gap-4 lg:mb-8">
            ...
            <div>
                ...
                <ol class="breadcrumb flex text-sm text-gray-600 mt-1 space-x-1">
                    ...
                    <li><a href="<?php echo e(url('/manage-Share Certificate')); ?>" class="text-blue-600 hover:underline">Share Certificate</a></li>
                    <li class="text-gray-500">Manage Share Certificate</li>
                </ol>
            </div>
            <a href="<?php echo e(route('share-certificates.create')); ?>" class="btn-primary">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views\share-certificates\index.blade.php ENDPATH**/ ?>