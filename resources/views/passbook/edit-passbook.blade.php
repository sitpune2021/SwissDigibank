...
@section('content')
    <div class="main-inner">
        ...
        @endif
        <form method="POST" action="{{ route('passbook.update', $passbook->id) }}"
            ...
            <div class="grid grid-cols-2 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <select id="accountType" name="account_type"
                        ...
                        <option value="Current" {{ $passbook->account_type == 'Current' ? 'selected' : '' }}>Current
                        </option>
                        <option value="RD Accounts" {{ $passbook->account_type == 'RD Accounts' ? 'selected' : '' }}>RD
                            Accounts</option>
                        <option value="DD Accounts" {{ $passbook->account_type == 'DD Accounts' ? 'selected' : '' }}>DD
                            Accounts</option>
                        <option value="FD Accounts" {{ $passbook->account_type == 'FD Accounts' ? 'selected' : '' }}>FD
                            Accounts</option>
                        <option value="MIS Accounts" {{ $passbook->account_type == 'MIS Accounts' ? 'selected' : '' }}>MIS
                            Accounts</option>
                        <option value="DDS Accounts" {{ $passbook->account_type == 'DDS Accounts' ? 'selected' : '' }}>DDS
                            Accounts</option>

                        <option value="Gold Account" {{ $passbook->account_type == 'Gold Account' ? 'selected' : '' }}>Gold
                            Loan</option>
                        <option value="Property Account"
                            {{ $passbook->account_type == 'Property Account' ? 'selected' : '' }}>Property Loan</option>
                        <option value="Deposit Account"
                            {{ $passbook->account_type == 'Deposit Account' ? 'selected' : '' }}>Deposit Loan</option>
                        <option value="Business Account"
                            {{ $passbook->account_type == 'Business Account' ? 'selected' : '' }}>Business Loan</option>
                        <option value="CCOD Account" {{ $passbook->account_type == 'CCOD Account' ? 'selected' : '' }}>CCOD
                            Loan</option>
                        <option value="Daily / Weekly Account"
                            {{ $passbook->account_type == 'Daily / Weekly Account' ? 'selected' : '' }}>Daily / Weekly Loan
                        </option>
                        <option value="Personal Account"
                            {{ $passbook->account_type == 'Personal Account' ? 'selected' : '' }}>Personal Loan</option>
                        <option value="Vehicle Account"
                            {{ $passbook->account_type == 'Vehicle Account' ? 'selected' : '' }}>Vehicle Loan</option>
                        <option value="Fixed Account" {{ $passbook->account_type == 'Fixed Account' ? 'selected' : '' }}>
                            Fixed Loan</option>
                ...
                <div>
                    ...
                    <input type="text" name="account_no" value="{{ $passbook->account_no }}" readonly
                ...
                <div>
                    ...
                    <input type="text" id="date_pass" name="issue_date"
                ...
                <div>
                    ...
                    <input type="text" name="passbook_no" value="{{ $passbook->passbook_no }}"
                        class="w-full px-3 py-2 text-sm border bg-secondary/5 dark:bg-bg3 
