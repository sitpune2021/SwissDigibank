    ...
    <div class="main-inner">
        ...
        <div class="col-span-12 box lg:col-span-12">
            ...
            <div class="grid grid-cols-2 gap-4 mt-6 xl:mt-8 xxxxxl:gap-6">
                    ...
                    <select id="branch_id" name="branch_id"
                        ...
                        @foreach ($branches as $branch)
                            <option value="{{ $branch->id }}"
                                {{ (old('branch_id') ?? ($misaccount->branch_id ?? '')) == $branch->id ? 'selected' : '' }}>
                                {{ $branch->branch_name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <select name="advisor_id" id="advisor_id"
                        ...
                        <option value="1"
                            {{ old('advisor_id', $misaccount->advisor_id ?? '') == 1 ? 'selected' : '' }}>Rahul Mehra
                        </option>
                        <option value="2"
                            {{ old('advisor_id', $misaccount->advisor_id ?? '') == 2 ? 'selected' : '' }}>Priya Sharma
                        </option>
                        <option value="3"
                            {{ old('advisor_id', $misaccount->advisor_id ?? '') == 3 ? 'selected' : '' }}>Ankit Verma
                        </option>
                        <option value="4"
                            {{ old('advisor_id', $misaccount->advisor_id ?? '') == 4 ? 'selected' : '' }}>Neha Iyer
                        </option>
                        <option value="5"
                            {{ old('advisor_id', $misaccount->advisor_id ?? '') == 5 ? 'selected' : '' }}>Amit Joshi
                        </option>
                        <option value="6"
                            {{ old('advisor_id', $misaccount->advisor_id ?? '') == 6 ? 'selected' : '' }}>Sneha Reddy
                        </option>
                        <option value="7"
                            {{ old('advisor_id', $misaccount->advisor_id ?? '') == 7 ? 'selected' : '' }}>Ravi Kapoor
                        </option>
                        <option value="8"
                            {{ old('advisor_id', $misaccount->advisor_id ?? '') == 8 ? 'selected' : '' }}>Kavita Nair
                        </option>
                        <option value="9"
                            {{ old('advisor_id', $misaccount->advisor_id ?? '') == 9 ? 'selected' : '' }}>Arjun Desai
                        </option>
                        <option value="10"
                            {{ old('advisor_id', $misaccount->advisor_id ?? '') == 10 ? 'selected' : '' }}>
                            Pooja Singh</option>
                    </select>
                    @error('advisor_id')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    ...
                    <div class="flex items-center gap-6">
                        <label class="flex items-center gap-2">
                            <input type="radio" name="tds_deduction" value="yes"
                                {{ old('tds_deduction', $misaccount->tds_deduction ?? '') == 'yes' ? 'checked' : '' }}>
                            <span>Yes</span>
                        </label>

                        <label class="flex items-center gap-2">
                            <input type="radio" name="tds_deduction" checked value="no"
                                {{ old('tds_deduction', $misaccount->tds_deduction ?? '') == 'no' ? 'checked' : '' }}>
                            <span>No</span>
                        </label>
                    </div>
                        ...
                        <select name="joint_member_id"
                            ...
                            @foreach ($members as $member)
                                <option value="{{ $member->id }}" data-fullname="{{ $member->full_name }}"
                                    ...
                                    data-branch="{{ $member->general_branch }}"
                                    data-mobile="{{ $member->member_info_mobile_no ?? '' }}"
                                    {{ old('joint_member_id', $misaccount->joint_member_id ?? '') == $member->id ? 'selected' : '' }}>
                                    {{ $member->full_name }}
                                </option>
                            @endforeach
                        </select>
                            ...
                            <div class="flex-1 min-w-[200px]">
                                ...
                                <select name="nominee_relation[]"
                                    ...
                                    <option value="daughter"
                                        {{ $nominee->nominee_relation == 'daughter' ? 'selected' : '' }}>Daughter</option>
                                    <option value="spouse" {{ $nominee->nominee_relation == 'spouse' ? 'selected' : '' }}>
                                        Spouse (Husband/Wife)</option>
                                    <option value="husband"
                                        {{ $nominee->nominee_relation == 'husband' ? 'selected' : '' }}>Husband</option>
                                    <option value="wife" {{ $nominee->nominee_relation == 'wife' ? 'selected' : '' }}>
                                        Wife
                                    </option>
                                    <option value="brother"
                                        {{ $nominee->nominee_relation == 'brother' ? 'selected' : '' }}>Brother</option>
                                    <option value="sister" {{ $nominee->nominee_relation == 'sister' ? 'selected' : '' }}>
                                        Sister</option>
                                    <option value="daughter_in_law"
                                        {{ $nominee->nominee_relation == 'daughter_in_law' ? 'selected' : '' }}>
                                        Daughter in Law</option>
                                    <option value="brother_in_law"
                                        {{ $nominee->nominee_relation == 'brother_in_law' ? 'selected' : '' }}>
                                        Brother in Law</option>
                                    <option value="grand_daughter"
                                        {{ $nominee->nominee_relation == 'grand_daughter' ? 'selected' : '' }}>
                                        Grand Daughter</option>
                                    <option value="grand_son"
                                        {{ $nominee->nominee_relation == 'grand_son' ? 'selected' : '' }}>Grand Son
                                    </option>
            ...
            <div class="grid grid-cols-2 gap-4 mt-6 xl:mt-8 xxxxxl:gap-6">
                ...
                @endif
                <div class="col-span-2 md:col-span-1">
                    <x-datepicker-disabled label="T.Date" name="transaction_date" value="{{ old('transaction_date') }}"
