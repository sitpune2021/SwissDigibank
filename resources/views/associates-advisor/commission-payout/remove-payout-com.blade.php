        ...
        <div class="mb-6 flex flex-wrap items-center justify-between gap-4 lg:mb-8">
            <div class="flex items-center flex-row gap-2">
                <h3 class="text-xl font-semibold uppercase">     
                 Commission Payouts - Remove/ Delete
                </h3>
                ...
                <div class="box dark:bg-bg3 border mb-4 border-gray-200 shadow-md rounded-lg">
                    <div class="">
                        <p class="font-semibold text-lg uppercase">
                            Remove/ Delete commission for a particular account with in particular dates.
                        </p>
        ...
        <div class="box  ">
            <div class="bg-warning rounded-10 text-white p-3">
                ...
                <div class="font-semibold">
                    Remove commission will delete all the commission (self/ team/ coll. charge) for that account in the selected time period above and no data will be recovered once it is done.

                </div>

                <p class="mt-3 font-semibold"> 
                Don't select big date range, it will slow down system.
                </p>
            </div>
        </div>
