            ...
            <div class=" w-full  overflow-hidden">
                    ...
                    <div class="p-4 overflow-x-auto" id="cibilInfo">
                        <table class="w-full whitespace-nowrap text-sm text-left">
                            <thead class="bg-secondary/5 text-gray-700">
                                <tr>
                                    <th class="px-4 py-2 uppercase font-semibold">CIBIL Type</th>
                                    <th class="px-4 py-2 uppercase font-semibold">CIBIL Score</th>
                                    <th class="px-4 py-2 uppercase font-semibold">Report Date</th>
                                    <th class="px-4 py-2 uppercase font-semibold">View Report</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-200">
                ...
                <div class="box shadow-md dark:bg-bg3  mt-5 rounded-lg overflow-hidden">
                    ...
                    <div
                        ...
                        <h3 class="text-lg font-semibold uppercase">Security Deposits</h3>
                        <div class="">
                                        ...
                                        @if ($application->loanOrnaments->isNotEmpty())
                                            @foreach ($application->loanOrnaments as $ornament)
                                                <tr>
                                                    ...
                                                    <td class="px-3 py-2 text-center">{{ $ornament->no_of_items ?? '0' }}
                                                    </td>
                                                    <td class="px-3 py-2 text-center">
                                                        {{ number_format($ornament->value_per_gram, 2) }}</td>
                                                    <td class="px-3 py-2 text-center">
                                                        {{ number_format($ornament->gross_weight, 2) }}</td>
                                                    <td class="px-3 py-2 text-center">
                                                        {{ number_format($ornament->net_weight, 2) }}
                                                    </td>
                                                    <td class="px-3 py-2 text-center">
                                                        {{ number_format($ornament->tunch, 2) }}</td>
                                                    <td class="px-3 py-2 text-center">
                                                        {{ number_format($ornament->fine_weight, 2) }}
                                                    </td>
                                                    <td class="px-3 py-2 text-center">
                                                        {{ number_format($ornament->total_value, 2) }}
                                                    </td>
                                                    <td class="px-3 py-2 text-center">
                                                        @if (!empty($ornament->image_path))
                                                            <a href="{{ asset('storage/' . $ornament->image_path) }}"
                    ...
                    <div class="overflow-x-auto mt-5 " id="goldLoanSchemeInfo">
                        <table class="w-full border-collapse rounded-lg overflow-hidden  bg-white dark:bg-bg3">
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-600">
                                ...
                                <tr class="border-b">
                                    <td class="font-semibold px-4 py-2 uppercase">Interest Type</td>
                                    <td class="px-4 py-2 text-right md:text-left">
                                ...
                                <tr class="border-b">
                                    <td class="font-semibold px-4 py-2 uppercase">Interest Rate</td>
                                    <td class="px-4 py-2 text-right md:text-left">
