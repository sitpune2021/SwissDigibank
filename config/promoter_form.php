...
return [
    ...
    'promoter_info' => [
        ...
        ['label'=>'Occupation','name'=>'occupation','id'=>'occupation','type'=>'text','required'=>true],
        ['label'=>'Father Name','name'=>'father_name','id'=>'father_name','type'=>'text','required'=>true],
        ['label'=>'Mother Name','name'=>'mother_name','id'=>'mother_name','type'=>'text','required'=>true],
    ...
    // Step 4: Nominee Info
    'nominee_info' => [
        ['label'=>'Nominee Name','name'=>'nominee_name','id'=>'nominee_name','type'=>'text','required'=>true],
        ['label'=>'Nominee Relation','name'=>'nominee_relation','id'=>'nominee_relation','type'=>'text','required'=>false],
        ['label'=>'Nominee Mobile','name'=>'nominee_mobile_no','id'=>'nominee_mobile_no','type'=>'text','required'=>true],
