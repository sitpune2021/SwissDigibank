...
Route::get('/migrate/shareholdings', function () {
    Artisan::call('migrate', [
        '--path' => 'database/migrations/2025_07_12_173835_shareholdings_table.php',
        '--force' => true,
    ]);
...
Route::middleware('auth.user')->group(function () {
    ...
    // Company profile
    Route::get('CreateProfile', [CompanyController::class, 'create'])->name('create.profile');
    Route::get('ManageProfile', [CompanyController::class, 'index'])->name('manage.profile');
    ...
    Route::get('CompanyEdit', [CompanyController::class, 'edit'])->name('company.edit');
    Route::post('/CompanyUpdate', [CompanyController::class, 'update'])->name('company.update');
    // Route::delete('/company/{id}/delete', [CompanyController::class, 'destroy'])->name('company.delete');

    // Branch 
    Route::get('CreateBranch', [BranchController::class, 'create'])->name('create.branch');
    Route::get('ManageBranch', [BranchController::class, 'index'])->name('manage.branch');
    Route::post('AddBranch', [BranchController::class, 'store'])->name('add.branch');
    ...
    Route::get('CreatePromotor', [PromotorController::class, 'create'])->name('create.promotor');
    Route::post('AddPromotor', [PromotorController::class, 'store'])->name('add.promotor');
    ...
    Route::get('/GetMaritalStatuses', [PromotorController::class, 'getMariatalStatuses']);
    Route::get('/GetReligionStatuses', [PromotorController::class, 'getReligion']);
    ...
    // Directors
    Route::get('ManagerDirector', [DirectorController::class, 'index'])->name('ManagerDirector');
    ...
    Route::post('AddEmployee', [HRController::class, 'add'])->name('AddEmployee');
    Route::get('selectEmployee', [HRController::class, 'selectEmployee'])->name('select.employee');
});
