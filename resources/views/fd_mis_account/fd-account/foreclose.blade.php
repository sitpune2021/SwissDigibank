    ...
    <div class="mb-4 flex flex-wrap items-center justify-between gap-4 lg:mb-4">
        <div class="flex items-start flex-col gap-2">
            <div class="flex items-center gap-2">
                <h3 class="uppercase text-lg font-semibold">fd Account - {{$fdAccount->fd_account_no}} - Fore Close</h3>
                <p class="text-gray-500 text-xs">Pay Due Emi</p>
            </div>
            {{-- <p class="text-gray-500">
                <a href="#" class="text-gray-500 text-sm">fd Account </a> >
    ...
    <div class="flex flex-col dark:bg-bg3 lg:flex-row justify-between mt-7 gap-5">
        ...
        <div class=" w-full">
            <div class="box dark:bg-bg3 border mb-4 border-gray-200 shadow-md rounded-lg">
                <form action="{{ route('fdaccount.raiseForecloseRequest',$fdAccount->id) }}" method="POST">
                    @csrf
                    <!-- Header -->
                    <div class="px-2 py-3 ">
                        ...
                        <table class="min-w-full text-sm md:text-base whitespace-nowrap">
                            <tbody>
                                ...
                                <tr class="">
                                    ...
                                    <th class="text-center px-3 py-1 ">Amount(D)</th>
                        ...
                        <table class="min-w-full text-sm md:text-base whitespace-nowrap">
                            <tbody>
                                ...
                                <tr class="">
                                    <th class="text-center px-3 py-1 ">Rate (%)</th>
                                    <th class="text-center px-3 py-1 ">Days</th>
                                    <th class="text-center px-3 py-1 ">Amount(E)</th>
            ...
            <div class="col-span-2 md:col-span-1 mb-4">
                ...
                <input type="text" id="reverseInterest"
            ...
            <div class="col-span-2 md:col-span-1 mb-4">
                ...
                <table class="min-w-full text-sm md:text-base whitespace-nowrap">
                    <tbody>
                        ...
                        <tr>
                            <td class="px-2 py-2 ">
                                <input type="text" id="penalAmount" value="{{ number_format($penalCharges,2) }}" name="" id="" placeholder="0"
                                    class="w-full px-2 py-2 text-center bg-secondary/5 border  rounded-10 text-sm md:text-base" />
                            </td>
                            <td class="px-2 py-2 ">
                                <input type="text" id="penalGst" value="{{ $gstRate }}" name="" id="" placeholder="0" readonly
                                    class="w-full px-2 py-2 text-center bg-secondary/5 border  rounded-10 text-sm md:text-base" />
                            </td>
                            <td class="px-2 py-2 ">
                                <input type="text" id="penalTotal" value=" {{ number_format($penalChargesWithGst, 2) }}" name="" id="" placeholder="0" readonly
                                    class="w-full px-2 py-2 text-center bg-secondary/5 border  rounded-10 text-sm md:text-base" />
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="col-span-2 md:col-span-1 mb-4">
                ...
                <table class="min-w-full text-sm md:text-base whitespace-nowrap">
                    <tbody>
                        ...
                        <tr>
                            <td class="px-2 py-2 ">
                                <input type="text" id="cancelAmount" value=" {{ number_format($cancellationCharge,2) }}" name="" id="" placeholder="0"
                                    class="w-full px-2 py-2 text-center bg-secondary/5 border  rounded-10 text-sm md:text-base" />
                            </td>
                            <td class="px-2 py-2 ">
                                <input type="text" id="cancelGst" value=" {{ $gstRate }} " name="" id="" placeholder="0" readonly
                                    class="w-full px-2 py-2 text-center bg-secondary/5 border  rounded-10 text-sm md:text-base" />
                            </td>
                            <td class="px-2 py-2 ">
                                <input type="text" id="cancelTotal" value=" {{ number_format($cancellationTotal,2) }}" name="" id="" placeholder="0" readonly
                                    class="w-full px-2 py-2 text-center bg-secondary/5 border  rounded-10 text-sm md:text-base" />
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="col-span-2 md:col-span-1 mb-4">
                ...
                <input type="text" value="{{$roundingOff }}" id="roundingOff"
                    class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-2 md:py-3"
                    placeholder="0.0" readonly>
            </div>
            ...
            <div class="col-span-2 md:col-span-1 mb-4">
                ...
                <input type="text" value="{{$finalAmount }}" id="finalAmount"
                    class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-2 md:py-3"
                    placeholder="0.0" readonly>
            </div>
                ...
                <table class="w-full text-sm whitespace-nowrap text-gray-700 rounded-md">
                    <tbody>
                        <tr class="border-b border-gray-200">
                            ...
                            <td class="px-3 py-2">{{ $fdAccount->member->member_no }} -
                                {{ $fdAccount->member->member_info_first_name }}
                            </td>
                        </tr>
                        <tr class="border-b border-gray-200">
                            <td class="uppercase font-semibold px-3 py-2">Open Date</td>
                            <td class="px-3 py-2">{{ \Carbon\Carbon::parse($fdAccount->open_date)->format('d/m/Y') }}</td>
                        </tr>
                        <tr class="border-b border-gray-200">
                            <td class="uppercase font-semibold px-3 py-2">Maturity Date</td>
                            <td class="px-3 py-2"> {{ \Carbon\Carbon::parse($fdAccount->maturity_date)->format('d/m/Y') }}</td>
                        </tr>
                        <tr class="border-b border-gray-200">
                            <td class="uppercase font-semibold px-3 py-2">Status</td>
                            <td class="px-3 py-2"> {{ $fdAccount->status == 1 ? 'Active' : 'Closed' }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <table class="w-full text-sm whitespace-nowrap text-gray-700 rounded-md">
                    <tbody>
                        ...
                        <tr class="border-b border-gray-200">
                            ...
                            <td class="px-3 py-2">{{ ($fdAccount->tenure_year * 12) + $fdAccount->tenure_month }}
                                MONTHS</td>
                        </tr>
                        <tr class="border-b border-gray-200">
                            <td class="uppercase font-semibold px-3 py-2">fd Lock In Period</td>
                            <td class="px-3 py-2">{{ $fdAccount->fdScheme->lock_in_period }} Months</td>
                        </tr>
                        <tr class="border-b border-gray-200">
                        ...
                        <tr class="border-b border-gray-200">
                            ...
                            <td class="px-3 py-2"> {{ $fdAccount->fdScheme->interest_in_period }}</td>
                        </tr>
                        <tr class="border-b border-gray-200">
                            <td class="uppercase font-semibold px-3 py-2">Penal Charges</td>
                            <td class="px-3 py-2">{{ $fdAccount->fdScheme->penal_charge ?? 0 }}</td>
                        </tr>
                        <tr class="border-b border-gray-200">
...
<script>
    ...
    function calculate() {
        ...
        let A = num(document.getElementById('currentBalance').value);
        let B = num(document.getElementById('interestLeftPaid').value);
        let C = num(document.getElementById('tdsDeducated').value);
        let F = num(document.getElementById('reverseInterest').value);

        let penalAmount = num(document.getElementById('penalAmount').value);
        let penalGst = num(document.getElementById('penalGst').value);

        let cancelAmount = num(document.getElementById('cancelAmount').value);
        let cancelGst = num(document.getElementById('cancelGst').value);

        let penalTotal = penalAmount + (penalAmount * penalGst / 100);
        let cancelTotal = cancelAmount + (cancelAmount * cancelGst / 100);

        document.getElementById('penalTotal').value = penalTotal.toFixed(2);
        document.getElementById('cancelTotal').value = cancelTotal.toFixed(2);
        

        let G = penalTotal;
        let H = cancelTotal;

        let total = A + B - C - F - G - H;

        document.getElementById('totalAccount').value = total.toFixed(2);

        let finalAmount = Math.round(total);
        let rounding = (total - finalAmount).toFixed(2);

        document.getElementById('roundingOff').value = rounding;
        document.getElementById('finalAmount').value = finalAmount;

    }

    document.getElementById('interestLeftPaid').addEventListener('input', calculate);
    document.getElementById('tdsDeducated').addEventListener('input', calculate);
    document.getElementById('penalAmount').addEventListener('input', calculate);
    document.getElementById('cancelAmount').addEventListener('input', calculate);
</script>
