                                    ...
                                    <div class="flex justify-center">
                                        <div class="relative">
                                            ...
                                            <ul class="horiz-option popover-content">
                                                <li><a href="{{ route('personal.applications.view', $application->id) }}" class="single-option capitalize">View</a></li>
                                                @if($application->status != 2 )
                                                <li><a href="{{ route('personal.applications.edit', $application->id) }}" class="single-option capitalize">Edit</a></li>
                                                @endif
                                            </ul>
                                        </div>
                                    </div>
