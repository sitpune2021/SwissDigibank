    ...
    <div class="flex items-center gap-3 min-w-0">
        ...
        <div class="min-w-0">
            ...
            <p class="text-[11px] sm:text-sm text-gray-500 font-medium mt-1">
                ...
                Manage fixed deposits, MIS plans, & investment records efficiently.
...
@section('action-button')
    @if($isSuperAdmin || in_array('fd-mis-schemes.create', $permissions))
        <a href="{{ route('fd-mis-schemes.create') }}"
        ...
        <table class="w-full" id="transactionTable1">
            ...
            <thead class="bg-gradient-to-r from-blue-50 to-cyan-50 border-b border-gray-200">
                <tr class="text-gray-700">
                    ...
                    <!-- SCHEME NAME -->
                    <th class="text-start py-4 px-4 sm:px-6 min-w-[180px]">
                        <div class="flex items-center gap-2 text-xs sm:text-sm font-bold uppercase tracking-wide">
                            <i class="las la-layer-group text-primary text-base"></i>
                            <span>Scheme Name</span>
                        </div>
                    </th>

                    <!-- MIN FD -->
                    <th class="text-start py-4 px-4 min-w-[140px]">
                        <div class="flex items-center gap-2 text-xs sm:text-sm font-bold uppercase tracking-wide">
                            <i class="las la-wallet text-success text-base"></i>
                            <span>Min. FD Amt</span>
                        </div>
                    </th>
                    ...
                    <th class="text-start py-4 px-4 sm:px-6 min-w-[180px]">
                        <div class="flex items-center gap-2 text-xs sm:text-sm font-bold uppercase tracking-wide">
                            <i class="las la-money-check-alt text-info text-base"></i>
                    ...
                    <th class="text-start py-4 px-4 sm:px-6 min-w-[170px]">
                        <div class="flex items-center gap-2 text-xs sm:text-sm font-bold uppercase tracking-wide">
                            <i class="las la-clock text-danger text-base"></i>
                    ...
                    <th class="text-start py-4 px-4 sm:px-6 min-w-[190px]">
                        <div class="flex items-center gap-2 text-xs sm:text-sm font-bold uppercase tracking-wide">
                            <i class="las la-percentage text-primary text-base"></i>
                            <span>A. Interest Rate (%)</span>
                        </div>
                    </th>

                    <!-- STATUS -->
                    <th class="text-start py-4 px-4 sm:px-6 min-w-[130px]">
                        <div class="flex items-center gap-2 text-xs sm:text-sm font-bold uppercase tracking-wide">
                    ...
                    <!-- ACTION -->
                    <th class="text-center py-4 px-4 sm:px-6 min-w-[130px]" data-sortable="false">
                ...
                <tr class="table-row border-b border-gray-100"
                    ...
                    <td class="px-5 py-4 text-center align-middle"
                        ...
                        <div class="flex items-center justify-center gap-2 action-group">
                            ...
                            <!-- VIEW -->
                            @if($isSuperAdmin || in_array('fd-mis-schemes.show', $permissions))
                            <a href="{{ route('fd-mis-schemes.show', $fdScheme->id) }}"
                            ...
                            <!-- EDIT -->
                            @if($isSuperAdmin || in_array('fd-mis-schemes.edit', $permissions))
                            <a href="{{ route('fd-mis-schemes.edit', $fdScheme->id) }}"
