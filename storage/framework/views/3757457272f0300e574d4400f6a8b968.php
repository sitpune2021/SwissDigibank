<?php $__env->startSection('page-title', 'Director'); ?>
                ...
                <tbody>
                    <?php $__currentLoopData = $directors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $director): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="px-6 py-4"><?php echo e($director->director_name ?? 'N/A'); ?></td>
                            <td class="px-6 py-4"><?php echo e($director->din_no); ?></td>
                            <td class="px-6 py-4"><?php echo e($director->appointment_date?->format('D M d Y') ?? 'N/A'); ?></td>
                            <td class="px-6 py-4"><?php echo e($director->resignation_date?->format('D M d Y') ?? 'N/A'); ?></td>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Avantika\office_work\Swiss\resources\views/company/director/index.blade.php ENDPATH**/ ?>