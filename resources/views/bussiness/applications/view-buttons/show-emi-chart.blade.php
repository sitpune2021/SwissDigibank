...
<div class="main-inner  dark:bg-bg3  mt-5">
    ...
    <div class="container mx-auto p-6">
        ...
        <div class="loan-info mb-6 p-4 rounded-lg shadow box" >
            ...
            <h2 class="text-lg text-center font-semibold uppercase border-b pb-2 mb-3">
                Loan Information 
            </h2>
            ...
            <table class="w-full text-sm border border-gray-400 rounded-lg">
                <tbody>
                    ...
                    <tr>
                        <td class="font-semibold uppercase py-2 px-3 border border-gray-300">EMI Type</td>
                        <td class="py-2 px-3 border border-gray-300">
                            {{ $application->scheme->charge_per_emi == 1 ? 'On EMI' : 'On Principal' }}
                        </td>
                        <td class="font-semibold uppercase py-2 px-3 border border-gray-300"></td>
        ...
        <div class="mt-6 box">
            <h3 class="text-lg font-semibold uppercase text-center">EMI Chart</h3>
