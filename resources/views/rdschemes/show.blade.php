            ...
            <div class="p-6 bg-white dark:bg-bg3 rounded-lg shadow-md">
                ...
                <table class="min-w-full border-separate border-spacing-y-2">
                    <tbody>
                        ...
                        <tr>
                            <td class="font-medium px-4 py-2 border-b uppercase">Senior Citizen Add-on Interest Rate (%)</td>
                            <td class="text-gray-700 px-4 py-2 border-b">
                                {{ $scheme->sr_citizen_add_on_interest_rate??'NA' }} %
                            </td>
                        </tr>
                        <tr>
                            <td class="font-medium px-4 py-2 border-b uppercase">Interest Compounding</td>
                        ...
                        <tr>
                            <td class="font-medium px-4 py-2 border-b uppercase">Stationery Charges</td>
                            <td class="text-gray-700 px-4 py-2 border-b">
                ...
                <form action="{{ route('rdschemes.update', $scheme->id) }}" method="POST">
                    ...
                    <table class="min-w-full">
                        <tbody>
                            ...
                            <tr>
                                <td class="font-medium px-4 py-2 border-b uppercase">Commission Chart</td>
                                <td class="text-gray-700 px-4 py-2 border-b">
        ...
        <div id="auditTrailSection"
            ...
            <table class="w-full text-start border-collapse">
                <thead class="bg-gray-100">
                    <tr>
                        <th class="px-4 py-2 font-semibold text-start text-gray-700 border-b uppercase">Creator</th>
                        <th class="px-4 py-2 font-semibold text-start text-gray-700 border-b uppercase">Event</th>
                        <th class="px-4 py-2 font-semibold text-start text-gray-700 border-b uppercase">Create On</th>
                        <th class="px-4 py-2 font-semibold text-start text-gray-700 border-b uppercase">Change Logs</th>
                    </tr>
                </thead>
                <tbody>
                </tbody>
