...
<div class="main-inner">
    ...
    <div class="flex flex-wrap gap-3">
        ...
        <a href="{{ route('vehical.account.fourcloser', $goldLoan->id) }}" class="btn-error uppercase px-2 py-2 rounded-10 ">
            Fore CloseLoan
        </a>
        
        <a href="{{ route('vehical.account.linksaving', $goldLoan->id) }}" class="btn-primary uppercase px-2 py-2 rounded-10 ">
        ...
        <form id="remove-account-form-{{ $goldLoan->id }}" action="{{ route('vehical.remove', $goldLoan->id) }}" method="POST" class="inline">
            @csrf
