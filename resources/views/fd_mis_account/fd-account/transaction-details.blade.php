                ...
                <div class="box dark:bg-bg3 border mb-4 border-gray-200  shadow-md rounded-lg  overflow-x-auto p-4">
                    <div class="flex  justify-end gap-3 mb-3">
                        ...
                        <a class=" btn-error p-1" title="Delete" data-confirm="Are you sure to delete transaction?"
                            ...
                            href="{{ route('dds-accounts.transactions.destroy', [$fdAccount->id, $transaction->id]) }}">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            <tr>
                                ...
                                <td class="px-4 py-2 ">
                                    ...
                                    <a href=" {{ route('member.show', $fdAccount->member->id) }}"
                            ...
                            <tr class="border-t">
                                ...
                                <td class="px-4 py-2"> {{ $fdAccount->id }} </td>
                            </tr>
                            <tr class="border-t">
                            ...
                            <tr class="border-t">
                                ...
                                <td class="px-4 py-2">
                                    {{ $transaction->fdAccount->branch->branch_name ?? '-' }}
                                </td>
                            </tr>
                            <tr class="border-t">
