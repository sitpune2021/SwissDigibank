...
<div class="main-inner">
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 mb-6 px-4 lg:mb-8">
        ...
        <a href="#" class="btn-primary capitalize ">
            Add
        </a>
    </div>
            ...
            <table class="w-full whitespace-nowrap select-all-table">
                ...
                <tbody>
                    ...
                    <tr class="border-b dark:border-bg3">
                        ...
                        <td class="text-start !py-5 px-6 min-w-[100px] cursor-pointer">
                            <div class="flex items-center gap-1">
                                Chas Bokaro secure home scheme
                            </div>
                        </td>
                        <td class="text-start !py-5 px-6 min-w-[100px] cursor-pointer">
                            <div class="flex items-center gap-1">
                              ecure home scheme 100,000.00
                            </div>
                        </td>
                        <td class="text-start !py-5 px-6 min-w-[100px] cursor-pointer">
                            <div class="flex items-center gap-1">
                        ...
                        <td class="text-start !py-5 px-6 min-w-[100px] cursor-pointer">
                            <div class="flex items-center gap-1">
                                <span class="block w-28 rounded-[30px] border border-n30 bg-primary/20 py-2 text-center text-xs text-primary dark:border-n500 dark:bg-bg3 xxl:w-16">APPROVED</span>
                            </div>
                        </td>
