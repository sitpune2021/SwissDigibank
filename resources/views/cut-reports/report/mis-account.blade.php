...
<div class="main-inner">
    ...
    <div class="col-span-12 box lg:col-span-12">
        <div class="mb-5 flex justify-end gap-2 flex-col md:flex-row lg:flex-row">
            <a href="{{route('report.mis.index')}}" class="btn-primary rounded-10 px-1 flex justify-center py-2 text-sm uppercase">
            ...
            <table class="w-full whitespace-nowrap select-all-table" id="transactionTable1">
                ...
                <tbody>
                    ...
                    <tr class="border-b dark:border-bg3">
                        ...
                        <td class="text-start !py-5 px-6 min-w-[100px] cursor-pointer">
                            <div class="flex items-center gap-1">
                                {{ $row->fdscheme->scheme_name??'' }} {{ $row->fdscheme->scheme_code??'' }}
                            </div>
                        </td>
                        <td class="text-start !py-5 px-6 min-w-[100px] cursor-pointer">
                            <div class="flex items-center gap-1">
