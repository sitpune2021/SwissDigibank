<?php $__env->startSection('content'); ?>
    ...
    <div class="main-inner">
        ...
        <div class="box mb-4 xxxl:mb-6">
            <form action="<?php echo e(route('edit.director')); ?>" method="POST" class="grid grid-cols-2 gap-4 xxxl:gap-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="w-full">
                        <input type="text" name="din_no" id="din_no" placeholder="Enter din_no."
                            class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3"
                            value="<?php echo e(old('din_no')); ?>">
                        <?php $__errorArgs = ['din_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views\director\edit.blade.php ENDPATH**/ ?>