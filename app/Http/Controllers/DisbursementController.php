...
class DisbursementController extends Controller
{
    ...
    {
        // relations ke sath loan applications fetch karenge
        $disbursements = LoanApplication::with(['member', 'branch', 'scheme'])->get();
...
public function store(Request $request)
{
    ...
    //     return view("gold-loan.disbursements.disburse-loan", compact('disbursement','banks'));
    // }
// public function show($id)
// {
//     $disbursement = LoanApplication::with(['member', 'branch', 'scheme'])->findOrFail($id);
...
//     // safe access to scheme (if scheme is null, use 0)
...
//         compact('disbursement', 'banks', 'processingFee', 'gstPercent', 'gstAmount', 'sgst', 'cgst', 'igst', 'total')
//     );
// }
