...
@section('content')
    ...
    value="{{ $members[$selectedMember->id] ?? '' }}">
                ...
                <div class="col-span-2 md:col-span-1 relative">
                    ...
                    <i
                        class="las la-calendar absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 pointer-events-none"></i>
                ...
                <div class="w-full mt-4 col-span-2">
                    <div class="bg-primary border-l-4 border-blue-500 text-white p-4 rounded-md mb-6 w-full">
                        ...
                        <h6>
                            Open saving account of splitting promoter to deposit the share transfer amount automatically and
                        ...
                        <ul class="list-disc list-inside text-sm leading-relaxed space-y-2">
                            ...
                            <li>The amount which you collect from member for the share transferred, should go to the
                                promoter who's share is transferred to the member.</li>
                            <li>
                                We have made this functionality automatic and from here itself you can deposit that share
                                amount to the promoter saving account.
        ...
        dropdown.on('change', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    infoBox.html(
                        `This member currently has <b>${currentShares}</b> shares.`);
                    sharesInput.val(0);
                    calculateTotal();
                },
                error: function() {
