    ...
    <div class="main-inner">
        ...
        <div class="flex flex-wrap gap-3">
            ...
            <a href="{{ route('mortgage.applications.view-buttons.show-emi-chart', $application->id) }}" target="_blank"
                class="btn-primary   px-2 py-2 rounded-10 ">
                SHOW EMI CHART
            </a>
            {{-- Submit button only when Draft --}}
            ...
            @if ($application->status != 2)
                <a href="{{ route('mortgage.applications.view-buttons.col_process_fee', $application->id) }}"
                    class="btn-warning uppercase px-2 py-2 text-sm rounded-10">
                    Collect Processing Fee
                </a>
            @endif

            <a href="{{ route('mortgage.applications.audit-trail') }}" target="_blank"
                class="btn-primary text-sm   px-2 py-2 rounded-10 ">
                SHOW AUDIT TRIAL
            </a>

            @if ($application->status != 0 && $application->status != 3 && $application->status != 2)
                <a href="#" class="btn-warning  uppercase px-2 py-2 text-sm rounded-10 ">
                    DISBURSE SETTINGS
                </a>

                <a href="#" class="btn-primary   px-2 py-2 text-sm rounded-10 ">
            ...
            @if ($application->status != 0 && $application->status != 3)
                <div class="relative inline-block text-left">
                    <!-- Button -->
                    <button type="button" class="btn-secondary px-2 py-2 rounded-10 flex text-sm items-center gap-2"
                    ...
                    <div id="printDropdown"
                        ...
                        <div class="py-1">
                            ...
                            <a href="{{ route('mortgage_loan.payout_chart_loan_application_view', $application->id) }}"
                                class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                <i class="las la-print text-secondary"></i> EMI SCHEDULE CHART
                            </a>
                            <a href="{{ route('mortgage_loan.sanction_letter-view', $application->id) }}"
                                class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                <i class="las la-print text-secondary"></i> SANCTION LETTER
                            </a>
                            <a href="{{ route('mortgage_loan.loanAgreement-view', $application->id) }}"
                                class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                <i class="las la-print text-secondary"></i> LOAN AGREEMENT
                            </a>
                            <a href="{{ route('mortgage_loan.disburse_letter.view', $application->id) }}"
                                class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                <i class="las la-print text-secondary"></i> DISBURSE LETTER
                            </a>
                            <a href="{{ route('mortgage_loan.promissory.view', $application->id) }}"
                                class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                <i class="las la-print text-secondary"></i> PROMISSORY NOTE
                            </a>
                            <a href="{{ route('mortgage_loan.undertaking_letter.view', $application->id) }}"
                                class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
        ...
        <div class="flex flex-col dark:bg-bg3 lg:flex-row justify-between mt-7 gap-5">
            ...
            <div class=" w-full  overflow-hidden">
                <div class="overflow-x-auto box rounded-lg dark:bg-bg3 p-2 bg-white shadow-md">
                    ...
                    <table class="w-full text-sm text-left border-collapse">
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="border-b">
                                <td class="font-semibold uppercase px-4 py-2">Loan Scheme</td>
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-2">
                                    ...
                                    <span class=" capitalize {{ $statusClass }}">
                                        {{ $statusText }}
                                    </span>
                                </td>
                            </tr>
                ...
                <div class="box shadow-md mt-5 dark:bg-bg3 dark:border-lightbg1 rounded-lg overflow-hidden">
                    ...
                    <div class="p-4 overflow-x-auto" id="cibilInfo">
                        <table class="w-full text-sm text-left whitesapce-nowrap">
                            <thead class="bg-gray-100 text-gray-700">
                                <tr class="bg-secondary/5">
                                    <th class="px-4 py-2 uppercase text-start  font-semibold">CIBIL Type</th>
                                    <th class="px-4 py-2  uppercase text-start font-semibold">CIBIL Score</th>
                                    <th class="px-4 py-2 uppercase text-start font-semibold">Report Date</th>
                                    <th class="px-4 py-2 uppercase text-start font-semibold">View Report</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-200">
                    ...
                    <table class="w-full text-md  whitesapce-nowrap">
                        <thead class="bg-gray-100  text-start">
                            <tr class="text-start bg-secondary/5">
                                <th class="px-2 py-2 font-semibold text-start uppercase text-gray-700">Status</th>
                                <th class="px-2 py-2 font-semibold text-start uppercase text-gray-700">Remarks</th>
                                <th class="px-2 py-2 font-semibold text-start uppercase text-gray-700">Updated at</th>
                                <th class="px-2 py-2 font-semibold text-start uppercase text-gray-700">Approved By</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class=" w-full ">
                ...
                <div class="flex flex-row gap-4 px-3 dark:bg-bg3  rounded-10">
                    ...
                    <div class="overflow-x-auto mt-5 " id="goldLoanSchemeInfo">
                        <table class="w-full border-collapse rounded-lg overflow-hidden  bg-white dark:bg-bg3">
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-600">
                                ...
                                <tr class="border-b">
                                    <td class="font-semibold uppercase px-4 py-2">Processing Fee</td>
                                    <td class="px-4 py-2 text-right md:text-left">
