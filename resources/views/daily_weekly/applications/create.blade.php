...
<div class="main-inner">
    ...
    <div class="box">
        <form method="POST" 
                        action="{{ isset($application) ? route('daily_weekly.applications.update', $application->id) : route('daily_weekly.store') }}" enctype="multipart/form-data">
                        @csrf
                ...
                <div class="grid grid-cols-2 gap-4 mt-6 xl:mt-8 xxxxxl:gap-6">
                        ...
                        <div class="col-span-2 md:col-span-1">
                            ...
                            <select id="emi_collection" name="emi_collection"
                                ...
                                <option value="Monthaly"   {{ $selectedValue == 'Monthaly' ? 'selected' : '' }}>MONTHALY</option>
                            </select>
                        </div>
                        ...
                        <div class="col-span-2 md:col-span-1">
                         ...
                         <div class="col-span-2 md:col-span-1">
                            ...
                            <input type="number" id="insurance_fee" name="insurance_fee"
                                ...
                                class="w-full text-sm mt-5 bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-2 md:py-3" readonly>
                                @error('insurance_fee')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                        </div>
                            ...
                            <div class="mt-3 flex fle-row gap-3">
                                ...
                                <label class="mr-4 flex fle-row gap-3 items-center">
                                    <input type="radio" name="fee_mode" value="cash"
                                        {{ old('fee_mode', $application->fee_mode ?? '') == 'cash' ? 'checked' : '' }} checked> 
                                        <p>
                                            Cash
                                        </p>
                                </label>
