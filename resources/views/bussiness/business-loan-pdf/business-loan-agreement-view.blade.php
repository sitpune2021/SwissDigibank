...
<div class="main-inner">
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4 lg:mb-8">
        <div class="flex items-start flex-col gap-2">
            <h3 class="text-lg uppercase font-semibold">loan agreement Letter </h3>
        </div>
    </div>
      <div class="text-center flex justify-center gap-5 mt-4">
        <a href="{{ route('business_loan.loanAgreement.pdf',  $schedule_one['loan_no']) }} " class="px-4 py-2 btn-primary uppercase"
            style="font-family: sans-serif !important; " target="_blank">
            <i class="las la-download"></i> Download
        </a>
        <a href="
 {{ route('bussiness.applications.view', $schedule_one['loan_no']) }}
  " class="px-4 py-2 btn-outline uppercase" style="font-family: sans-serif !important; " target="_self">
    ...
    <div class="box mt-5">
        ...
        <p class="justify" style="line-height: 1">
            This <span style="font-weight:600; font-size: 16px; ">LOAN AGREEMENT(“Agreement”) </span>is made at the
            ...
            hereinafter referred to as <span style=" font-weight:600; font-size:16px; ">“the Borrower”</span> (which
        ...
        <p style="text-align: center; font-size:16px; font-weight: 600; line-height: 0.5;">And</p>

        <p class="justify" style="line-height: 1;">
            The Person mentioned as Guarantor(s) in Schedule 1 (hereinafter referred to as
            <span style=" font-weight:600; font-size:16px; "> “Guarantor(s)”</span>
            which
        ...
        <p class="justify" style="font-size: 18px; font-size: bolder; font-weight: 600; line-height: 1;">
            WHEREAS
        </p>
        <p class="justify" style="line-height: 1;">
        ...
        <p class="justify" style="font-size: 16px; font-size: bolder; font-weight: 600; margin-top: 10px; line-height: 1;">
        ...
        <p class="justify" style="line-height: 1;">
            ...
            hereto.
            <br>
            <b> 4.</b> <span style="font-weight: 600; font-size: 16px;">Fees </span>: The Borrower agrees to pay to the
            Lender
        ...
        <p style="line-height: 1;  font-weight: 600; font-size: 14px;">
            5. Repayment
        </p>
        ...
        <span style="line-height: 1;  font-weight: 600; font-size: 14px;">
            6. Pre- payment
        </span>
        <br>
        <p style="line-height: 1;">
        ...
        <br>
        <span style="line-height: 1;  font-weight: 600; font-size: 16px;">
        ...
        <h4 style="line-height: 1 ; margin-top: 20px; font-size: 16px;">
            All fees shall be paid together with all taxes including Goods and Service Tax (GST) as
            may be applicable from time to time.
        </h4>

        <h2 style="text-align: center; font-size: 14px;">Schedule 3 - Schedule of Charges</h2>
        <table class="table">
            <tr>
            ...
            <tbody>
                @forelse($ornaments as $ornament)
                    <tr>
                        ...
                        <td>₹ {{ number_format($ornament->value_per_gram, 2) }}</td>
                        <td>{{ number_format($ornament->gross_weight, 3) }}</td>
                        <td>{{ number_format($ornament->net_weight, 3) }}</td>
                        <td>{{ number_format($ornament->tunch, 2) }}</td>
                        <td>{{ number_format($ornament->fine_weight, 3) }}</td>
                        <td>₹ {{ number_format($ornament->total_value, 2) }}</td>
