                                    ...
                                    <tr>
                                        <td class="px-2 py-2">
                                            <select name="cibil_type[]"
                                                ...
                                                <option value="transunion" {{ $score->cibil_type == 'transunion' ?
                                                    'selected' : '' }}>TransUnion</option>
                                                <option value="equifax" {{ $score->cibil_type == 'equifax' ? 'selected'
                                                    : '' }}>Equifax</option>
                                                <option value="experian" {{ $score->cibil_type == 'experian' ?
                                                    'selected' : '' }}>Experian</option>
                                                <option value="crif_highmark" {{ $score->cibil_type == 'crif_highmark' ?
                                                    'selected' : '' }}>Crif Highmark</option>
                                            </select>
                                        </td>
                            ...
                            <div class="mt-3 flex fle-row gap-3">
                                ...
                                <label class="mr-4 flex fle-row gap-3 items-center">
                                    <input type="radio" name="fee_mode" value="cash" {{ old('fee_mode',
                                        $application->fee_mode ?? '') == 'cash' ? 'checked' : '' }} checked>
                                    <p>
                                        Cash
                                    </p>
                                </label>
                            ...
                            <div id="onlineFields" class="space-y-4 hidden">
                                ...
                                <div>
                                    ...
                                    <div class="flex gap-4 mt-2">
                                        ...
                                        <label class="flex items-center gap-2">
                                            <input type="radio" name="transfer_mode" value="vpa" {{ old('transfer_mode',
                                                $application->transfer_mode ?? '') == 'vpa' ? 'checked' : '' }}>
