...
<div class="main-inner">
    ...
    <div class="mb-4 flex flex-wrap items-center justify-between gap-4 lg:mb-4">
        <div class="flex items-start flex-col gap-2">
            <h3 class="uppercase font-semibold">Gold Loan - 00460 - Remove Account</h3>
    ...
    <div class="box dark:bg-bg3 shadow-md rounded-xl p-6 border border-gray-200 dark:border-gray-700">
        ...
        <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">
            Remove gold loan account and it's details and transactions.
       </h2>
  <hr>
  <p class="text-lg  text-gray-800 dark:text-gray-100 mb-3">
            
Remove gold loan account will delete following details: 
  </p>
        <!-- Content -->
        <ul class="list-disc pl-6 text-sm mt-3 leading-relaxed text-gray-700 dark:text-gray-300 space-y-2">
            <li>Remove gold loan account.</li>
            <li>Remove gold loan application associated with account.</li>
