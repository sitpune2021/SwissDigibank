                ...
                <div class="flex justify-center">
                    <div class="relative">
                        ...
                        <ul class="horiz-option popover-content">
                             <li>
                               <a href="{{ route('daily_weekly.disbursements.disburse-loan', $disbursement->id) }}" class="single-option uppercase">Disburse Loan</a>
                            </li>
                            <li>
                                <form action="{{ route('daily_weekly.cancel', $disbursement->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to cancel this loan?');">
                                    @csrf
