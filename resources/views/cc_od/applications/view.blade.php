    ...
    <div class="main-inner">
        ...
        <div class="flex flex-wrap gap-3">
            ...
            @if ($application->status == 1)
                <a href="{{ route('cc_od.applications.view-buttons.col_process_fee', $application->id) }}"
            ...
            @if ($application->status != 0)
                <div class="relative inline-block text-left">
                    <!-- Button -->
                    <button type="button"
                        class="btn-primary px-2 py-2 rounded-10 text-sm uppercase flex items-center gap-2"
