                            ...
                            <div class="flex justify-center">
                                <div class="relative">
                                    ...
                                    <ul class="horiz-option popover-content">
                                        <li><a href="{{ route('mortgage_schemes.view-mortgage-scheme') }}" class="single-option">View</a></li>
                                        <li><a href="{{route('mortgage_schemes.edit-mortgage-scheme')}}" class="single-option">Edit</a></li>
                                    </ul>
