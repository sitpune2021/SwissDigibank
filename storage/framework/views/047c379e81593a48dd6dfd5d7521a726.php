                    ...
                    <table class="w-full whitespace-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr class="even:bg-secondary/5 dark:even:bg-bg3">
                                <td class="px-6 py-2">
                                    <div class="flex items-center gap-3">
                                        <img src="<?php echo e(asset('assets/images/payoneer.png')); ?>" width="32"
...
<?php $__env->startPush('page-js'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/page-cdn.js'); ?>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views\dashboard\index3.blade.php ENDPATH**/ ?>