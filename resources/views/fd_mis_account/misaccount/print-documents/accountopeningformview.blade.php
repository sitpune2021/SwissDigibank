...
<div class="main-inner">
    ...
    <div class="text-center flex justify-center gap-5 mt-4">
        ...
        <a href="{{ route('misaccount.show', $account->id) }}" class="px-4 py-2 btn-outline uppercase" target="_self">
            BACk
        </a>
    </div>
    <div class="box mt-5">
        <div class="form-container">
            ...
            <div style="width: 100%; font-size: 12px; margin-top: 12px;">
                ...
                <p
                    style="float: left;  border: 1px solid #000; padding: 2px 6px; min-width: 200px; margin-right: 16px;">
                    ...
                    <td style="width:33.33%; vertical-align:top;">
                        <div style="width:100%;">
                            <div style="float:left; width:25%;">
                                <input type="checkbox" style="width:18px; height:18px;" {{ $account->account_type ==
                                'single' ? 'checked' : '' }}>
                            </div>
                ...
                <tr>
                    <td>
                        <label style="display:flex; align-items:center;">
                            <input type="checkbox" style="width: 20px; height: 20px;" {{ $account->account_type ==
                            'single'
                            ? 'checked' : '' }}> : Self
                        </label>
                    </td>
                ...
                <tr>
                    ...
                    <td style="width:20%; vertical-align:top;">
                        <div style="width:100%;">
                            <div style="float:left; width:25%;">
                                <input type="checkbox" style="width:18px; height:18px;" {{
                                    !in_array($account->interest_payout_type, ['monthly','Quarterly','Half
                                Yearly','Yearly']) ? 'checked' : '' }}>
                            </div>
                            <div style="float:left; width:75%; padding-top:2px;">
                                : End of Term
                            </div>
                    ...
                    <td>
                        <label style="display:flex; align-items:center;">
                            <input type="checkbox" style="width: 20px; height: 20px;" {{
                                !in_array($account->interest_payout_type, ['monthly', 'Quarterly', 'Half Yearly',
                            'Yearly'])
                            ? 'checked' : '' }}> : End of Term
                        </label>
                    </td>
