        ...
        <div class="flex flex-col dark:bg-bg3 lg:flex-row justify-between mt-7 gap-5">
            ...
            <div class="w-full overflow-hidden">
                <div class="box dark:bg-bg3 border mb-4 border-gray-200 shadow-md rounded-lg">
                    <form action="{{ route('daily_weekly.payEmiLoan', $goldLoan->id) }}" method="POST"
                        ...
                        <div class=" flex mb-2 overflow-x-auto">
                            <table class="min-w-full text-sm md:text-base whitespace-nowrap">
                                <tbody>
                                    ...
                                    <tr class="">
                                        <td class="px-2 py-2 ">
                                            <input type="text" name="overdueInterest" id="overdueInterest"
                                                placeholder="0.0" value="{{ $overdueInterest ?? 0 }}" readonly
                                                class="w-full px-2 py-2 text-center bg-secondary/5 border  rounded-10 text-sm md:text-base" />
                                        </td>
                                        <td class="px-2 py-2 ">
                                            <input type="text" name="otherCharges" id="otherCharges" placeholder="0.0"
                                                value="{{ $otherCharges ?? 0 }}" readonly
                                                class="w-full px-2 py-2 text-center  bg-secondary/5 border  rounded-10 text-sm md:text-base" />
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <div class=" flex mb-2 overflow-x-auto">
                            <table class="min-w-full text-sm md:text-base whitespace-nowrap">
                                <tbody>
                                    ...
                                    <tr class="">
                                        <td class="px-2 py-2 ">
                                            <input type="text" name="amount" value="{{ $overdueInterest ?? 0 }}"
                                                id="amount" placeholder="0" readonly
                                                class="w-full px-2 py-2 text-center bg-secondary/5 border  rounded-10 text-sm md:text-base" />
                                        </td>
                                        <td class="px-2 py-2 ">
                                            <input type="text" name="gstRate" id="gstRate" value="{{ $gstRate ?? 0 }}"
                                                placeholder="0.0" readonly
                                                class="w-full px-2 py-2 text-center bg-secondary/5 border  rounded-10 text-sm md:text-base" />
                                        </td>
                                        <td class="px-2 py-2 ">
                                            <input type="text" name="totalAmount" id="totalAmount"
                                                value="{{ $totalOverdueWithGst ?? 0 }}" placeholder="0.0"
                        ...
                        <div class="mt-4 mb-4">
                            <p id="noteMessage" class="text-error text-sm block mt-3 mb-4 hidden">
                                Note: If you are change transaction date then above data will be reflected according to the
                                transaction date.
                            </p>
                            <label class="md:text-lg font-medium block mb-4">Transaction Date</label>
                            <div class="relative flex items-center">
                                <input type="text" name="transaction_date" value="{{ date('d-m-Y') }}"
                                    class="datepicker-field w-full rounded-10 bg-secondary/5 dark:bg-bg3 border border-n30  dark:border-n500 border-gray-300 px-3 md:px-6 py-2 md:py-3"
                                    readonly>
            ...
            <div class="w-full">
                ...
                <div class="box bg-white dark:bg-bg3 border shadow-md rounded-lg mb-4">
                    ...
                    <div class="flex justify-between items-center px-4 py-2 bg-secondary/5 text-black rounded-10">
                        <h3 class="text-black font-semibold text-lg">DAILY WEEKLY LOAN ACCOUNT INFO</h3>
                        ...
                        <table class="w-full text-sm whitespace-nowrap text-gray-700 rounded-md">
                            <tbody>
                                ...
                                <tr class="border-b border-gray-200">
                                    ...
                                    <td class="px-3 py-2">{{ $goldLoan->member->member_no ?? '' }} -
                                        {{ $goldLoan->member->member_info_first_name ?? '' }}</td>
                                </tr>

                                <tr class="border-b border-gray-200">
                                    <td class="font-semibold px-3 py-2">Open Date</td>
                                    <td class="px-3 py-2">
                                        {{ \Carbon\Carbon::parse($goldLoan->application_date)->format('d-m-Y') }}</td>
                                </tr>
                                <tr class="border-b border-gray-200">
