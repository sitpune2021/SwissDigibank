                            ...
                            <td>
                                <div
                                    ...
                                    <img width="32" height="32" class="rounded-full shrink-0"
                                        src="<?php echo e(asset('assets/images/paypal.png')); ?>" alt="img" />
                        ...
                        <tr>
                            ...
                            <td>
                                <div
                                    class="flex items-center py-2.5 gap-3 pr-6 min-w-[300px] px-3 bg-secondary/5 dark:bg-bg3">
                                    <img width="32" height="32" class="rounded-full shrink-0"
                                        src="<?php echo e(asset('assets/images/visa.png')); ?>" alt="img" />
                                    <div class="flex flex-col">
                                        <span class="font-medium inline-block mb-1">
                                            Hooli INV-79820
                                        </span>
                        ...
                        <tr>
                            ...
                            <td>
                                <div
                                    class="flex items-center py-2.5 gap-3 pr-6 min-w-[300px] px-3 bg-secondary/5 dark:bg-bg3">
                                    <img width="32" height="32" class="rounded-full shrink-0"
                                        src="<?php echo e(asset('assets/images/payoneer.png')); ?>" alt="img" />
                                    <div class="flex flex-col">
                                        <span class="font-medium inline-block mb-1">
                                            Hooli INV-79820
                                        </span>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views\transaction\style3.blade.php ENDPATH**/ ?>