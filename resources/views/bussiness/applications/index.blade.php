                                    ...
                                    <div class="flex justify-center">
                                        <div class="relative">
                                            ...
                                            <ul class="horiz-option popover-content">
                                                <li><a href="{{ route('bussiness.applications.view', $application->id) }}" class="single-option uppercase">View</a></li>
                                                @if($application->status != 2)
                                                <li><a href="{{ route('bussiness.applications.edit', $application->id) }}" class="single-option uppercase">Edit</a></li>
                                                @endif
                                            </ul>
                                        </div>
                                    </div>
