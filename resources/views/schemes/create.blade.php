...
@section('content')
    ...
    <div class="main-inner">
        ...
        <div class="box mb-4 xxxl:mb-6">
            <form id="companyForm" action="{{ route('schemes.create') }}" method="POST"
                ...
                <div class="col-span-2 md:col-span-1">
                    <label for="rate" class="md:text-lg font-medium block mb-4">City <span
                            class="text-red-500">*</span></label>
                ...
                <div class="col-span-2 md:col-span-1">
                    <label for="rate" class="md:text-lg font-medium block mb-4">Contact Email <span
                            class="text-red-500">*</span></label>
                ...
                <div class="col-span-2 md:col-span-1">
                    <label for="rate" class="md:text-lg font-medium block mb-4">Landline No.<span
                            class="text-red-500">*</span></label>
                ...
                <div class="col-span-2 md:col-span-1">
                    <label for="rate" class="md:text-lg font-medium block mb-4">GST No.<span
                            class="text-red-500">*</span></label>
                ...
                <div class="col-span-2 md:col-span-1">
                    <label for="rate" class="md:text-lg font-medium block mb-4">Disable Recharge / Bill Payment<span
                            class="text-red-500">*</span></label>
                    <label>
