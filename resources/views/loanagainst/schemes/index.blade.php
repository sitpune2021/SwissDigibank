...
@section('content')
    ...
    <div class="main-inner">
        ...
        <div class="flex flex-wrap items-center justify-between gap-4 mb-6 px-4 lg:mb-8">
            <h1 class="flex text-xl block font-semibold uppercase">loan against deposit scheme</h1>
            <a href="{{route('loanagainst.schemes.create')}}" class=" block flex btn-primary uppercase   ">Add
            </a>
        </div>
                @if(session('success'))
            <div class="">
                            ...
                            <tr class="border-b dark:border-bg3">
                                <td class="text-start !py-5 px-6">
                                    <div class="flex items-center gap-1 text-secondary uppercase">
                                        <a href="{{ route('loanagainst.schemes.view', $scheme->id) }}"
                                    ...
                                    <div class="flex justify-center">
                                        <div class="relative">
                                            ...
                                            <ul class="horiz-option popover-content">
                                                <li><a href="{{ route('loanagainst.schemes.view', $scheme->id) }}"
                                                        class="single-option uppercase">View</a></li>
                                                <li><a href="{{ route('loanagainst.schemes.edit', $scheme->id) }}"
