                    ...
                    <div class="col-span-2 md:col-span-1 mt-4">
                        ...
                        <select name="nominee_relation"
                            ...
                            <option value="child"
                                ...
                                Child</option>
                            <option value="son"
                                {{ old('nominee_relation', $account->nominee_relation ?? '') === 'son' ? 'selected' : '' }}>
                                Son</option>
                            <option value="daughter"
                                {{ old('nominee_relation', $account->nominee_relation ?? '') === 'daughter' ? 'selected' : '' }}>
                                Daughter</option>
                            <option value="brother"
                                {{ old('nominee_relation', $account->nominee_relation ?? '') === 'brother' ? 'selected' : '' }}>
                                Brother</option>
                            <option value="sister"
                                {{ old('nominee_relation', $account->nominee_relation ?? '') === 'sister' ? 'selected' : '' }}>
                                Sister</option>
                            <option value="grandfather"
                                {{ old('nominee_relation', $account->nominee_relation ?? '') === 'grandfather' ? 'selected' : '' }}>
                                Grandfather</option>
                            <option value="grandmother"
                                {{ old('nominee_relation', $account->nominee_relation ?? '') === 'grandmother' ? 'selected' : '' }}>
                                Grandmother</option>
                            <option value="uncle"
                                {{ old('nominee_relation', $account->nominee_relation ?? '') === 'uncle' ? 'selected' : '' }}>
                                Uncle</option>
                            <option value="aunt"
                                {{ old('nominee_relation', $account->nominee_relation ?? '') === 'aunt' ? 'selected' : '' }}>
                                Aunt</option>
                            <option value="other"
                                {{ old('nominee_relation', $account->nominee_relation ?? '') === 'other' ? 'selected' : '' }}>
                                Other</option>
                        </select>
