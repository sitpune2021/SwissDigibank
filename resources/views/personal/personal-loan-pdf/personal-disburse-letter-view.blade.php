...
<div class="main-inner">
    ...
    <div class="text-center flex justify-center gap-5 mt-4">
        <a href="{{ route('personal_loan.disburse_letter.pdf', $loan_no) }} " class="px-4 py-2 btn-primary uppercase"
            style="font-family: sans-serif !important; " target="_blank">
            <i class="las la-download"></i> Download
        </a>
        <a href="
 {{ route('personal.applications.view', $loan_no) }}
    ...
    <div class="box mt-5">
        ...
        <div class="content">
            ...
            <div class="subject" style="font-size: 14px;">
                ...
                ( Personal Loan - {{ str_pad( $loan_no, 10, '0', STR_PAD_LEFT) }} ) of
