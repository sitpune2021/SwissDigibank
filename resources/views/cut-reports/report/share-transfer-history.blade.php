...
<div class="main-inner">
         ...
         " method="GET">
            ...
            <div class="w-full mt-4 flex flex-wrap gap-2">
                <button type="button" data-range="6m"
                    class="px-3 py-2 border text-sm  rounded-10 btn-primary hover:bg-gray-200 uppercase">Last 6 Months</button>
                <button type="button" data-range="3m"
                    class="px-3 py-2 border text-sm  rounded-10 btn-primary hover:bg-gray-200 uppercase">Last 3 Months</button>
                <button type="button" data-range="1w"
                    class="px-3 py-2 border text-sm  rounded-10 btn-primary hover:bg-gray-200 uppercase">Last 1 Week</button>
                <button type="button" data-range="1d"
                    class="px-3 py-2 border text-sm  rounded-10 btn-primary hover:bg-gray-200 uppercase">Last 1 Day</button>
    ...
    <div class="col-span-12 box lg:col-span-12 mt-5">
        <div class="mb-5 flex justify-end gap-2 flex-col md:flex-row lg:flex-row">
            <a href="{{ route('share.transfer.print') }}" target="_blank" class="btn-primary rounded-10 px-2 flex justify-center py-2 text-sm uppercase">
                    ...
                    <tr class="border-b dark:border-bg3">
                        ...
                        <td class="text-start !py-5 px-6 min-w-[100px] cursor-pointer">
                            <div class="flex items-center gap-1 Capitalize">
                                {{ $shareTransfer->members->member_info_first_name ?? ''}} {{ $shareTransfer->members->member_info_last_name ?? ''}}
                            </div>
                        </td>
