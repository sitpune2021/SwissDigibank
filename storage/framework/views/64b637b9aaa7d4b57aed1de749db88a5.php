<?php $__env->startSection('content'); ?>
    <div class="main-inner">
        <div class="mb-6 flex flex-wrap items-center justify-between gap-4 lg:mb-8">
            <h2 class="h2">Invoice Style 02</h2>
        ...
        <!-- Stats -->
        <div class="grid grid-cols-12 gap-4 xxl:gap-6 mb-4 lg:mb-6">
            <!-- Statistics -->
            ...
            <div class="overflow-x-auto mb-4 lg:mb-6">
                <table class="w-full whitespace-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr class=" duration-500 even:bg-secondary/5">
                            <td class="py-5 px-6">
                        ...
                        <tr class=" duration-500 even:bg-secondary/5 first:border-t">
                            <td class="py-5 px-6">
                                <div class="flex items-center gap-3">
                                    <i class="las la-file text-primary"></i>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views\invoicing\style2.blade.php ENDPATH**/ ?>