...
<div class="main-inner">
    <div class="mb-6 flex flex-wrap items-center justify-between gap-3 lg:mb-5">
        ...
        <a class="btn-primary" href="{{ route('scheme.create') }}">
    ...
    <div class="box col-span-12 lg:col-span-6">
        <div class="flex flex-wrap gap-4 justify-between items-center bb-dashed mb-4 pb-4 lg:mb-6 lg:pb-6">
            ...
            <div class="flex items-center gap-4 flex-wrap grow sm:justify-end">
                <form method="GET" action="{{ route('scheme.index') }}"
                ...
                <thead class="custom-thead">
                    ...
                    @foreach ($schemes as $scheme)
                        <tr class="even:bg-secondary/5 dark:even:bg-bg3">
                            <td class="py-5 px-6">{{ ($scheme->currentPage() - 1) * $scheme->perPage() + $loop->iteration }}</td>
