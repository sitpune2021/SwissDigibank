    ...
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4 lg:mb-4">
        <div class="flex items-start flex-col gap-2">
            <h1 class="text-lg uppercase font-semibold">
                Master Settings - Edit Provisioning Percentage
            </h1>
        </div>
    </div>
    <div class="flex flex-col dark:bg-bg3 lg:flex-row justify-between mt-7 gap-5">
        ...
        <div class=" w-full  overflow-hidden">
            <div class="box dark:bg-bg3 border-gray-200 shadow-md rounded-lg">
                <!-- Header -->
                <div class="border-b font-semibold text-lg uppercase">NPA Provisioning Settings</div>
                <div class="  mt-3 px-4 text-lg uppercase text-primary">Secured Loans</div>
                ...
                <div class=" overflow-x-auto">
                    <div class="mb-4 mt-5">
                        ...
                        <input type="text" id="" name=""
                            ...
                            placeholder=" Standard Asset Provisioning (%)">
                ...
                <div class=" overflow-x-auto">
                    <div class="mb-4 ">
                        <label for="" class="block font-medium mb-2">
                            Sub-standard Asset Provisioning (%)
                        </label>
                        <input type="text" id="" name=""
                            class="w-full border rounded-10 px-3 py-3 text-sm bg-secondary/5 dark:bg-bg3"
                            placeholder=" Sub-standard Asset Provisioning (%)">
                ...
                <div class=" overflow-x-auto">
                    <div class="mb-4 ">
                        <label for="" class="block font-medium mb-2">
                            Doubtful-1 Asset Provisioning (%)
                        </label>
                        <input type="text" id="" name=""
                            class="w-full border rounded-10 px-3 py-3 text-sm bg-secondary/5 dark:bg-bg3"
                            placeholder="Doubtful-1 Asset Provisioning (%)">
                ...
                <div class=" overflow-x-auto">
                    <div class="mb-4 ">
                        <label for="" class="block font-medium mb-2">
                            Doubtful-2 Asset Provisioning (%)
                        </label>
                        <input type="text" id="" name=""
                            class="w-full border rounded-10 px-3 py-3 text-sm bg-secondary/5 dark:bg-bg3"
                            placeholder="Doubtful-2 Asset Provisioning (%)">
                ...
                <div class=" overflow-x-auto">
                    <div class="mb-4 ">
                        <label for="" class="block font-medium mb-2">
                            Doubtful-3 Asset Provisioning (%)
                        </label>
                        <input type="text" id="" name=""
                            class="w-full border rounded-10 px-3 py-3 text-sm bg-secondary/5 dark:bg-bg3"
                            placeholder="Doubtful-3 Asset Provisioning (%)">
                ...
                <div class=" overflow-x-auto">
                    <div class="mb-4 ">
                        <label for="" class="block font-medium mb-2">
                            Loss Asset Provisioning (%)
                        </label>
                        <input type="text" id="" name=""
                            class="w-full border rounded-10 px-3 py-3 text-sm bg-secondary/5 dark:bg-bg3"
                            placeholder="Loss Asset Provisioning (%)">

                    </div>
                </div>
                <div class="  mt-3 px-4 text-lg uppercase text-primary">
                    Unsecured Loans
                </div>
