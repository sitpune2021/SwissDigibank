        ...
        <table class="w-full whitespace-nowrap select-all-table" id="transactionTable1">
            ...
            <tbody>
                ...
                <tr class="border-b dark:border-bg3">
                    ...
                    <td class="py-3 px-6">{{ $item->member_info_old_member_no ?? '' }}</td>
                    ...
                    <td class="py-3 px-6">
                        {{ $item->member_info_father_name ?? ($item->member_info_spouse_name ?? '') }}
                    </td>
                    ...
                    <td class="py-3 px-6">
                        {{ $item->kyc?->member_kyc_aadhaar_no ?? '' }}
                    </td>

                    <td class="py-3 px-6">
                        {{ $item->kyc?->member_kyc_pan_no ?? '' }}
                    </td>
