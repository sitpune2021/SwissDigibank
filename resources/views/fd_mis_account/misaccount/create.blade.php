                ...
                <div class="grid grid-cols-2 gap-4 mt-6 xl:mt-8 xxxxxl:gap-6">
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <select id="member_id" name="member_id"
                            ...
                            <option value="{{ $member->id }}" {{ old('member_id', $misaccount->member_id ?? '') ==
                                $member->id ? 'selected' : '' }} data-fullname="{{ $member->full_name }}"
                                data-address="{{ $member->address->member_address_line_1 ?? '' }}"
                                data-branch="{{ $member->general_branch }}"
                                data-mobile="{{ $member->member_info_mobile_no ?? '' }}" {{ old('member_id') ==
                                $member->id ? 'selected' : '' }}>
                                {{ $member->full_name }}
                            </option>
                            @endforeach
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <input type="text" id="date" name="open_date" placeholder="DD/MM/YYYY"
                            value="{{ old('open_date', isset($misaccount) ? $misaccount->open_date : '') }}"
                            class="w-full text-sm bg-secondary/5 dark:bg-bg3 border rounded-10 px-3 md:px-6 py-3 md:py-3">
                    ...
                    <div class="nominee-item flex flex-wrap gap-4 items-end bg-gray-50 p-3 rounded-md shadow">
                        ...
                        <div class="flex-1 min-w-[200px]">
                            ...
                            <select name="nominee_relation[]"
                                ...
                                <option value="wife" {{ $nominee->nominee_relation == 'wife' ? 'selected' : '' }}>Wife
                                </option>
                        ...
                        <table class="w-full border-collapse min-w-[600px]">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b  border-gray-200">
                                    ...
                                    <td class="px-3 py-2 text-center">{{ number_format($transaction->amount, 2) }}</td>
                ...
                <div class="grid grid-cols-2 gap-4 mt-6 xl:mt-8 xxxxxl:gap-6">
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <input type="text" id="date2" name="transaction_date" placeholder="DD/MM/YYYY"
                            class="w-full text-sm bg-secondary/5 dark:bg-bg3 border rounded-10 px-3 md:px-6 py-3 md:py-3"
                            value="{{ old('transaction_date', isset($misaccount) ? $misaccount->transaction_date : '') }}">
