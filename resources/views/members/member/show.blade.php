...
@section('content')
    <div class="flex flex-wrap gap-3 mb-3 text-center">
        <a class="px-2 py-1 text-sm text-white bg-blue-500 rounded-md btn-info hover:bg-blue-600">SHARE HOLDINGS</a>

        <a class="px-2 py-1 text-sm text-white bg-green-500 rounded-md btn-success hover:bg-green-600">ALLOCATE SHARES</a>

        <a class="px-2 py-1 text-sm text-white bg-yellow-500 rounded-md btn-warning hover:bg-yellow-600">ADD SHARE
            AMOUNT</a>

        <a class="px-2 py-1 text-sm text-white bg-yellow-500 rounded-md btn-warning hover:bg-yellow-600">ADD MEMBERSHIP
            CHARGES</a>

        <a class="px-2 py-1 text-sm text-white bg-blue-500 rounded-md btn-info hover:bg-blue-600">VIEW TRANSACTIONS</a>

        <!-- Dropdown -->
        <div class="relative">
            <button type="button" class="px-2 py-1 text-sm text-white bg-green-500 rounded-md hover:bg-green-600"
                onclick="toggleDropdown()">DEBIT OTHER CHARGES</button>
            <ul id="dropdown-menu" class="absolute right-0 z-10 hidden mt-2 text-left bg-white border rounded shadow-md">
        ...
        <a title="DOWNLOAD 15G/ 15H"
            class="px-2 py-1 text-sm text-gray-700 bg-gray-200 rounded-md btn-default hover:bg-gray-300">
            <i class="fa fa-print"></i> DOWNLOAD 15G/ 15H
        </a>

        <a class="px-2 py-1 text-sm text-white bg-yellow-500 rounded-md btn-warning hover:bg-yellow-600">
            <i class="fa fa-plus" aria-hidden="true"></i> UPLOAD 15G/ 15H
        </a>

        <a class="px-2 py-1 text-sm text-white bg-red-500 rounded-md btn-danger hover:bg-red-600">REMOVE MEMBER</a>

        <a class="px-2 py-1 text-sm text-white bg-indigo-500 rounded-md btn-primary hover:bg-indigo-600">
            <i class="fa fa-print"></i> APPLICATION FORM
        </a>

        <a class="px-2 py-1 text-sm text-white bg-blue-500 rounded-md btn-info hover:bg-blue-600">SHOW AUDIT TRAIL</a>
    </div>


    <div class="grid grid-cols-12 gap-4 xxl:gap-6">
        <!-- Left Panel -->
        <div class="col-span-12 overflow-x-hidden lg:col-span-6">
            <table class="w-full text-sm bg-white border rounded shadow whitespace-nowrap">
    <tbody>
                ...
                <div><span>dhayari</span></div>
                    ...
                    <div class="mt-4 bg-white border rounded shadow">
                        ...
                        <div class="flex items-center justify-between px-4 py-2 rounded-t">
                            <span class="font-semibold uppercase">Appointment Details</span>
                            <button class="px-2 py-1 text-xs text-white bg-green-500 border rounded ">+
