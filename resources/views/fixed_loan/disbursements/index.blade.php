                    ...
                    <tbody>
                        @foreach($disbursements as $disbursement)
                            <tr class="border-b dark:border-bg3">
                                ...
                                <td class="text-start !py-5 px-6">
                                    <div class="flex items-center gap-1">
                                        {{ number_format($disbursement->loan_amount, 2) }}
                                    </div>
                                </td>
                                <td class="text-start !py-5 px-6">
                                    ...
                                    <div class="flex justify-center">
                                        <div class="relative">
                                            ...
                                            <ul class="horiz-option popover-content">
                                                <li>
                                                <a href="{{ route('fixed_loan.disbursements.disburse-loan', $disbursement->id) }}" class="single-option uppercase">Disburse Loan</a>
                                                </li>
                                                <li>
                                                    <form action="{{ route('fixed_loan.cancel', $disbursement->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to cancel this loan?');">
                                                        @csrf
