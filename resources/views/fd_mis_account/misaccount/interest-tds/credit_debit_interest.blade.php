                ...
                <form action="{{ route('mis.creditdebit.store', $misaccount->id) }}" method="POST">
                    ...
                    <div class="col-span-2 md:col-span-1 mt-8 mb-2">
                        <div class="flex flex-col sm:flex-row justify-center gap-3 mt-5">
                            ...
                            <a href="{{ route('fd-accounts.transactions.details', [$fdAccount->id, $transaction->id]) }}"
                        ...
                        <table class="w-full text-sm  text-gray-700 rounded-md">
                            <tbody>
                                <tr class="border-b border-gray-200">
                                    ...
                                    <td class="px-3 py-2">{{ $misaccount->member->member_info_first_name }}
                                        {{ $misaccount->member->member_info_last_name }} </td>
                                </tr>
                                <tr class="border-b border-gray-200">
