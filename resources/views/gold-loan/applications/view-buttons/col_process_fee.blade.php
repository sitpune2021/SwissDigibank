...
<div class="main-inner">
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4 lg:mb-8">
        <div class="flex items-start flex-col gap-2">
            <h1 class="text-lg font-semibold capitalize">Gold Loan Processing Fee</h1>
        </div>
    </div>
    <div class="flex flex-col dark:bg-bg3 lg:flex-row justify-between mt-7 gap-5">
        ...
        <div class="w-full overflow-hidden">
            <div class="box dark:bg-bg3 border mb-4 border-gray-200 shadow-md rounded-lg">
                <form action="{{ route('gold-loan.col_process_fee.store', $application->id) }}" method="POST">
                    @csrf
                    ...
                    <div class="flex flex-col min-w-10 sm:flex-row justify-center gap-3 mt-5">
                        ...
                        <button class="btn-outline uppercase justify-center" type="reset">
                            <a href="{{ route('gold-loan.applications.view', $application->id) }}"> BACK</a>
                        </button>
                    </div>
                </form>
            </div>
