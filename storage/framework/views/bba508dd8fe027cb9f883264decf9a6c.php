<nav class="navbar-top topbarfull z-20 gap-3 bg-n0 py-3 shadow-sm duration-300 border-b border-n0 dark:border-n700 dark:bg-bg4 xl:py-4 xxxl:py-6"
    ...
    <div class="topbar-inner flex items-center justify-between">
        <div class="flex grow items-center gap-4 xxl:gap-6">
            <a href="<?php echo e(route('index1')); ?>" class="topbar-logo hidden shrink-0">
                <img width="174" height="38" src="<?php echo e(asset('assets/images/SBC_Logo.png')); ?>" alt="logo"
        ...
        <div class="flex items-center gap-3 sm:gap-4 xxl:gap-6">
                ...
                <div id="notification"
                    ...
                    <ul class="flex w-[300px] flex-col p-4">
                        <div class="flex cursor-pointer gap-2 rounded-md p-2 duration-300 hover:bg-primary/10">
                            <img src="<?php echo e(asset('assets/images/user-3.png')); ?>" width="44" height="40" class="shrink-0 rounded-full"
                                alt="img" />
                            <div class="text-sm">
                        ...
                        <div class="flex cursor-pointer gap-2 rounded-md p-2 duration-300 hover:bg-primary/10">
                            <img src="<?php echo e(asset('assets/images/user-7.png')); ?>" width="44" height="40"
            ...
            <!-- Chat Link -->
            <a href="<?php echo e(route('transfer.chat')); ?>"
            ...
            <div class="relative shrink-0">
                <div id="profile-btn" class="w-10 cursor-pointer md:w-12">
                    <img src="<?php echo e(asset('assets/images/user-big-4.png')); ?>" class="rounded-full" width="48"
                        height="48" alt="profile img" />
                </div>
                <div id="profile"
                    class="hide absolute top-full z-20 rounded-md bg-n0 shadow-[0px_6px_30px_0px_rgba(0,0,0,0.08)] duration-300 dark:bg-bg4 ltr:right-0 ltr:origin-top-right rtl:left-0 rtl:origin-top-left">
                    <div class="flex flex-col items-center border-b p-3 text-center dark:border-n500 lg:p-4">
                        <img src="<?php echo e(asset('assets/images/user-big-4.png')); ?>" width="60" height="60" class="rounded-full"
                            alt="profile img" />
                        <h6 class="h6 mt-2">
                        <?php echo e(auth()->user()->name); ?> </h6>
                    ...
                    <ul class="flex w-[250px] flex-col p-4">
                        ...
                        <li>
                            <a href="<?php echo e(route('support.help.center')); ?>"
                                class="flex items-center gap-2 rounded-md p-2 duration-300 hover:bg-primary hover:text-n0">
                                <span>
                        ...
                        <li>
                            <a href="<?php echo e(route('settings.security')); ?>"
                                class="flex items-center gap-2 rounded-md p-2 duration-300 hover:bg-primary hover:text-n0">
                                <span>
                        ...
                        <li>
                            ...
                            <form id="logout-form" action="<?php echo e(route('log.out')); ?>" method="POST" style="display: none;">
                                <?php echo csrf_field(); ?>
                            </form>
                        </li>
                    </ul>
...
</nav><?php /**PATH C:\xampp\htdocs\swiss bank live code\resources\views/layout/nav.blade.php ENDPATH**/ ?>