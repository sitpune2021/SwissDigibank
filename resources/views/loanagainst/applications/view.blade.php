...
@section('content')
    ...
    <div class="main-inner">
        ...
        <div class="flex flex-wrap gap-3">
            ...
            <a href="{{ route('loanagainst.applications.view-buttons.show-emi-chart', $application->id) }}" target="_blank"
                class="btn-primary  text-sm uppercase px-2 py-2 rounded-10 ">
                Show EMI Chart
            </a>
            {{-- Submit button only when Draft --}}
            @if ($application->status == 0)
                <form action="{{ route('loanagainst.submitForApproval', $application->id) }}" method="POST">
                    @csrf
            ...
            @if ($application->status != 0 && $application->status != 3)
                <div class="relative inline-block text-left">
                    <!-- Button -->
                    <button type="button"
                        class="btn-secondary text-sm uppercase px-2 py-2 rounded-10 flex items-center gap-2"
            ...
            <div class=" w-full  overflow-hidden">
                <div class="overflow-x-auto box rounded-lg dark:bg-bg3 p-2 bg-white shadow-md">
                    <div class="text-end p-3">
                        @if ($application->status != 2)
                            <a href="{{ route('loanagainst.applications.edit', $application->id) }}"
            ...
            <div class=" w-full ">
                ...
                <div class="flex flex-row gap-4  dark:bg-bg3  rounded-10">
                    ...
                    <div class="w-full bg-white dark:bg-bg3 p-4 rounded-10 shadow-md border border-gray-200">
                        ...
                        <div
                            class="flex justify-center items-center mt-3 px-4 py-6 mt-3 text-2xl sm:text-3xl font-semibold text-red-500">
                            <label class="cursor-pointer">
                                <h3>
