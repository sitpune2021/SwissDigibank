...
<div class="main-inner">
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4 lg:mb-4">
        <div class="flex items-start flex-col gap-2">
         ...
         Master Settings - Daily / Weekly Loan
            </h1>
        </div>
    </div>
    <div class="flex flex-col dark:bg-bg3 lg:flex-row justify-between mt-7 gap-5">
        ...
        <div class=" w-full  overflow-hidden">
            <div class="box dark:bg-bg3 border-gray-200 shadow-md rounded-lg">
                <div class=" overflow-x-auto">
                    ...
                    <div class="mb-4 mt-5">
                        ...
                        <div class="flex items-center gap-3">
                            <input type="radio" id="" name="Add_collect_adv" class="">
                            <p>Yes </p>
                            <input type="radio" id="" name="Add_collect_adv" class="">
                            <p>No</p>
                        </div>
                     ...
                     <div class="mb-4 mt-5">
                        <label for="" class="block font-medium mb-2">
                         Scheme Based Loan Application
                        </label>
                        <div class="flex items-center gap-3">
                            <input type="radio" id="" name="sch_base_loan" class="">
                            <p>Yes </p>
                            <input type="radio" id="" name="sch_base_loan" class="">
                            <p>No</p>
                        </div>
                     ...
                     <div class="mb-4 mt-5">
                        <label for="" class="block font-medium mb-2">
                         Debit Other Charges Directly To Loan Account
                        </label>
                        <div class="flex items-center gap-3">
                            <input type="radio" id="" name="debit_oth_cha" class="">
                            <p>Yes </p>
                            <input type="radio" id="" name="debit_oth_cha" class="">
                            <p>No</p>
                        </div>
                     ...
                     <div class="mb-4 mt-5">
                        <label for="" class="block font-medium mb-2">
                       Debit all interest in fore close 
                        </label>
                        <div class="flex items-center gap-3">
                            <input type="radio" id="" name="debit_all_int" class="">
                            <p>Yes </p>
                            <input type="radio" id="" name="debit_all_int" class="">
                            <p>No</p>
                        </div>
                 ...
                 <div class=" overflow-x-auto">
                    <div class="mb-4 ">
                        ...
                        <div class="flex gap-3">
                            <input type="text" id="" name=""
                                class="w-full border rounded-10 px-3 py-3 text-sm bg-secondary/5 dark:bg-bg3"
                                placeholder="Stamp Duty Charges (%)">
                    ...
                    <div class="mb-4 ">
                     ...
                     Fore Close Charges (%)
                        ...
                        <div class="flex gap-3">
                            <input type="text" id="" name=""
                                class="w-full border rounded-10 px-3 py-3 text-sm bg-secondary/5 dark:bg-bg3"
                                placeholder="Fore Close Charges (%)">
                        </div>
                ...
                <div class=""><hr></div>
                <div class="uppercase text-lg  text-center font-semibold mt-3">Charges Per EMI </div>
                ...
                <div class=" overflow-x-auto mt-3">
                    <div class="mb-4 ">
                        ...
                        <input type="text" id="" name=""
                            class="w-full border rounded-10 px-3 py-3 text-sm bg-secondary/5 dark:bg-bg3"
                            placeholder="SMS Charges per EMI (%)">
                   ...
                   <div class=" overflow-x-auto mt-3">
                    <div class="mb-4 ">
                        ...
                        <input type="text" id="" name=""
                            class="w-full border rounded-10 px-3 py-3 text-sm bg-secondary/5 dark:bg-bg3"
                            placeholder="Stationary Charges per EMI (%)">
                 ...
                 <div class=" overflow-x-auto mt-3">
                    <div class="mb-4 ">
                        ...
                        <input type="text" id="" name=""
                            class="w-full border rounded-10 px-3 py-3 text-sm bg-secondary/5 dark:bg-bg3"
                            placeholder="Fuel Charges per EMI (%)">
                 ...
                 <div class=" overflow-x-auto mt-3">
                    <div class="mb-4 ">
                        ...
                        <input type="text" id="" name=""
                            class="w-full border rounded-10 px-3 py-3 text-sm bg-secondary/5 dark:bg-bg3"
                            placeholder="Maintenance Charges per EMI (%)">
                 ...
                 <div class=" overflow-x-auto mt-3">
                    <div class="mb-4 ">
                        <label for="" class="block font-medium mb-2">
                        Collection Charges per EMI (%)
                        </label>
                        <input type="text" id="" name=""
                            class="w-full border rounded-10 px-3 py-3 text-sm bg-secondary/5 dark:bg-bg3"
                            placeholder="Collection Charges per EMI (%)">
