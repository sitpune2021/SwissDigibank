...
<div class="main-inner">
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4 lg:mb-8">
        ...
        <div class="box mb-4 xxxl:mb-6">
            <form action="<?php echo e(route('share-certificates.edit')); ?>" method="POST" class="grid grid-cols-2 gap-4 xxxl:gap-6">
                <?php echo csrf_field(); ?>
<!----------------------------------------------------------------------------------------- -->
...
<!-- ------------------------------------------------------------------------------ -->
                ...
                <div class="flex items-start gap-4"> 
    <label for="aadhaar_no" class="w-48 text-sm font-medium">Aadhaar No:<span class="text-red-500">*</span></label>
    <div class="w-full">
...
<div class="flex items-start gap-4"> 
    <label for="address" class="w-48 text-sm font-medium">Address:<span class="text-red-500">*</span></label>
    <div class="w-full">
...
<!--------------------------------------------------------------------------------->
                ...
                <div class="col-span-2 flex gap-4 md:gap-6 mt-2">
                    ...
                    <button class="btn-outline" type="reset"
                        onclick="window.location.href='<?php echo e(route('sharecerticate.index')); ?>'">
                        Back
                    </button>
                    <button class="btn-outline" type="reset">
                        Reset
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views\share-certificates\show.blade.php ENDPATH**/ ?>