                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="flex justify-center">
                                        <img src="<?php echo e(asset('assets/images/my-wallet-1.png')); ?>" width="296" class="rounded-xl"
                                            height="200" alt="card img" />
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="flex justify-center">
                                        <img src="<?php echo e(asset('assets/images/my-wallet-2.png')); ?>" width="296" class="rounded-xl"
                                            height="200" alt="card img" />
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="flex justify-center">
                                        <img src="<?php echo e(asset('assets/images/my-wallet-3.png')); ?>" width="296" class="rounded-xl"
                                            height="200" alt="card img" />
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views\transfer\make-transfer.blade.php ENDPATH**/ ?>