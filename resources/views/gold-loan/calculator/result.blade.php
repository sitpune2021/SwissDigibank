...
<div class="p-6 bg-white shadow rounded-lg">
  ...
  <div class="overflow-x-auto">
    <table class="w-full text-sm border border-gray-400 rounded-lg">
      <tbody>
        ...
        <tr>
          <td class="font-semibold py-2 px-3 uppercase border border-gray-300">Interest Type</td>
          <td class="py-2 px-3 border border-gray-300">{{ ucfirst($interest_type) }}</td>
          <td class="font-semibold py-2 px-3 uppercase border border-gray-300">Processing Charges</td>
          <td class="py-2 px-3 border border-gray-300">₹ {{ number_format($processing_fee,2) }} (Incl. 18% GST)</td>
        </tr>

        <tr>
          <td class="font-semibold py-2 px-3 uppercase border border-gray-300">Insurance Charges</td>
          <td class="py-2 px-3 border border-gray-300">₹ {{ number_format($insurance_amount,2) }} (Incl. 0% GST)</td>
          <td class="font-semibold py-2 px-3 uppercase border border-gray-300">Stamp Duty</td>
          <td class="py-2 px-3 border border-gray-300">₹ {{ number_format($stamp_amount,2) }} (Incl. 18% GST)</td>       
        </tr>

        <tr>
          <td class="font-semibold py-2 px-3 uppercase border border-gray-300">EMI Count</td>
          <td class="py-2 px-3 border border-gray-300">{{ $installments }}</td>
          <td class="font-semibold py-2 uppercase px-3 border border-gray-300">EMI Payout</td>
          <td class="py-2 px-3 border  border-gray-300">{{ strtoupper($payout) }}</td>        
        </tr>

        <tr>
          <td class="font-semibold py-2 uppercase px-3 border border-gray-300">Tenure</td>
  ...
  <div class="overflow-auto mt-5 box">
    ...
    <table class="w-full mt-5 table-auto text-sm border border-gray-300 border-collapse">
        ...
        <thead>
            <tr class="bg-gray-100 border uppercase border-gray-300">
                <th class="p-2 border uppercase border-gray-300">EMI NO</th>
                <th class="p-2 border uppercase border-gray-300">EMI DATE</th>
                <th class="p-2 border uppercase border-gray-300">DUE DATE</th>
                <th class="p-2 border uppercase border-gray-300">PRINCIPAL (A)</th>
                <th class="p-2 border uppercase border-gray-300">INTEREST (B)</th>
                <th class="p-2 border uppercase border-gray-300">CHARGES PER EMI (C)</th>
                <th class="p-2 border uppercase border-gray-300">EMI (A+B+C)</th>
                <th class="p-2 border uppercase border-gray-300">BAL. PRINCIPAL</th>
            </tr>
        </thead>
