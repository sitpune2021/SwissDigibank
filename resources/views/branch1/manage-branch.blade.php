...
<div class="main-inner">
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4 lg:mb-8">
        <div>
            <h1 class="text-xl font-semibold">Manage Branches</h1>
            <ol class="breadcrumb flex text-sm text-gray-600 mt-1 space-x-1">
                ...
                <li><a href="{{ url('/manage-branch') }}" class="text-blue-600 hover:underline">Branch</a></li>
                <li class="text-gray-500">Manage Branches</li>
            </ol>
        </div>
