...
<div class="main-inner">
    <div class="mb-6 flex flex-wrap items-center  justify-between gap-4 lg:mb-8">
        <div class="flex items-start flex-col gap-2" style=";">
      ...
      <div class="text-center  flex justify-center gap-5 mt-4">
        <a href="{{ route('loan.payout_chart_loan_application.pdf' ,$loan_no) }}" class="px-4 py-2 btn-primary uppercase"
    ...
    <div class="box mt-5">
        ...
        <div class="" style="margin-top:30px;">
            <table style="width: 100%;font-size: 14px !important ; padding: 5px;">
                ...
                <tr>
                    <td style="padding: 5px;  font-size:14px">1</td>
                    <td style="padding: 5px;  font-size:14px">{{$emi_date}}</td>
                    <td style="padding: 5px;  font-size:14px">{{$emi_principle}}</td>
                    <td style="padding: 5px;  font-size:14px">{{$emi_interest}}</td>
                    <td style="padding: 5px;  font-size:14px">{{$per_emi_charges}}</td>
                    <td style="padding: 5px;  font-size:14px"> {{ $emi_amount }}</td>
                    <td style="padding: 5px;  font-size:14px">{{ $balance_principle }}</td>
                </tr>
                <tr>
