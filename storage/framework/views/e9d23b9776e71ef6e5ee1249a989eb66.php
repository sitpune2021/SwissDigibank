    ...
    <div class="main-inner">
        <div class="mb-6 flex flex-wrap items-center justify-between gap-3 lg:mb-5">
            ...
            <a class="btn btn-warning btn-sm" title="UN-ALLOTTED SHARE LIST" onclick="block_ui()"
                href="<?php echo e(route('shares-holdings.create')); ?>">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views\shares-holdings\index.blade.php ENDPATH**/ ?>