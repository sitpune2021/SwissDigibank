            ...
            <div class="w-full  overflow-hidden">
                ...
                <div class="box dark:bg-bg3 border mb-4 border-gray-200  shadow-md rounded-lg  overflow-x-auto p-4">
                    <div class="flex  justify-end gap-3 mb-3">
                        <a class=" btn-primary p-1" href="{{ url('/print-documents/transaction-receipt?t_id='.$transaction->id.'&t_type=DdAccountTransaction') }}">
                            <i class="las la-print"></i>
                        </a>
                        <a class=" btn-error p-1" title="Delete" data-confirm="Are you sure to delete transaction?"
                            rel="nofollow" data-method="delete" href="{{ route('dds-accounts.transactions.destroy', [$ddsAccount->id, $transaction->id]) }}">
                  ...
                  <table class="w-full whitespace-nowrap text-sm text-left ">
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr class="border-t">
                                ...
                                <td class="px-4 py-2"> {{ number_format($transaction->balance_available, 2) }}</strong>
                                    </td>
                            </tr>
                            <tr class="border-t">
                            ...
                            <tr class="border-t">
                                ...
                                <td class="px-4 py-2">
                                    ...
                                    \Carbon\Carbon::parse($transaction->approval_date)->format('d-m-Y') : '-' }}
                                </td>
                            </tr>
