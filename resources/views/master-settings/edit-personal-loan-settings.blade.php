                ...
                <div class=" overflow-x-auto">
                    <div class="mb-4 mt-5">
                        ...
                        <div class="flex items-center gap-3">
                            <input type="radio" id="" name="add-charges-emi" class="">
                            <p>Yes </p>
                            <input type="radio" id="" name="add-charges-emi" class="">
                            <p>No</p>
                        </div>
                    ...
                    <div class="mb-4 mt-5">
                        ...
                        <div class="flex items-center gap-3">
                            <input type="radio" id="" name="add_coll_adv" class="">
                            <p>Yes </p>
                            <input type="radio" id="" name="add_coll_adv" class="">
                            <p>No</p>
                        </div>
                     ...
                     <div class="mb-4 mt-5">
                        ...
                        <div class="flex items-center gap-3">
                            <input type="radio" id="" name="cbil" class="">
                            <p>Yes </p>
                            <input type="radio" id="" name="cbil" class="">
                            <p>No</p>
                        </div>
