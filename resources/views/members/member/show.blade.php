...
<div class="flex flex-wrap gap-3 mb-3 text-center">
    ...
    <a href="{{ url('/share/allocate') }}?member_id={{ $member->id }}" class="text-sm rounded-10 px-2 py-2 btn-primary">
        ALLOCATE SHARES
    </a>
                ...
                <tbody>
                    ...
                    <tr class="border-b dark:even:bg-bg3">
                        ...
                        <td class="p-2">
                            <div>
                                <span>
                                    {{ $member->member_info_dob ?
                                    \Carbon\Carbon::parse($member->member_info_dob)->format('d-m-Y') : 'N/A' }}
                                </span>
                            </div>
                ...
                <table class="w-full text-sm ">
                    <tbody>
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-6 py-2 text-start">
                                @php $idProofBack = $documents->where('document_category', 'id_proof_back')->first();
                                @endphp
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-6 py-2 text-start">
                                @php $addressProof = $documents->where('document_category', 'address_proof')->first();
                                @endphp
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-6 py-2 text-start">
                                @php $addressProofBack = $documents->where('document_category',
                                'address_proof_back')->first(); @endphp
            ...
            <div>
                ...
                <div class="mt-4 overflow-hidden bg-white box border rounded shadow">
                    ...
                    <div class="flex items-center justify-between px-4 py-2 border-b">
                        ...
                        <span class="px-4 py-2 text-sm font-bold text-error bg-error/20 rounded">PENDING</span>
                    </div>
                    ...
                    <div class="mt-4 box  border rounded shadow">
                        ...
                        <div class="flex items-center justify-between px-4 py-2 rounded-t">
                            <span class="font-semibold text-lg uppercase">
                                {{ isset($member) ? $member->member_info_first_name . ' ' .
                                $member->member_info_last_name : 'Add member' }}
                            </span>
                ...
                <div>
                    ...
                    <div class="mt-4 box border rounded shadow">
                        ...
                        <div class="flex mt-5 bg-white gap-3 ">
                            <button
                                class="px-4 py-2 text-sm font-semibold uppercase btn-primary">
                                Active Account
                            </button>
                            <button
                                class="px-4 py-2 text-sm font-semibold uppercase btn-primary">
