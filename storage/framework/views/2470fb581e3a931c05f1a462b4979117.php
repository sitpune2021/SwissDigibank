        ...
        <form action="<?php echo e(isset($route) && isset($method) ? $route : ''); ?>" method="POST"
                ...
                <?php $__currentLoopData = $formFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-span-2 md:col-span-1 relative">
                        <label for="<?php echo e($id); ?>" class="block mb-2 font-medium">
                        ...
                        <?php else: ?>
                            <div class="relative">
                                <input type="<?php echo e($type); ?>" name="<?php echo e($name); ?>" id="<?php echo e($id); ?>"
                                    ...
                                    placeholder="Enter <?php echo e(strtolower($label)); ?>" <?php echo e($required ? 'required' : ''); ?> />
                                <?php echo $hasHtml ? $field['html'] : ''; ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views\share-holdings\add-shares.blade.php ENDPATH**/ ?>