<?php $__env->startSection('page-title', 'Promoters Share Holding Details'); ?>
<?php $__env->startSection('action-button'); ?>
    <a class="btn-primary" href="<?php echo e(route('shareholding.create')); ?>">
    ...
    <div class="box col-span-12 lg:col-span-6">
        <div class="flex flex-wrap gap-4 justify-between items-center bb-dashed mb-4 pb-4 lg:mb-6 lg:pb-6">
            ...
            <div class="flex items-center gap-4 flex-wrap grow sm:justify-end">
                <form action="<?php echo e(route('shareholding.index')); ?>"
                    ...
                    <?php if(request('search')): ?>
                        <a href="<?php echo e(route('shareholding.index')); ?>"
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $share_holdings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $share): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="px-6 py-4"><?php echo e($share->promotor->first_name ?? 'N/A'); ?></td>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Avantika\office_work\Swiss\resources\views/company/share-holdings/manage-shareholding.blade.php ENDPATH**/ ?>