    ...
    <div class="box">
            ...
            <div class="mb-4" id="intersetTypeRadio">
                ...
                <div class="mt-1 flex flex-wrap gap-3">
                    ...
                    <label class="flex items-center gap-2 space-x-2 p-2">
                        ...
                        <span class="text-gray-70 uppercase uppercase">Reducing EMI</span>
                    </label>
        ...
        <div id="charges-per-emi" hidden>
            <div class="w-full my-4">
                ...
                <h4
                    class="uppercase text-center font-semibold text-lg sm:text-xl md:text-2xl mt-4 flex items-center justify-center gap-2">
                    Charges Per EMI
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead class="bg-secondary/5  text-black">
                            <tr class="">
                                <th colspan="2" class="text-center py-3 uppercase">DAYS</th>
                            ...
                            <tr class="">
                                <th class="text-center uppercase">FROM (Start From Day 1)</th>
                                <th class="text-center  uppercase">TO</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr >
