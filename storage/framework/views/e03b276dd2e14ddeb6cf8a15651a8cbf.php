                ...
                <div class="col-span-2 flex gap-4 md:gap-6 mt-4">
                    <?php if(isset($method)): ?>
                        <button class="btn-primary" type="submit">
                            <?php echo e($method === 'PUT' ? 'Update' : 'Add'); ?> Member
                        </button>
                    <?php endif; ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss bank live code\resources\views/member/create.blade.php ENDPATH**/ ?>