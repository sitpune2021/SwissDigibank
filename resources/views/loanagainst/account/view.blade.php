...
<div class="main-inner">
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4 lg:mb-8">
        <div class="flex items-start flex-col gap-2">
            <h1 class="text-2xl uppercase font-semibold">LOAN AGAINST DEPOSITE - {{$goldLoan->id}} </h1>
        </div>
    </div>

    <div class="flex flex-wrap gap-3">
        <a href="{{route('loanagainst.account.transaction',$goldLoan->id)}}" class="btn-secondary uppercase px-2 py-2 rounded-10 ">
            View Transaction
        </a>
        @if(
            ...
            <a href="{{route('loanagainst.account.pay-emi',$goldLoan->id)}}" class="btn-primary uppercase px-2 py-2 rounded-10 ">
                Pay Emi
            </a>
            @if(strtolower($goldLoan->scheme->gold_loan_setting) == 'flat_advanced_interest')
                <a href="{{ route('loanagainst.account.extension',$goldLoan->id) }}" class="btn-error uppercase px-2 py-2 rounded-10 ">
                    LOAN EXTENSION
                </a>
            @endif
        ...
        <a href="{{ route('loanagainst.account.fourcloser', $goldLoan->id) }}" class="btn-error uppercase px-2 py-2 rounded-10 ">
            Fore CloseLoan
        </a>
        
        <a href="{{ route('loanagainst.account.linksaving', $goldLoan->id) }}" class="btn-primary uppercase px-2 py-2 rounded-10 ">
        ...
        <div class="relative inline-block text-left">
            ...
            <div id="debitCharges"
                ...
                <div class="py-1">
                    <a href="{{route('loanagainst.debitChargesList.form',$goldLoan->id)}}"
        ...
        <a href="{{ route('loanagainst.account.audit-trail') }}" class="btn-primary uppercase  px-2 py-2 rounded-10 ">
            Show audit trail
        </a>
