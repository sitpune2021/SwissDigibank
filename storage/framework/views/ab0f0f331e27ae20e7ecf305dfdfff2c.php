  ...
  <nav
    ...
    <div class="topbar-inner flex items-center justify-between">
      <div class="flex grow items-center gap-4 xxl:gap-6">
        <a href="<?php echo e(route('dashboard.index1')); ?>" class="topbar-logo hidden shrink-0">
            ...
            <ul class="menu-ul">
              <li class="menu-li">
                ...
                <ul class="submenu-hide submenu">
                  <li>
                    <a href="<?php echo e(route('index1')); ?>l" class="submenu-link">
                      <i class="las la-minus text-xl"></i>
                      <span>Style 01</span>
                    </a>
                  </li>
...
<?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views\partials\_navigation.blade.php ENDPATH**/ ?>