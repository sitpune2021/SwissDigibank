...
@section('content')
    ...
    <div class="main-inner">
        ...
        <div class="flex flex-wrap gap-3">
            <a href="{{ route('daily_weekly.account.transaction', $goldLoan->id) }}"
            ...
            @if (strtolower($goldLoan->scheme->gold_loan_setting) != 'no_emi')
                ...
                @if (strtolower($goldLoan->scheme->gold_loan_setting) == 'flat_advanced_interest')
                    <a href="{{ route('daily_weekly.account.extension', $goldLoan->id) }}"
            ...
            {{-- @if (strtolower($goldLoan->scheme->gold_loan_setting) != 'flat_advanced_interest' && strtolower($goldLoan->scheme->gold_loan_setting) != 'reducing_emi')
        ...
        @endif   --}}
            ...
            <a href="{{ route('daily_weekly.account.fourcloser', $goldLoan->id) }}"
                class="btn-error uppercase text-sm px-2 py-2 rounded-10 ">
                Fore CloseLoan
            </a>

            <a href="{{ route('daily_weekly.account.linksaving', $goldLoan->id) }}"
                class="btn-primary uppercase text-sm px-2 py-2 rounded-10 ">
            ...
            <div class="relative inline-block text-left">
                ...
                <div id="debitCharges"
                    ...
                    <div class="py-1">
                        ...
                        <a href="{{ route('daily_weekly.clear-due.form', $goldLoan->id) }}"
                            class="flex items-center uppercase gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                            Clear Dues
                        </a>
                    </div>
            ...
            <form id="remove-account-form-{{ $goldLoan->id }}" action="{{ route('daily_weekly.remove', $goldLoan->id) }}"
            ...
            <a href="{{ route('daily_weekly.account.audit-trail') }}"
                class="btn-primary uppercase  text-sm px-2 py-2 rounded-10 ">
                Show audit trail
            </a>
            ...
            <div class=" w-full overflow-x-auto   overflow-hidden">
                ...
                <div class="bg-white dark:bg-bg3 box shadow-md mt-5 rounded-10 overflow-hidden">
                    ...
                    <div class="flex items-center justify-between rounded-10 bg-secondary/5 text-black px-4 py-3 cursor-pointer"
                        ...
                        <a href="{{ route('daily_weekly.uploadDocuments', $loan->id) }}"
                                        ...
                                        @foreach ($documents as $doc)
                                            <tr class="border-b text-center">
                                                ...
                                                <td class="px-4 text-start py-2">
                                                    ...
                                                    <form action="{{ route('daily_weekly.documents.destroy', $doc->id) }}"
