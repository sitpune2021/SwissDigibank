...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-span-2 flex gap-4 md:gap-6 mt-4">
                    ...
                    <?php endif; ?>
                    <button class="btn-outline" type="reset"
                        onclick="window.location.href='<?php echo e(route('shareholding.index')); ?>'">Back</button>
                </div>
            </form>
