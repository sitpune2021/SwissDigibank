        ...
        <div class="flex flex-col  dark:bg-bg3 lg:flex-row justify-between mt-7 gap-5">
            <div class=" w-full  box overflow-hidden">
                ...
                <form action="{{ route('fd.creditdebit.store', $fdAccount->id) }}" method="POST">
                    @csrf
                    <input type="hidden" name="transaction_purpose" value="tds">

                    <label class="font-semibold text-lg uppercase block mb-4">DEDUCT/ REVERSE TDS</label>
                    <hr>
                    ...
                    <div class="col-span-2 md:col-span-1 mt-8 mb-2">
                        <div class="flex flex-col min-w-10 sm:flex-row justify-center gap-3 mt-5">
                            ...
                            <a href="{{ route('fd-mis-schemes.fd_show', $fdAccount->id) }}"
                                class="btn-outline uppercase justify-center text-center">
                                Back
                            </a>
                        </div>
                    </div>
                        ...
                        <table class="w-full text-sm  text-gray-700 rounded-md">
                            <tbody>
                                ...
                                <tr class="border-b border-gray-200">
                                    ...
                                    <td class="px-3 py-2">₹{{ $fdAccount->fd_amount }}</td>
                                </tr>
                                <tr class="border-b border-gray-200">
                                    <td class="uppercase font-semibold px-3 py-2">Balance Available</td>
                                    <td class="px-3 py-2">₹{{ number_format($balance, 2) }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
