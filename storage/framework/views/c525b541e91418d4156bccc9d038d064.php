...
<div class="main-inner">
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4 lg:mb-8">
        ...
        <a class="btn-primary" href="<?php echo e(route('create.branch')); ?>">
    ...
    <div class="box col-span-12 lg:col-span-6">
        <div class="flex flex-wrap gap-4 justify-between items-center bb-dashed mb-4 pb-4 lg:mb-6 lg:pb-6">
            ...
            <div class="flex items-center gap-4 flex-wrap grow sm:justify-end">
                <form method="GET" action="<?php echo e(route('manage.branch')); ?>"
                    ...
                    <a href="<?php echo e(route('manage.branch')); ?>"
            ...
            <table class="w-full whitespace-nowrap select-all-table" id="transactionTable1">
                ...
                <tbody>
                    ...
                    <tr class="even:bg-secondary/5 dark:even:bg-bg3">
                        ...
                        <?php echo e($branch->stateData ? $branch->stateData->name : ''); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss bank live code\resources\views/branch/manage-branch.blade.php ENDPATH**/ ?>