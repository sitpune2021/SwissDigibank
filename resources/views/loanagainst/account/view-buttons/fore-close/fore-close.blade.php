...
<div class="main-inner">
    ...
    <div class="mb-4 flex flex-wrap items-center justify-between gap-4 lg:mb-4">
        <div class="flex items-start flex-col gap-2">
            <h3 class="uppercase text-lg font-semibold">FORE CLOSE LOAN AGAINST DEPOSITE</h3>
        </div>
    </div>
    <div class="rounded-lg border-l-4 border-yellow-500  p-2">
        <a href="" class="btn-primary text-sm uppercase rounded-10">
    ...
    <div class="flex flex-col dark:bg-bg3 lg:flex-row justify-between mt-7 gap-5">
        ...
        <div class=" w-full  overflow-hidden">
            <div class="box dark:bg-bg3 border mb-4 border-gray-200 shadow-md rounded-lg">
                <form action="{{ route('loanagainst.account.forecloser.store', $goldLoan->id) }}" method="POST">
                @csrf
                    <!-- Header -->
                    <div class=" py-3 ">
