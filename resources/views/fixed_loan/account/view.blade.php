...
@section('content')
    ...
    <div class="main-inner">
        ...
        <div class="flex flex-wrap gap-3">
            <a href="{{ route('fixed_loan.account.transaction', $goldLoan->id) }}"
                class="btn-secondary uppercase text-sm px-2 py-2 rounded-10 ">
                View Transaction
            </a>

            <a href="{{ route('fixed_loan.account.pay-emi', $goldLoan->id) }}"
            ...
            <a href="" class="btn-primary text-sm  uppercase px-2 py-2 rounded-10 ">
                ...
                <form id="remove-account-form-{{ $goldLoan->id }}"
                    action="{{ route('daily_weekly.remove', $goldLoan->id) }}" method="POST" class="inline">
                    @csrf
