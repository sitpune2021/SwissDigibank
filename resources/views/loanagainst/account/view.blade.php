...
@section('content')
    ...
    <div class="main-inner">
        ...
        <div class="flex flex-wrap gap-3">
            <a href="{{ route('loanagainst.account.transaction', $goldLoan->id) }}"
            ...
            <a href="{{ route('loanagainst.account.fourcloser', $goldLoan->id) }}"
                class="btn-error uppercase text-sm px-2 py-2 rounded-10 ">
                Fore CloseLoan
            </a>

            <a href="{{ route('loanagainst.account.linksaving', $goldLoan->id) }}"
                class="btn-primary uppercase text-sm px-2 py-2 rounded-10 ">
            ...
            <form id="remove-account-form-{{ $goldLoan->id }}" action="{{ route('loanagainst.remove', $goldLoan->id) }}"
            ...
            <a href="{{ route('loanagainst.account.audit-trail') }}"
                class="btn-primary uppercase text-sm  px-2 py-2 rounded-10 ">
                Show audit trail
            </a>
            ...
            <div class=" w-full overflow-x-auto   overflow-hidden">
                    ...
                    <div
                        ...
                        <div class=" flex gap-3">
                            <a href="javascript:void(0)" onclick="openModal()"
                                class="p-2 rounded-10 uppercase btn-primary">
                ...
                <div class="bg-white dark:bg-bg3 box shadow-md mt-5 rounded-10 overflow-hidden">
                    ...
                    <div class="flex items-center justify-between rounded-10 bg-secondary/5 text-black px-4 py-3 cursor-pointer"
                        ...
                        <a href="{{ route('loanagainst.uploadDocuments', $goldLoan->id) }}"
                                        ...
                                        @foreach ($documents as $doc)
                                            <tr class="border-b text-center">
                                                ...
                                                <td class="px-4 text-start py-2">
                                                    ...
                                                    <form action="{{ route('loanagainst.documents.destroy', $doc->id) }}"
                ...
                bg-secondary/5 rounded-10 text-lg cursor-pointer"
                    ...
                    <div x-show="open" x-transition class="p-4 bg-white dark:bg-bg3">
                        ...
                        <div class="w-full flex items-center justify-center gap-4 mt-4">
                            ...
                            <a href="{{ route('loanagainst.addComment', $goldLoan->id) }}"
                            ...
                            @if ($comments->isNotEmpty())
                                <a class="btn-primary rounded-10 py-2"
                                    href="{{ route('loanagainst.addComment', $goldLoan->id) }}">
                                    VIEW ALL
                                </a>
                            @endif
                        ...
                        <div class="overflow-x-auto   ">
                            <table class="w-full border-collapse">
                                <tbody>
                                    ...
                                    <tr class="border-b">
                                        <td
                                            class="whitespace-nowrap font-semibold text-sm px-4 py-2 flex items-start gap-2 ">
                                            OC DUE
