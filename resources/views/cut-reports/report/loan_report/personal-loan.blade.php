    ...
    <div class="main-inner">
            ...
            <div id="toggleContent" class="mt-4">
                <form method="GET" action="{{ url()->current() }}">
                    ...
                    <div class="mt-5 flex justify-center gap-4">
                        ...
                        <a href="{{ url()->current() }}" class="btn-warning py-2 text-sm uppercase">Clear</a>
                    </div>
        ...
        <div class="col-span-12 box lg:col-span-12">
            ...
            <div class="mb-5 flex justify-end gap-2 flex-col md:flex-row lg:flex-row">
                 <a href="{{ route('personal.print', request()->all()) }}"
   target="_blank"
                    class="btn-primary rounded-10 px-2 flex justify-center py-2 text-sm uppercase">
                        <i class="las la-print"></i>
                       Print Report
                </a>
                <a href="{{ route('accounts.personal.export.csv') }}" 
                    ...
                    <tbody>
                        @forelse($goldLoan as $loan)
                            <tr class="border-b dark:border-bg3">
                                ...
                                <!-- ACCOUNT NO -->
                                <td class="px-6 py-5">
                                      <a href="{{ route('personal.account.show', $loan->id) }}" 
                                        class="text-green-600 hover:underline">
                                        {{-- {{ $loan->id }} --}}
