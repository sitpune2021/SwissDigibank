...
@section('content')
    ...
    @endif
            ...
            <div class="flex flex-wrap items-center justify-between gap-4 mb-6 px-4 lg:mb-8">
                <h1 class=" flex text-xl block font-semibold uppercase">Property / Mortgage Loan Schemes</h1>
        ...
        <tr class="border-b dark:border-bg3">
            <td class="text-start !py-5 px-6">
                <div class="flex items-center gap-1 text-secondary uppercase">
                    <a href="{{ route('mortgage.schemes.view', $scheme->id) }}" class="single-option text-green-600 hover:text-green-800 transition">
                        {{ $scheme->scheme_code }}
                    </a>
                </div>
            </td>
