...
<div class="main-inner">
    ...
    <div class="mb-4 flex flex-wrap items-center justify-between gap-4 lg:mb-4">
        <div class="flex items-start flex-col gap-2">
            <h3 class="uppercase text-lg font-semibold">FORE CLOSE BUSINESS LOAN</h3>
        </div>
    </div>
    <div class="rounded-lg border-l-4 border-yellow-500  p-2">
        <a href="" class="btn-primary text-sm rounded-10">
    ...
    <div class="flex flex-col dark:bg-bg3 lg:flex-row justify-between mt-7 gap-5">
        ...
        <div class=" w-full  overflow-hidden">
            <div class="box dark:bg-bg3 border mb-4 border-gray-200 shadow-md rounded-lg">
                <form action="{{ route('bussiness.account.forecloser.store', $goldLoan->id) }}" method="POST">
                @csrf
                    <!-- Header -->
                    <div class=" py-3 ">
                        <h3 class="text-lg uppercase  border-b mb-4 font-semibold text-black">ACCOUNT DETAILS</h3>
                    </div>
                    <!-- Body -->
        ...
        <div class=" w-full  overflow-hidden">
            ...
            <div class="box bg-white dark:bg-bg3 border shadow-md rounded-lg">
                ...
                <div class="flex justify-between items-center px-4 py-2 bg-secondary/5 text-black rounded-10">
                    <h3 class="text-black uppercase font-semibold text-lg">BUSINESS LOAN ACCOUNT INFO</h3>
