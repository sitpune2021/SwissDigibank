<?php $__env->startSection('content'); ?>
    ...
    <div class="main-inner">
        ...
        <div class="box mb-4 xxxl:mb-6">
            <form id="Schemes_Form" action="<?php echo e(isset($route) && isset($method) ? $route : ''); ?>" method="POST"
                ...
                <div class="col-span-2 flex gap-4 md:gap-6 mt-4">
                    <?php if(isset($method)): ?>
                        <button class="btn-primary" type="submit">
                            <?php echo e($method === 'PUT' ? 'Update' : 'Save'); ?> Schemes
                        </button>
                    <?php endif; ?>
                    <a href="<?php echo e(route('schemes.index')); ?>" class="btn-outline inline-flex items-center justify-center">
                        Back
                    </a>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views\schemes\add-edit.blade.php ENDPATH**/ ?>