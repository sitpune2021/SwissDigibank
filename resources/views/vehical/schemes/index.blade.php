   ...
   @if(session('success'))
    ...
    @endif
            ...
            <div class="flex flex-wrap items-center justify-between gap-4 mb-6 px-4 lg:mb-8">
                <h1 class=" flex text-xl block font-semibold">VEHICAL LOAN SCHEMES</h1>
                <a href="{{route('vehical.schemes.create')}}" class=" block flex btn-primary capitalize ">Add
                </a>
            </div>  
                                    ...
                                    <div class="flex justify-center">
                                        <div class="relative">
                                            ...
                                            <ul class="horiz-option popover-content">
                                                <li><a href="{{ route('vehical.schemes.view',$scheme->id) }}" class="single-option">View</a></li>
                                                <li><a href="{{ route('vehical.schemes.edit',$scheme->id) }}" class="single-option">Edit</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </td>
