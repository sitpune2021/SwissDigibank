...
class CollectionCenterController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($validated['center_head'])) {
            ...
            if ($type === 'member')
                $center_head_member_id = $id;
            elseif ($type === 'employee')
                $center_head_employee_id = $id;
        }
        ...
        if (!empty($validated['center_cashier'])) {
            ...
            if ($type === 'member')
                $center_cashier_member_id = $id;
            elseif ($type === 'employee')
                $center_cashier_employee_id = $id;
        }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if (!empty($validated['center_head'])) {
            ...
            if ($type === 'member')
                $center_head_member_id = $idVal;
            if ($type === 'employee')
                $center_head_employee_id = $idVal;
        }
        ...
        if (!empty($validated['center_cashier'])) {
            ...
            if ($type === 'member')
                $center_cashier_member_id = $idVal;
            if ($type === 'employee')
                $center_cashier_employee_id = $idVal;
        }
