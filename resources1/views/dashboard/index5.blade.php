                ...
                <div class="box col-span-12 lg:col-span-6">
                    ...
                    <div class="overflow-x-hidden flex justify-center flex-col sm:flex-row items-center gap-3 ">
                        ...
                        <div class="flex w-[25%] shrink-0 sm:flex-col max-sm:w-full flex-wrap justify-center gap-5">
                            <div class="flex items-center gap-2">
                                <img width="24" height="24" src="{{ asset('assets/images/chrome.png') }}" alt="browser icon" />
                                <p>36.87%</p>
                            </div>
                            <div class="flex items-center gap-2">
                                <img width="24" height="24" src="{{ asset('assets/images/firefox.png') }}" alt="browser icon" />
                                <p>9.87%</p>
                            </div>
                            <div class="flex items-center gap-2">
                                <img width="24" height="24" src="{{ asset('assets/images/edge.png') }}" alt="browser icon" />
                                <p>3.87%</p>
                            </div>
                            <div class="flex items-center gap-2">
                                <img width="24" height="24" src="{{ asset('assets/images/opera.png') }}" alt="browser icon" />
                                <p>45.87%</p>
                            </div>
                        </div>
                    </div>
