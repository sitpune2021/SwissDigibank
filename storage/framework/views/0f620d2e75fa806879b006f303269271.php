...
<div class="main-inner">
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4 lg:mb-8">
        ...
        <a class="btn-primary" href="<?php echo e(route('create.shareholding')); ?>">
    ...
    <div class="box col-span-12 lg:col-span-6">
        <div class="flex flex-wrap gap-4 justify-between items-center bb-dashed mb-4 pb-4 lg:mb-6 lg:pb-6">
            ...
            <div class="flex items-center gap-4 flex-wrap grow sm:justify-end">
                <form action="<?php echo e(route('manage.shareholding')); ?>"
                    ...
                    <input type="text" name="search" id="transaction-search" placeholder="Search" value="<?php echo e(request('search')); ?>"
                    ...
                    <a href="<?php echo e(route('manage.shareholding')); ?>"
        ...
        <div class="overflow-x-auto pb-4 lg:pb-6">
            <table class="w-full whitespace-nowrap select-all-table" id="transactionTable1">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $share_holdings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $share): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="px-6 py-4"><?php echo e($index + 1); ?></td>
                        <td class="px-6 py-4"><?php echo e($share->promoters->first_name ?? 'N/A'); ?></td>
                        <td class="px-6 py-4"><?php echo e($share->first_share); ?></td>
                        <td class="px-6 py-4"><?php echo e($share->share_no); ?></td>
                        <td class="px-6 py-4"><?php echo e($share->total_share_held ?? '-'); ?></td>
                        <td class="px-6 py-4"><?php echo e($share->nominal_value ?? '-'); ?></td>
                        <td class="px-6 py-4"><?php echo e($share->total_share_value ?? '-'); ?></td>
                        <!-- <td class="px-6 py-4"><?php echo e(\Carbon\Carbon::parse($share->allotment_date)->format('d-m-Y')); ?></td> -->
                        <td class="py-2 px-6">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views\share-holdings\manage-shareholding.blade.php ENDPATH**/ ?>