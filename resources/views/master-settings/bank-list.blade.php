    ...
    <div class="main-inner">
        ...
        <div class="flex flex-col dark:bg-bg3 lg:flex-row justify-between mt-7 gap-5">
            ...
            <div class=" w-full box  overflow-hidden">
                <form id="" action="" method=""  class="space-y-6 ">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full  text-center">
                            ...
                            <tbody id="nested-fields">
                                <!-- Example Row -->
                                <tr id="field-set-7845234" class="border-b">
                                    ...
                                    <td class=" px-3 py-2">
                                        <button type="button" onclick="removeField(7845234)"
        ...
        <script>
            ...
            <td class=" px-3 py-2">
                <input
                    type="text"
                    name="company_setting[bank_list][${id}]"
                    placeholder="Enter Bank Name"
                    class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-300"
                >
            </td>
