    ...
    <div class="grid grid-cols-12 gap-6">
            ...
            <div class="mb-4 box" x-data="{ payMode: '' }">
                <form class="grid grid-cols-2 gap-6" method="POST" action="{{  route('withdraw.money', base64_encode($id)) }}" enctype="multipart/form-data">
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <div class="w-full text-sm  bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-2 md:py-3 w-fit">Yes</div>
                    </div>

                    <div class="col-span-2 md:col-span-1">
                        <label class="block mb-1 font-semibold text-gray-700 uppercase">Customer's Sign</label>
                        <div class="w-full text-sm  bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-2 md:py-3">
                    ...
                    <div class="col-span-2 md:col-span-1">
                        <label for="amount" class="block mb-1 font-semibold text-gray-700 uppercase">Amount With Draw <span class="text-red-500">*</span></label>
                    ...
                    <div class="col-span-2 md:col-span-1">
                        <label for="receipt" class="block mb-1 font-semibold text-gray-700 uppercase">T. Receipt</label>
                        <input type="file" id="receipt" name="receipt" disabled
                            class="w-full text-sm mt-4 bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-2 md:py-3" style="cursor: not-allowed;">
                    </div>
                    ...
                    <div class="grid grid-cols-2 col-span-2 gap-6 p-4 border rounded-lg bg-blue-50" x-show="payMode === 'online'">
                        ...
                        <div>
                            ...
                            <input type="text" name="utr_no"
                                class="w-full text-sm mt-1  bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-2 md:py-3">
                            @error('utr_no')
                    ...
                    <div class="flex gap-4">
                        <button type="submit" class="btn-primary uppercase">Withdraw</button>
        ...
        <div class="col-span-12 lg:col-span-5" x-data="{ open: false }">
            ...
            <div class="overflow-hidden border box rounded-lg">
                ...
                <div style=""
                    class="flex bg-secondary/5 rounded-10 items-center justify-between px-4 py-3 font-bold  cursor-pointer"
                    @click="open = !open">
