            ...
            <table class="w-full whitespace-nowrap select-all-table" id="transactionTable1">
                ...
                <tbody>
                    ...
                    <tr class="even:bg-secondary/5 dark:even:bg-bg3">
                        ...
                        <!-- <td class="py-5 px-6"><?php echo e($promotor->is_senior); ?></td> -->
                        <td class="py-2">
                        ...
                        <td class="py-5 px-6"><?php echo e($promotor->enrollment_date); ?></td>
                        <td class="py-2">
                            <?php if($promotor->active == 'Yes'): ?>
                            <span class="block w-28 rounded-[30px] border border-n30 bg-primary/20 py-2 text-center text-xs text-primary dark:border-n500 dark:bg-bg3 xxl:w-16">
                                Yes
                            </span>
                            <?php else: ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views\promoters\manage-promotors.blade.php ENDPATH**/ ?>