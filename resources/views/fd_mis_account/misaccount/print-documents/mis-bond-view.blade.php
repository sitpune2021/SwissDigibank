...
@section('content')
   ...
   <i class="las la-print"></i> Print
            ...
            <a href="{{ route('misaccount.show', $misaccount->id) }}" class="px-4 py-2 btn-outline uppercase"
                target="_self">
                BACk
            </a>
        </div>
        <div class="box mt-5">
            <div class="sheet">
                ...
                <table class="btable mt-6">
                    ...
                    <tbody>
                        <tr>
                            <td class="center">{{ \Carbon\Carbon::parse($misaccount->open_date ?? now())->format('d-m-Y') }}
                            </td>
                            <td class="center">
                            ...
                            <td class="center">
                                {{ \Carbon\Carbon::parse($misaccount->maturity_date ?? now())->format('d-m-Y') }}
                            </td>
