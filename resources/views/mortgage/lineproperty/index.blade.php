...
<div class="main-inner">
    <h3 class="text-2xl font-semibold">LOAN ITEMS REPORT</h3>

    <div class="box overflow-x-auto">
        <div class="flex justify-end">
            <a href="{{ route('mortgage.lineproperty.export') }}" class="btn-primary rounded-10 uppercase">
        ...
        <table class="w-full border-collapse whitespace-nowrap  text-sm">
            <thead class="bg-secondary/5 ">
                <tr class="text-center">
                    ...
                    <th class=" p-2 ">LOAN ACCOUNT NO	</th>
    ...
    @forelse($applications as $application)
        <tr class="text-center border-b">
            <td class="p-2"><a href="{{ route('mortgage.applications.view', $application->id) }}" 
