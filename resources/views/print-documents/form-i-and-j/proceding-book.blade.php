...
<body>
    ...
    <table style="width: 100%">
        <thead>
            <tr>
                <th style="width:15%; font-size: 16px;">तारीख वेळ व ठिकाण</th>
                <th style=" width:40%;font-size: 16px;">सभेत हजर असलेल्या सदस्यांची  नावे</th>
                <th style="width:22%; font-size: 16px;">सदस्यांच्या सह्या</th>
                <th style="width:14%; font-size: 16px;">विषय क्रमांक</th>
                <th style="width:40%; font-size: 16px;">विषय</th>
                 <th style="width:14%; font-size: 16px;">ठराव क्र.</th>
                <th style="width:40%; font-size: 16px;">मंजूर झालेला ठराव</th>
                <th style="width:14%; font-size: 16px;">ठरावास अनुकूल सदस्यांची संख्या</th>
                <th style="width:14%; font-size: 16px;">ठरावास प्रतिकूल सदस्यांची संख्या</th>
