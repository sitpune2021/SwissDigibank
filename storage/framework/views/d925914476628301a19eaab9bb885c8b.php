            ...
            <div class="grid grid-cols-12 gap-4 xxxxxl:gap-6">
                        ...
                        <div class="box xxl:p-8 xxxl:p-10 mb-6">
                            ...
                            <?php if($isForm): ?>
                                <section class="mt-6 xl:mt-8 grid grid-cols-2 gap-4 xxxxxl:gap-6">
                                    <?php echo $__env->make('company-profile.partial.sectionLoop', [
                                        'section' => $section,
                                        'company' => $company,
                                        'show' => false,
                ...
                <?php if(!isset($show) || !$show): ?>
                    <div class="col-span-2 flex gap-4 md:gap-6 mt-2 absolute bottom-0 right-0">
                        ...
                        <a href="<?php echo e(route('company.view')); ?>" class="btn-outline">Cancel</a>
                    </div>
                <?php endif; ?>
            </div>
        </form>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views\company-profile\view-profile.blade.php ENDPATH**/ ?>