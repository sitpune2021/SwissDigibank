                    ...
                    @else
                        ...
                        @foreach ($fields as $field)
                            ...
                            <div class="col-span-2 md:col-span-1">
                                ...
                                @if ($name === 'lock_in_amount')
                                    <x-number-to-word for="lock_in_amount" />
                                @endif
                                @if ($name === 'min_opening_balance')
                                    <x-number-to-word for="min_opening_balance" />
                                @endif
                                @if ($name === 'min_monthly_avg_balance')
                                    <x-number-to-word for="min_monthly_avg_balance" />
                                @endif
                                @if ($name === 'min_monthly_avg_bal_charge')
                                    <x-number-to-word for="min_monthly_avg_bal_charge" />
                                @endif
                                ...
                                <td class="border px-4 py-2">
                                    @php
                                        ...
                                        if ($mode == 'IMPS Charges') {
                                            $inputValue =
                                                $charge && isset($charge->imps_charge) ? $charge->imps_charge : '0';
                                        }

                                        if ($mode == 'NEFT Charges') {
                                            $inputValue =
                                                $charge && isset($charge->neft_charge) ? $charge->neft_charge : '0';
                                        }

                                        if ($mode == 'UPI Charges') {
                                            $inputValue =
                                                $charge && isset($charge->upi_charge) ? $charge->upi_charge : '0';
                                        }
                                    ...
                                    <input type="text" name="{{ $inputName }}" id="{{ $inputName }}"
                                        ...
                                        @if (empty($schemes)) value=""
                            @else
                            value="{{ old($inputName, $inputValue) }}" @endif
