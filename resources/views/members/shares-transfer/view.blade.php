        ...
        <div class="overflow-hidden bg-white border border-gray-200 rounded-lg shadow-md">
            ...
            <div class="flex items-center justify-between px-4 py-2 border-b border-gray-200 bg-gray-50">
                ...
                <div class="flex gap-2">
                    <button class="flex items-center gap-1 px-2 py-1 text-xs text-white transition rounded"
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2 text-blue-600 border-0">
                                <a href="{{ route('promotor.show', base64_encode($shareholding->promotor->id)) }}"
                                    ...
                                    DEMO-{{ $shareholding->promotor->folio_no ?? '' }} - {{ $shareholding->promotor->first_name ?? '' }}
                                </a>
                            </td>
                            <td class="px-4 py-2 text-blue-600 border-0">
                            ...
                            <td class="px-4 py-2 border-0">{{ $shareholding->from_share_no }} -
                                {{ $shareholding->to_share_no }}</td>
                            <td class="px-4 py-2 border-0">{{ number_format($shareholding->face_value, 2) }}</td>
                            <td class="px-4 py-2 border-0">{{ $shareholding->shares ?? '' }}</td>
                            <td class="px-4 py-2 border-0">{{ $shareholding->transfer_date }}</td>
