    ...
    <div style="max-width:80mm; margin:0 auto; padding:8px 6px;">
        ...
        <table style="width:100%; border-collapse:collapse; font-size:12px;">
            <tr>
                ...
                <td style="padding:4px 2px; vertical-align:top; ">{{ $transaction->misaccount->member->member_no }}</td>
            </tr>
            <tr>
                <td style="padding:4px 2px; vertical-align:top; font-weight:bold; width:40%;">Name :</td>
                <td style="padding:4px 2px; vertical-align:top; ">{{ $transaction->misaccount->member->member_info_first_name }}
                    {{ $transaction->misaccount->member->member_info_middle_name ?? '' }}
                    {{ $transaction->misaccount->member->member_info_last_name }}</td>
            </tr>
            <tr>
                <td style="padding:4px 2px; vertical-align:top; font-weight:bold; width:40%;">Phone :</td>
                <td style="padding:4px 2px; vertical-align:top;  width:60%;">{{ $transaction->misaccount->member->member_info_mobile_no }}</td>
            </tr>
        ...
        <table style="width:100%; border-collapse:collapse; font-size:12px;">
                    <tr>
                        ...
                        <td  style="padding:4px 2px; vertical-align:top;  width:60%;">
                    ...
                    <tr>
                        ...
                        <td style="padding:4px 2px; vertical-align:top;  width:60%;">{{ $transaction->id ?? 'N/A' }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="padding:4px 2px; vertical-align:top;  width:60%;">{{ $transaction->pay_mode }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="padding:4px 2px; vertical-align:top;  width:60%;">{{ $transaction->remark ?? 'N/A' }}</td>
                    </tr>
                </table>
