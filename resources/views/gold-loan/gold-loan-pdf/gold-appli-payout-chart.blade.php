        ...
        <div class="" style="margin-top:30px;">
            <table style="font-size: 12px !important ; padding: 5px;">
                ...
                <tr>
                    ...
                    <td style="padding: 5px">{{$emi_date}}</td>
                    <td style="padding: 5px">{{$emi_principle}}</td>
                    <td style="padding: 5px">{{$emi_interest}}</td>
                    <td style="padding: 5px">{{$per_emi_charges}}</td>
                    <td style="padding: 5px"> {{ $emi_amount }}</td>
                    <td style="padding: 5px">{{ $balance_principle }}</td>
                </tr>
                <tr>
