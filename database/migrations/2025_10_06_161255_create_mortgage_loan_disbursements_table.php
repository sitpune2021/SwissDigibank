...
return new class extends Migration {
    public function up(): void
    {
        ...
        if (!Schema::hasTable('mortgage_loan_disbursements')) {
            Schema::create('mortgage_loan_disbursements', function (Blueprint $table) {
                $table->id();
    ...
    public function down(): void
    {
        ...
        if (Schema::hasTable('mortgage_loan_disbursements')) {
            Schema::dropIfExists('mortgage_loan_disbursements');
        }
    }
};
