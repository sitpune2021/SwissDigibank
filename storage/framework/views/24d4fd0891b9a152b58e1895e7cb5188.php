<?php $__env->startSection('content'); ?>
    ...
    <div class="main-inner">
        ...
        <div class="box mb-4 xxxl:mb-6">
            <form id="companyForm" action="<?php echo e(isset($route) && isset($method) ? $route : ''); ?>" method="POST"
                enctype="multipart/form-data" class="grid grid-cols-2 gap-4 xxxl:gap-6">
                <?php echo csrf_field(); ?>
                <?php if($method == 'PUT'): ?>
                ...
                <?php $__currentLoopData = $sections ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sectionName => $fields): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            ...
                            $value = old($name, $form15g15h[$name] ?? ($field['default'] ?? ''));
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php if(!empty($form15g15h['form_15_upload'])): ?>
                    <?php
                ...
                <div class="col-span-2 flex gap-4 md:gap-6 mt-4">
                    <?php if(!isset($show) || !$show): ?>
                        <button class="btn-primary" type="submit">
                            <?php echo e($method === 'PUT' ? 'Update' : 'UPLOAD'); ?> FORM 15G/ 15H
                        </button>
                        <div class="col-span-2 flex gap-4 md:gap-6 mt-4">
                    <?php endif; ?>
                    <a href="<?php echo e(route('form15g15h.index')); ?>" class="btn-outline inline-flex items-center justify-center">
                        Back
                    </a>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss bank live code\resources\views/form15g15h/create.blade.php ENDPATH**/ ?>