        ...
        <div class="box mb-4 xxxl:mb-6">
            <form id="companyForm"
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <div class="relative">
                        ...
                        <input name="joining_date" id="date2" type="text" placeholder="DD/MM/YYYY"
                            ...
                            class="w-full text-sm  bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-2 md:py-3"
                            autocomplete="off" @if ($isView) disabled @endif>
                        <i
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <label>
                        ...
                        <input type="radio" name="gender" value="female"
                            ...
                            @if ($isView) disabled @endif> Female
                        <!-- Female -->
                    </label>
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <div class="flex gap-2">
                        ...
                        <input type="text" name="mobile_no" id="mobile_no" type ="number" maxlength ="10"
                            minlength= "10" pattern = "[0-9]{10} " placeholder="Enter Mobile No"
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <label for="nominee_address" class="md:text-lg font-medium block mb-4">Auto Generate Payable
                        Ledger</label>
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <label for="payable_ledger" class="md:text-lg font-medium block mb-4">Linked Accounting Payable
                        Ledger</label>
                    @if (isset($isView) && $isView)
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <label for="expense_ledger" class="md:text-lg font-medium block mb-4">Linked Accounting Expense
                        Ledger</label>
                    @if (isset($isView) && $isView)
