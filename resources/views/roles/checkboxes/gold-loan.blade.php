...
<!----------------- Gold Loan Schemes --------------------> 
    <div class="payload-section">
        ...
        <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 xxxl:gap-6">
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="gl_lon_sch"
                     name="permissions[gl_lon_sch]" value=""
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    ...
                    name="permissions[add_new_gol_sch]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="shw_gol_lon_sch_inf" name="permissions[shw_gol_lon_sch_inf]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    ...
                    name="permissions[edit_gol_lon_sch]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
...
<!----------------- Gold Loan Calculator --------------------> 
    <div class="payload-section">
        ...
        <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 xxxl:gap-6">
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="gol_loan_calc" name="permissions[gol_loan_calc]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
...
<!----------------- Gold Loan Applications --------------------> 
    <div class="payload-section">
        ...
        <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 xxxl:gap-6 mt-4">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="gol_lon_app_lis" name="permissions[gol_lon_app_lis]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="gol_lon_app_sms_enb" name="permissions[gol_lon_app_sms_enb]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="op_new_gol_lon_app" name="permissions[op_new_gol_lon_app]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="shw_gol_app_inf" name="permissions[editshw_gol_app_inf_min]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="set_dis_set" name="permissions[set_dis_set]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="edi_dis_set_enach" name="permissions[edi_dis_set_enach]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="edi_gol_lon_app_apr" name="permissions[edi_gol_lon_app_apr]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="up_new_orn_img" name="permissions[up_new_orn_img]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="ch_upl_orn_img" name="permissions[ch_upl_orn_img]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="rem_gol_lon_app" name="permissions[rem_gol_lon_app]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="sub_gol_lon_app_adm" name="permissions[sub_gol_lon_app_adm]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="upl_gol_lon_app_doc" name="permissions[upl_gol_lon_app_doc]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="del_gol_lon_app" name="permissions[del_gol_lon_app]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
 ...
 <!----------------- Gold Items -------------------->
    <div class="payload-section">
        ...
        <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 xxxl:gap-6">
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="gol_orn_inv" name="permissions[gol_orn_inv]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="up_gol_orn_sta" name="permissions[up_gol_orn_sta]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
    ...
    <div class="payload-section">
        ...
        <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 xxxl:gap-6">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="gol_lon_dis_lis" name="permissions[gol_lon_dis_lis]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="dis_rel_gol_lon" name="permissions[dis_rel_gol_lon]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="can_gol_lon_dis" name="permissions[can_gol_lon_dis]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
  ...
  <!----------------- Gold Loan Accounts --------------------> 
    <div class="payload-section">
        ...
        <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 xxxl:gap-6">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    ...
                    name="permissions[gl_lon_acc_lis]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="shw_gol_lon_acc" name="permissions[shw_gol_lon_acc]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    ...
                    name="permissions[gl_lon_acc_rem_sms]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="gol_lon_acc_hol_enb" name="permissions[gol_lon_acc_hol_enb]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="rm_gol_lon_acc" name="permissions[rm_gol_lon_acc]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="gol_lon_trans_list" name="permissions[gol_lon_trans_list]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
              ...
              <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="shw_gol_lon_trans" name="permissions[shw_gol_lon_trans]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="up_gol_tran_time" name="permissions[up_gol_tran_time]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="rem_gol_trans" name="permissions[rem_gol_trans]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="gol_lon_sms_enb_dsb" name="permissions[gol_lon_sms_enb_dsb]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
              ...
              <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="link_sav_acc_to_gold" name="permissions[link_sav_acc_to_gold]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
              ...
              <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="unlink_sav_acc_to_gol" name="permissions[unlink_sav_acc_to_gol]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="col_pay_int_of_gl" name="permissions[col_pay_int_of_gl]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
              ...
              <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="col_pay_gol_due_emi" name="permissions[col_pay_gol_due_emi]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="lon_set_gol_acc" name="permissions[lon_set_gol_acc]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="on_hol_enach_sub" name="permissions[on_hol_enach_sub]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
           ...
           <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="oth_cha_gol_lon_acc" name="permissions[oth_cha_gol_lon_acc]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="del_oth_cha_lon_acc" name="permissions[del_oth_cha_lon_acc]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
              ...
              <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="oth_cha_wav_amt" name="permissions[oth_cha_wav_amt]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="gol_lon_trans_rec" name="permissions[gol_lon_trans_rec]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            Gold Loan Transaction Receipt
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="chg_up_gol_pen_ch" name="permissions[chg_up_gol_pen_ch]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            Change/ Update Gold Loan Penalty Charges
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="gol_lon_over_in" name="permissions[gol_lon_over_in]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="up_gol_acc_brc" name="permissions[up_gol_acc_brc]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="up_acc_agent" name="permissions[up_acc_agent]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="acc_gen" name="permissions[acc_gen]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="py_amt_gol_lon" name="permissions[py_amt_gol_lon]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="re_sch_ext" name="permissions[re_sch_ext]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="rai_req_for_cl" name="permissions[rai_req_for_cl]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="cls_gold_lon" name="permissions[cls_gold_lon]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
           ...
           Close Gold Loan
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="emi_to_due" name="permissions[emi_to_due]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
           ...
           Mark Gold Loan EMI to DUE if (System/ Software FAILS).
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="mar_gol_emi_ovr_due" name="permissions[mar_gol_emi_ovr_due]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
          ...
          Mark Gold Loan EMI to OVER DUE if (System/ Software FAILS).
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="gl_paid_emi_ovr_due" name="permissions[gl_paid_emi_ovr_due]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
           ...
           Mark Gold Loan PAID EMI to DUE or OVER DUE
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="mrk_gol_due_paid_st" name="permissions[fd_mis_lmrk_gol_due_paid_stien]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
           ...
           Mark Gold Loan DUE to Paid state
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="gol_lon_acc_doc" name="permissions[gol_lon_acc_doc]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
           ...
           Upload Gold Loan Account Document
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="del_gol_acc_doc" name="permissions[del_gol_acc_doc]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
         ...
         Delete Gold Loan Account Document
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="gol_cc_comment" name="permissions[gol_cc_comment]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
       ...
       Add Gold Loan Account Comment
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="reg_gol_acc_led" name="permissions[reg_gol_acc_led]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="rep_gol_lon_acc" name="permissions[rep_gol_lon_acc]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="emi_ch_gl_acc" name="permissions[emi_ch_gl_acc]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="re_initaite_pg_trans" name="permissions[re_initaite_pg_trans]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
             ...
             <div class="col-span-2 md:col-span-1">
                <div class="flex items-center gap-2 space-x-2">
                    <input type="checkbox" id="re_gen_del_entry" name="permissions[re_gen_del_entry]" value=""
                        class="item-checkbox form-checkbox h-5 w-5 text-primary">
