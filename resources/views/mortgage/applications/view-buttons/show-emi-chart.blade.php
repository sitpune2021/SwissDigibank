...
<div class="main-inner ">
    ...
    <div class="container  mx-auto p-6">
        ...
        <div class="loan-info mb-6 p-4 box rounded-lg shadow" >
            
            <h2 class="text-lg font-semibold text-center uppercase  pb-2 mb-3">
                Loan Information 
            </h2>
            ...
            <table class="w-full text-sm border border-gray-400 rounded-lg">
                <tbody>
                    <tr>
                    <td class="font-semibold py-2 px-3 w-1/4 border border-gray-300 uppercase" >Disburse Date</td>
                    ...
                    <td class="font-semibold py-2 px-3 w-1/4 border border-gray-300 uppercase">Loan Amount</td>
                    <td class="py-2 px-3 w-1/4 border border-gray-300">₹ {{ number_format($loanAmount, 2) }}</td>
                    </tr>

                    <tr>
                    <td class="font-semibold py-2 px-3 border border-gray-300 uppercase">Interest Type</td>
                    ...
                    <td class="font-semibold py-2 px-3 border border-gray-300 uppercase">Processing Charges</td>
                    <td class="py-2 px-3 border border-gray-300">₹ {{ number_format($processingFeeInc,2) }} (Incl. 18% GST)</td>
                    </tr>

                    <tr>
                    <td class="font-semibold py-2 px-3 border border-gray-300 uppercase">Insurance Charges</td>
                    <td class="py-2 px-3 border border-gray-300">₹ {{ number_format($insuranceInc,2) }} (Incl. 0% GST)</td>
                    <td class="font-semibold py-2 px-3 border border-gray-300 uppercase">Stamp Duty</td>
                    <td class="py-2 px-3 border border-gray-300">₹ {{ number_format($stampDutyInc,2) }} (Incl. 18% GST)</td> 
                    </tr>

                    <tr>
                    <td class="font-semibold py-2 px-3 border border-gray-300 uppercase">EMI Count</td>
                    <td class="py-2 px-3 border border-gray-300">{{ $tenure }}</td>
                    <td class="font-semibold py-2 px-3 border border-gray-300 uppercase">EMI Payout</td>
                    <td class="py-2 px-3 border border-gray-300">{{ strtoupper($periodName) }}</td>         
                    </tr>

                    <tr>
                    <td class="font-semibold py-2 px-3 border border-gray-300 uppercase">Tenure</td>
                    <td class="py-2 px-3 border border-gray-300">{{ $tenure }} MONTHS</td>
                    <td class="font-semibold py-2 px-3 border border-gray-300 uppercase">Interest Rate ( Annually )</td>
        ...
        <div class="mt-6 box">
            <h3 class="text-lg font-semibold text-center uppercase">EMI Chart</h3>
            <div class="overflow-x-auto mt-3">
                <table class="min-w-full border-collapse border">
                    <thead>
                        <tr class="bg-gray-100">
                            <th class="border px-2 py-1 uppercase">EMI NO</th>
                            <th class="border px-2 py-1 uppercase">EMI DATE</th>
                            <th class="border px-2 py-1 uppercase">DUE DATE</th>
                            <th class="border px-2 py-1 uppercase">PRINCIPAL (A)</th>
                            <th class="border px-2 py-1 uppercase">INTEREST (B)</th>
                            <th class="border px-2 py-1 uppercase">CHARGES PER EMI (C)</th>
                            <th class="border px-2 py-1 uppercase">EMI (A + B + C)</th>
                            <th class="border px-2 py-1 uppercase">BAL. PRINCIPAL</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        <tr class="bg-blue-50 font-semibold">
                            <td colspan="7" class="border px-2 py-2 text-right uppercase">Starting Balance</td>
