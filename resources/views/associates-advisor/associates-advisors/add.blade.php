            ...
            <form action="{{ $isEdit ? route('associate.update', $associate->id) : route('associate.store') }}"
                ...
                <div class="grid grid-cols-2 gap-4 mt-6 xl:mt-8 xxxxxl:gap-6">
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <div class="col-sm-7">
                            <div class="flex items-center gap-2">
                                <input type="text" id="first_name" name="first_name" value="{{ $isEdit ? $associate->first_name : '' }}"
                                    class=" w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-2 md:py-3 "
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <div class="col-sm-7">
                            <div class="flex items-center gap-2">
                                <input type="text" id="date" name="dob" value="{{ $isEdit && $associate->dob ? \Carbon\Carbon::parse($associate->dob)->format('d/m/Y') : '' }}"
                                    class=" w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-2 md:py-3 "
                                    placeholder="DD/MM/YYYY">
                            </div>
                        </div>
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <div class="flex items-center gap-6">
                                <label class="flex items-center gap-2">
                                    <input type="radio" name="access_type" value="admin"
                                        {{ isset($associate) && $associate->access_type === 'admin' ? 'checked' : '' }}>
                                    <span>Admin App</span>
                                </label>

                                <label class="flex items-center gap-2">
                                    <input type="radio" name="access_type" value="agent"
                                        {{ isset($associate) && $associate->access_type === 'agent' ? 'checked' : '' }}>
                                    <span>Agent App</span>
                                </label>

                                <label class="flex items-center gap-2">
                                    <input type="radio" name="access_type" value="both"
                                        {{ isset($associate) && $associate->access_type === 'both' ? 'checked' : '' }}>
                                    <span>Both App</span>
                                </label>
                        </div>
                    </div>
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <div class="flex items-center gap-6">
                            <label class="flex items-center gap-2">
                                <input type="radio" name="login_holiday" value="yes"
                                    {{ $isEdit && $associate->login_holiday == 'yes' ? 'checked' : '' }}>
                                <span>Yes</span>
                            </label>

                            <label class="flex items-center gap-2">
                                <input type="radio" name="login_holiday" value="no"
                                    {{ $isEdit && $associate->login_holiday == 'no' ? 'checked' : '' }}>
                                <span>No</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <div class="flex items-center gap-6">
                            <label class="flex items-center gap-2">
                                <input type="radio" name="searchable_accounts" value="yes"
                                    {{ $isEdit && $associate->searchable_accounts == 'yes' ? 'checked' : '' }}>
                                <span>Yes - All</span>
                            </label>

                            <label class="flex items-center gap-2">
                                <input type="radio" name="searchable_accounts" value="no"
                                    {{ $isEdit && $associate->searchable_accounts == 'no' ? 'checked' : '' }}>
                        ...
                        <div class="flex items-center gap-6">
                            <label class="flex items-center gap-2">
                                <input type="radio" name="active" value="yes"
                                    {{ isset($associate) && $associate->active === 'yes' ? 'checked' : '' }}>
                                <span>Yes</span>
                            </label>

                            <label class="flex items-center gap-2">
                                <input type="radio" name="active" value="no"
                                    {{ isset($associate) && $associate->active === 'no' ? 'checked' : '' }}>
                                <span>No</span>
                            </label>
                        </div>
                    </div>
