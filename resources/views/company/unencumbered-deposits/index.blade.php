...
@if($isSuperAdmin || in_array('unencumbered-deposits.create', $permissions))
                        ...
                        <tr class="table-row dark:even:bg-bg3 border-b hover:bg-gray-50 dark:hover:bg-bg3"
                            ...
                            <td class="px-4 py-3 text-center">
                                ...
                                <div class="flex items-center justify-center gap-2 whitespace-nowrap">
                                    ...
                                    <!-- VIEW -->
                                    @if($isSuperAdmin || in_array('unencumbered-deposits.show', $permissions))
                                    ...
                                    <!-- EDIT -->
                                    @if($isSuperAdmin || in_array('unencumbered-deposits.edit', $permissions))
