    ...
    <div class="main-inner">
        ...
        <div class="flex flex-wrap gap-3">
            <a href="{{ route('fd-mis-account.fd-payoutplan.fdpayoutplan', $fdAccount->id) }}"
                class="btn-primary px-4 py-2 rounded-10">
                FD PAYOUT PLAN
            </a>
            <a href="{{ route('fd-accounts.transactions', $fdAccount->id) }}" class="btn-primary px-4 py-2 rounded-10">
                VIEW TRANSACTIONS
            </a>
                    ...
                    <table class="min-w-full text-sm text-left border-collapse">
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-2">
                                    {{ $fdAccount->tenure_year }}Y,{{ $fdAccount->tenure_month }}M,{{ $fdAccount->tenure_days }}D
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-2">
                                    @if ($fdAccount->tds_deduction == 1)
                                        <span
                                            class="px-2 py-1 text-xs font-medium rounded bg-green-100 text-green-600">Yes</span>
                                    @else
                                        <span
                                            class="px-2 py-1 text-xs font-medium rounded bg-red-100 text-red-600">No</span>
                                    @endif
                                </td>
                            </tr>
                            <tr>
                                ...
                                <table
                                    ...
                                    <tbody>
                                        @foreach ($fdAccount->transactions->sortByDesc('id') as $tran)
                                            <tr class="border-b">
                                                <td class="px-3 py-2">
                                                    {{ \Carbon\Carbon::parse($tran->transaction_date)->format('d/m/Y H:i') }}
                                                </td>
                        ...
                        <div class="overflow-x-auto mt-5  bg-white dark:bg-bg3">
                            <table class="min-w-full text-sm ">
                                <thead class="bg-gray-100">
                                    ...
                                    <tr>
                                        <th colspan="2"
                                            class="px-4 py-2 text-center font-semibold text-gray-700 border-b">DAYS</th>
                                        <th rowspan="2"
                                            class="px-4 py-2 text-center font-semibold text-gray-700 border-b">
