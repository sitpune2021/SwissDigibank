                ...
                <div class=" overflow-x-auto">
                    ...
                    <div class="col-span-2 md:col-span-1 mt-3">
                        ...
                        <div class="flex gap-3 items-center">
                            <select name="saving_account_id" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border rounded-10 px-3 md:px-6 py-3 md:py-3">
                                <option value="">Select Saving Account</option>

                                @foreach($misaccount->member->accounts as $account)
                                <option value="{{ $account->id }}">
                                    {{ $account->account_no }} - {{ $misaccount->member->member_info_first_name }} {{ $misaccount->member->member_info_last_name }}
                                </option>
                                @endforeach
                    ...
                    <div class="p-4">
                        <table class="w-full whitespace-nowrap text-sm">
                            <tbody class="divide-y divide-gray-200">
                                <tr class="border-b">
                                    <td class="font-semibold text-gray-800 px-4 py-3 uppercase w-1/3">
                                        Member
                                    </td>
                                    <td class="px-4 py-3 text-gray-700">
                                        <a href="" class="text-primary">
                                            {{ $misaccount->member->member_no }} - {{ $misaccount->member->member_info_first_name }} {{ $misaccount->member->member_info_last_name }}
                                        </a>
                                    </td>
                                </tr>

                                <tr class="border-b">
                                    <td class="font-semibold text-gray-800 px-4 py-3 uppercase">Open Date </td>
                                    <td class="px-4 py-3 text-gray-700">
                                ...
                                <tr class="border-b">
                                    <td class="font-semibold text-gray-800 px-4 py-3 uppercase">Maturity Date </td>
                                    <td class="px-4 py-3 text-gray-700">{{ \Carbon\Carbon::parse($misaccount->maturity_date)->format('d-m-Y') }}</td>
                                </tr>

                                <tr class="border-b">
                                    <td class="font-semibold text-gray-800 px-4 py-3 uppercase">Status </td>
                                    <td class="px-4 py-3 text-gray-700">
