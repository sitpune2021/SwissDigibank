...
Route::group(['prefix' => 'fd-mis-schemes'], function () {
    ...
    //remove account 
    Route::get('fdaccount/{id}/remove', [FdController::class, 'removeAccount'])
        ->name('fdaccount.remove');

    Route::delete('fdaccount/{id}/confirm-remove', [FdController::class, 'confirmRemoveAccount'])
        ->name('fdaccount.confirmRemove');
