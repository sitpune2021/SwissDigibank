...
class RdschemesController extends Controller
{
  ...
  {
    try {
      Log::info('RD Scheme creation request initiated', [
        'user_id' => Auth::id(),
      ...
      $validated = $request->validate([
        ...
        'bonus_rate_type' => 'nullable|string|in:fixed,percentage',
        'bonus_rate_value' => 'nullable|numeric|min:0',
      ...
      Log::info('RD Scheme validation passed', [
      ...
      Log::warning('RD Scheme validation failed', [
        'errors' => $e->errors(),
        'input' => $request->all()
      ]);
