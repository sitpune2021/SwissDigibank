...
<div class="main-inner">
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4 lg:mb-8">
        <h3 class="h2"><?php echo e(isset($branch) ? 'Edit' : 'Add'); ?> Branch</h3>
    </div>
    ...
    <div class="box mb-4 xxxl:mb-6">
        <form id="companyForm" action="<?php echo e($route); ?>" method="POST" class="grid grid-cols-2 gap-4 xxxl:gap-6" autocomplete="off">
            <?php echo csrf_field(); ?>
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <select name="<?php echo e($name); ?>" id="<?php echo e($id); ?>"
                    ...
                    <?php echo e($required ? 'required' : ''); ?> autocomplete="off">
                ...
                <div class="flex gap-5">
                    ...
                    <label class="flex items-center space-x-2">
                        <input type="radio" name="<?php echo e($name); ?>" value="<?php echo e($optionValue); ?>"
                            <?php echo e($value == $optionValue ? 'checked' : ''); ?>autocomplete="off">
                ...
                <?php else: ?>
                <input type="<?php echo e($type); ?>" name="<?php echo e($name); ?>" id="<?php echo e($id); ?>" value="<?php echo e($value); ?>"
                    class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-2 md:py-3"
                    placeholder="Enter <?php echo e(strtolower($label)); ?>" autocomplete="off"/>
                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-span-2 flex gap-4 md:gap-6 mt-4">
                ...
                <button class="btn-outline" type="button"
                    onclick="window.location.href='<?php echo e(route('manage.branch')); ?>'">Back</button>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss bank live code\resources\views/branch/add-branch.blade.php ENDPATH**/ ?>