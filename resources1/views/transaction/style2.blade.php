                ...
                <table class="w-full whitespace-nowrap select-all-table" id="transactionTable1">
                    ...
                    <tbody>
                        <tr class="border-b border-n30 dark:border-n500">
                            ...
                            <td class="py-2 px-6">
                                <div class="flex items-center gap-3">
                                    <img src="{{ asset('assets/images/paypal.png') }}" width="32" height="32" class="rounded-full"
                        ...
                        <tr class="border-b border-n30 dark:border-n500">
                            ...
                            <td class="py-2 px-6">
                                <div class="flex items-center gap-3">
                                    <img src="{{ asset('assets/images/payoneer.png') }}" width="32" height="32" class="rounded-full"
                                        alt="payment medium icon" />
                                    <div>
