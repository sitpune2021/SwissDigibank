...
@section('content')
    ...
    <div class="main-inner">
        ...
        <div class="flex flex-wrap gap-3">
            <a href="{{ route('cc_od.account.transaction', $goldLoan->id) }}"
            ...
            <a href="{{ route('cc_od.account.fourcloser', $goldLoan->id) }}"
                class="btn-error text-sm uppercase px-2 py-2 rounded-10 ">
                Fore CloseLoan
            </a>

            <a href="{{ route('cc_od.account.linksaving', $goldLoan->id) }}"
            ...
            <form id="remove-account-form-{{ $goldLoan->id }}" action="{{ route('cc_od.remove', $goldLoan->id) }}"
            ...
            <a href="{{ route('cc_od.account.audit-trail') }}"
            ...
            <div class=" w-full overflow-x-auto   overflow-hidden">
                ...
                <div class="bg-white dark:bg-bg3 box shadow-md mt-5 rounded-10 overflow-hidden">
                    ...
                    <div class="flex items-center justify-between rounded-10 bg-secondary/5 text-black px-4 py-3 cursor-pointer"
                        ...
                        <a href="{{ route('cc_od.uploadDocuments', $goldLoan->id) }}"
                                        ...
                                        @foreach ($documents as $doc)
                                            <tr class="border-b text-center">
                                                ...
                                                <td class="px-4 text-start py-2">
                                                    ...
                                                    <form action="{{ route('cc_od.documents.destroy', $doc->id) }}"
                ...
                bg-secondary/5 rounded-10 text-lg cursor-pointer"
                    ...
                    <div x-show="open" x-transition class="p-4 bg-white dark:bg-bg3">
                        ...
                        <div class="w-full flex items-center justify-center gap-4 mt-4">
                            ...
                            <!-- Add Comment -->
                            <a href="{{ route('ccod.addComment', $goldLoan->id) }}" class="btn-primary rounded-10 py-2">
                                ADD COMMENT
                            </a>
                            ...
                            @if ($comments->isNotEmpty())
                                <a class="btn-primary rounded-10 py-2"
                                    href="{{ route('ccod.addComment', $goldLoan->id) }}">
                                    VIEW ALL
                                </a>
                            @endif
                        ...
                        <table class="w-full border-collapse whitespace-nowrap  text-sm">
                            ...
                            <tbody>
                                @forelse($currentStatement as $row)
                                    <tr class="border-b">
                                        <td class="p-2 text-start">{{ Carbon::parse($row->date)->format('d/m/Y h:i A') }}
                                        </td>
