...
<div class="main-inner">
    <div class="mb-6 flex flex-wrap items-center  justify-between gap-4 lg:mb-8">
        <div class="flex items-center flex-col  gap-2">
            <h3 class="text-lg font-semibold">NEW RD/ DD SCHEME</h3>
        </div>
    </div>
    ...
    <div class="col-span-12 box lg:col-span-12">
        ...
        <form class="grid grid-cols-2 gap-4 mt-6 xl:mt-8 xxxxxl:gap-6" action="{{ route('rdschemes.store') }}"
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <input type="text" name="scheme_code" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 
            ...
            <div class="col-span-2">
                <p name="tenure-info" class="text-blue-500">
                    <strong>10.0 % TDS</strong> will be deducted, if the
                    Interest exceeds ₹ 40,000.00 per annum.
                </p>
            </div>
...
<script>
    document.getElementById('rd_dd_frequency').addEventListener('change', function() {

        let frequency = this.value;
        let tenureType = document.getElementById('tenure-type');

        if (!tenureType) return;

        if (frequency === 'daily') {
            tenureType.value = 'days';
        } else if (frequency === 'weekly' || frequency === 'bi_weekly') {
            tenureType.value = 'weeks';
        } else if (
            frequency === 'monthly' ||
            frequency === 'quarterly' ||
