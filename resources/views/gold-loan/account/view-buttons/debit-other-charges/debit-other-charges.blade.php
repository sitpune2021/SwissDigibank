...
<div class="main-inner">
    ...
    <div class="flex flex-col  dark:bg-bg3 lg:flex-row justify-between mt-7 gap-5">
        <div class=" w-full  box overflow-hidden">
            <form action="{{route('gold-loan.debitOtherCharges.store',$goldLoan->id)}}" method="post">
                @csrf
                ...
                <div class="col-span-2 md:col-span-1 mt-8 mb-2">
                    <div class="flex flex-col min-w-10 sm:flex-row justify-center gap-3 mt-5">
                        ...
                        <button class="btn-outline uppercase justify-center" type="reset"  onclick="window.location.href='{{ route('gold-loan.account.index') }}'">
                            BACK
                        </button>
                    </div>
                </div>
                    ...
                    <table class="w-full text-sm whitespace-nowrap text-gray-700 rounded-md">
                        <tbody>
                            ...
                            <tr class="border-b border-gray-200">
                                ...
                                {{\Carbon\Carbon::parse($goldLoan->application_date)->format('d-m-Y')  }}
                            ...
                            <tr class="border-b border-gray-200">
                                ...
                                <td class="px-3 py-2">{{$goldLoan->goldLoanTransactions->first()->current_debt??''}} </td>
                            </tr>
                            <tr class="border-b border-gray-200">
