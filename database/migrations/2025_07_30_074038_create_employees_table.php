...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('employees', function (Blueprint $table) {
            ...
            $table->foreign('payable_ledger_id')->references('id')->on('payable_ledgers')->onDelete('cascade');

            $table->foreign('expense_ledger_id')->references('id')->on('payable_expenses')->onDelete('cascade');
            $table->softDeletes();
