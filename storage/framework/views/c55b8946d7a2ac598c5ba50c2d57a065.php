...
<div class="main-inner">
    ...
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4 lg:mb-8">
        <!-- <h3 class="h2"><?php echo e(isset($director) ? 'Edit - ' . $director->director_name. ' Director'  : 'Add New Director'); ?></h3> -->
        <h3 class="h2">
            <?php if(!empty($show)): ?>
            <?php echo e($director->director_name ?? ''); ?>

            <?php elseif(isset($director)): ?>
            Edit - <?php echo e($director->director_name); ?> Director
            <?php else: ?>
            Add New Director
            <?php endif; ?>
        </h3>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-span-2 flex gap-4 md:gap-6 mt-4">
                ...
                <div class="col-span-2 flex gap-4 md:gap-6 mt-4">
                    ...
                    <a href="<?php echo e(route('director.index')); ?>" class="btn-outline inline-flex items-center justify-center">
                        Back
                    </a>
                    <button class="btn-outline" type="reset" onclick="document.getElementById('companyForm').reset();">
                        Reset
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views\director\create.blade.php ENDPATH**/ ?>