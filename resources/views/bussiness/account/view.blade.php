...
@section('content')
    ...
    <div class="main-inner">
        ...
        <div class="flex flex-wrap gap-3">
            <a href="{{ route('bussiness.account.transaction', $goldLoan->id) }}"
            ...
            @if (strtolower($goldLoan->scheme->gold_loan_setting) != 'no_emi')
                ...
                @if (strtolower($goldLoan->scheme->gold_loan_setting) == 'flat_advanced_interest')
                    <a href="{{ route('bussiness.account.extension', $goldLoan->id) }}"
            ...
            <a href="{{ route('bussiness.account.fourcloser', $goldLoan->id) }}"
                class="btn-error uppercase text-sm px-2 py-2 rounded-10 ">
                Fore CloseLoan
            </a>

            <a href="{{ route('bussiness.account.linksaving', $goldLoan->id) }}"
                class="btn-primary uppercase text-sm px-2 py-2 rounded-10 ">
            ...
            <form id="remove-account-form-{{ $goldLoan->id }}" action="{{ route('bussiness.remove', $goldLoan->id) }}"
            ...
            <a href="{{ route('bussiness.account.audit-trail') }}"
                class="btn-primary uppercase text-sm  px-2 py-2 rounded-10 ">
                Show audit trail
            </a>
            ...
            <div class=" w-full overflow-x-auto   overflow-hidden">
                    ...
                    <div
                        ...
                        <div class=" flex gap-3">
                            <a href="javascript:void(0)" onclick="openModal()"
                                class="p-2 rounded-10 uppercase text-sm btn-primary">
                ...
                <div class="bg-white dark:bg-bg3 box shadow-md mt-5 rounded-10 overflow-hidden">
                    ...
                    <div class="flex items-center justify-between rounded-10 bg-secondary/5 text-black px-4 py-3 cursor-pointer"
                        ...
                        <a href="{{ route('business.uploadDocuments', $goldLoan->id) }}"
                                        ...
                                        @foreach ($documents as $doc)
                                            <tr class="border-b text-center">
                                                ...
                                                <td class="px-4 text-start py-2">
                                                    ...
                                                    <form action="{{ route('business.documents.destroy', $doc->id) }}"
                ...
                bg-secondary/5 rounded-10 text-lg cursor-pointer"
                    ...
                    <div x-show="open" x-transition class="p-4 bg-white dark:bg-bg3">
                        ...
                        <div class="w-full flex items-center justify-center gap-4 mt-4">
                            ...
                            <!-- Add Comment -->
                            <a href="{{ route('bussiness.addComment', $goldLoan->id) }}"
                            ...
                            @if ($comments->isNotEmpty())
                                <a class="btn-primary rounded-10 py-2"
                                    href="{{ route('bussiness.addComment', $goldLoan->id) }}">
                                    VIEW ALL
                                </a>
                            @endif
                                ...
                                @forelse($currentStatement as $row)
                                    <tr class="border-b">
                                        <td class="p-2 text-start border">
                                            {{ Carbon::parse($row->date)->format('d/m/Y h:i A') }}</td>
