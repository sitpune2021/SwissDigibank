...
@section('content')
    ...
    <div class="main-inner">
        ...
        <div class="flex flex-wrap gap-3">
            <a href="{{ route('personal.account.transaction', $goldLoan->id) }}"
            ...
            @if (strtolower($goldLoan->scheme->gold_loan_setting) != 'no_emi')
                ...
                @if (strtolower($goldLoan->scheme->gold_loan_setting) == 'flat_advanced_interest')
                    <a href="{{ route('personal.account.extension', $goldLoan->id) }}"
            ...
            <a href="{{ route('personal.account.fourcloser', $goldLoan->id) }}"
                class="btn-error uppercase px-2 py-2 rounded-10 ">
                Fore CloseLoan
            </a>

            <a href="{{ route('personal.account.linksaving', $goldLoan->id) }}"
                class="btn-primary uppercase px-2 py-2 rounded-10 ">
            ...
            <form id="remove-account-form-{{ $goldLoan->id }}" action="{{ route('personal.remove', $goldLoan->id) }}"
                ...
                bg-secondary/5 rounded-10 text-lg cursor-pointer"
                    ...
                    <div x-show="open" x-transition class="p-4 bg-white dark:bg-bg3">
                        ...
                        <div class="w-full flex items-center justify-center gap-4 mt-4">
                            ...
                            <!-- Add Comment -->
                            <a href="{{ route('personal.addComment', $goldLoan->id) }}"
                            ...
                            @if ($comments->isNotEmpty())
                                <a class="btn-primary rounded-10 py-2"
                                    href="{{ route('personal.addComment', $goldLoan->id) }}">
                                    VIEW ALL
                                </a>
                            @endif
