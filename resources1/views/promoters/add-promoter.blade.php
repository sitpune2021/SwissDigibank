        ...
        <form id="companyForm" action="{{route('add.promotor')}}" method="POST" class="grid grid-cols-2 gap-4 xxxl:gap-6 max-w-screen-md mx-auto">
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <div class="relative bg-secondary/5 py-3 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl">
                        <input name="enrollment_date" id="date2" value="{{ old('enrollment_date') }}" class="border-none" placeholder="Select Date" class="w-full text-sm border px-3 py-2" autocomplete="off" />
                        <i
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    ...
                    class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter first name">
                    @error('first_name')
                    <span class="text-red-500 text-xs">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input name="middle_name" id="middle_name" value="{{ old('middle_name') }}"
                    class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter middle name">
                    @error('middle_name')
                    <span class="text-red-500 text-xs">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    ...
                    class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter last name">
                    @error('lastname')
                    <span class="text-red-500 text-xs">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <div class="relative bg-secondary/5 py-3 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl">
                        <input name="dob" id="date" class="border-none" value="{{ old('dob') }}"
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="father_name" id="father_name" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" 
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    ...
                    class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter mother name" 
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                     <input type="hidden" id="oldReligion" value="{{ old('member_religion') }}">
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    ...
                    class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter Spouse" 
                    value="{{ old('spouse') }}">
                    @error('spouse')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    ...
                    class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter branch landline no"
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    ...
                    placeholder="Enter Aadhaar No" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ old('aadhaar_no') }}">
                    @error('aadhaar_no')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
