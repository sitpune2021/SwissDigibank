<div class="flex items-center relative">
    <input type="checkbox" id="@label" name="A3-confirmation" class="opacity-0 absolute h-8 w-8" />
    <div
    ...
    <label for="@label" class="select-none text-sm md:text-base flex gap-2 cursor-pointer items-center">
        @label
    </label>
</div><?php /**PATH C:\xampp\htdocs\swiss_bank\resources\views\partials\_checkbox.blade.php ENDPATH**/ ?>