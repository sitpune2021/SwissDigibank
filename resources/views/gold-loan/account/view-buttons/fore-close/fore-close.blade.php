...
<div class="main-inner">
    ...
    <div class="rounded-lg border-l-4 border-yellow-500  p-2">
        <a href="" class="btn-primary rounded-10 text-sm">
    ...
    <div class="flex flex-col dark:bg-bg3 lg:flex-row justify-between mt-7 gap-5">
        ...
        <div class=" w-full  overflow-hidden">
            <div class="box dark:bg-bg3 border mb-4 border-gray-200 shadow-md rounded-lg">
                <form action="{{ route('gold-loan.account.forecloser.store', $goldLoan->id) }}" method="POST">
                @csrf
                    <!-- Header -->
                    <div class="px-4 py-3 ">
                ...
                <div class="overflow-x-auto p-4 hidden">
                    <table class="w-full text-sm whitespace-nowrap text-gray-700 rounded-md">
                        <tbody>
                            ...
                            <tr class="border-b border-gray-200">
                                <td class="font-semibold px-3 uppercase py-2">Open Date</td>
                                <td class="px-3 py-2">{{ \Carbon\Carbon::now()->format('d-m-Y') }}</td>
                            </tr>

                            <tr class="border-b border-gray-200">
                                <td class="font-semibold px-3 uppercase py-2">Scheme</td>
                                <td class="px-3 py-2">{{ $goldLoan->scheme->scheme_name }}</td>
                            </tr>

                            <tr class="border-b border-gray-200">
                                <td class="font-semibold px-3 uppercase py-2">Loan Amount</td>
                                <td class="px-3 py-2">₹ {{ number_format($goldLoan->loan_amount, 2) }}</td>
                            </tr>

                            <tr class="border-b border-gray-200">
                                <td class="font-semibold px-3 uppercase py-2">Current Debt</td>
                            ...
                            <tr class="border-b border-gray-200">
                                <td class="font-semibold px-3 uppercase py-2">Interest Type</td>
                                <td class="px-3 py-2">{{ ucfirst($goldLoan->scheme->gold_loan_setting) }}</td>
                            </tr>

                            <tr class="border-b border-gray-200">
                                <td class="font-semibold px-3 uppercase py-2">Tenure</td>
                                <td class="px-3 py-2">{{ $goldLoan->scheme->tenure }} MONTHS</td>
                            </tr>

                            <tr class="border-b border-gray-200">
                                <td class="font-semibold px-3 uppercase py-2">Status</td>
                                <td class="px-3 py-2">
                ...
                <div class="p-4" id="SecurityDeposits">
                   <table class="w-full text-sm whitespace-nowrap text-gray-700 rounded-md">
                        <tbody>
                            ...
                            <tr class="border-b border-gray-200">
                                <td class="font-semibold px-3  uppercase py-2">PAID</td>
