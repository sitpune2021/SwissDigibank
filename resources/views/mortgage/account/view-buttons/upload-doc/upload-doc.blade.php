...
<div class="main-inner">
    ...
    <div class="mb-4 flex flex-wrap items-center justify-between gap-4 lg:mb-4">
        <div class="flex items-start flex-col gap-2">
            <h3 class="uppercase font-semibold">Upload Gold Loan Account Documents</h3>
            <p class="text-gray-500">
                <a href="#" class="text-gray-500 text-sm">Gold Loan Accounts  </a> >
                <a href="#" class="text-gray-500 text-sm">00063 </a>>
                <a href="#" class="text-gray-500 text-sm"> Documents </a>
            </p>
        </div>
    </div>
<div class="box">
