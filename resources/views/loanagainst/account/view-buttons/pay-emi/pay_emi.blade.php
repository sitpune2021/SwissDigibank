    ...
    <div class="flex flex-col dark:bg-bg3 lg:flex-row justify-between mt-7 gap-5">
        ...
        <div class="w-full overflow-hidden">
            <div class="box dark:bg-bg3 border mb-4 border-gray-200 shadow-md rounded-lg">
                <form action="{{ route('loanagainst.payEmiLoan', $goldLoan->id) }}" method="POST" enctype="multipart/form-data">
                    <!-- Header -->
                    @csrf
                    <div class="px-2 py-3">
                                ...
                                <tr class="">
                                    ...
                                    <td class="px-2 py-2 ">
                                        <input type="text" name="totalAmount" id="totalAmount" value="{{ $totalOverdueWithGst ?? 0 }}" placeholder="0.0"
                                            class="w-full px-2 py-2 text-center border bg-secondary/5  rounded-10 text-sm md:text-base" />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="flex flex-col min-w-10 sm:flex-row justify-center gap-3 mt-5">
                        ...
                        <button class="btn-outline uppercase justify-center" type="reset">
                            <a href="{{ route('loanagainst.account.show', $goldLoan->id) }}"> BACK</a>
                        </button>
                    </div>
                </form>
            </div>
        ...
        <div class="w-full">
            ...
            <div class="box bg-white dark:bg-bg3 border shadow-md rounded-lg mb-4">
                ...
                <div class="flex justify-between items-center px-4 py-2 bg-secondary/5 text-black rounded-10">
                    <h3 class="text-black font-semibold text-lg">LOAN AGAINST DEPOSITE ACCOUNT INFO</h3>
