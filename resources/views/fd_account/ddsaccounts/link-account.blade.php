                            ...
                            <div class="flex gap-3 items-center">
                                <select name="saving_account_id"
                                    ...
                                    @foreach ($savingAccounts as $acc)
                                        <option value="{{ $acc->id }}">
                                            {{ $acc->account_no }} - {{ $acc->firm_name ?? ($acc->member?->full_name ?? '') }}
                                        </option>
                                    @endforeach
                            ...
                            <table class="w-full whitespace-nowrap text-sm">
                                <tbody class="divide-y divide-gray-200">
                                    ...
                                    <tr class="border-b">
                                        ...
                                        <td class="py-2">{{ $ddaccount->member->member_info_father_name ?? 'N/A' }}</td>
                                    </tr>

                                    <tr class="border-b">
                                        <td class="font-semibold uppercase py-2">Occupation</td>
                                        <td class="py-2">{{ $ddaccount->member->member_info_occupation ?? 'N/A' }}</td>
                                    </tr>
