                    ...
                    <div class="w-full col-span-12 px-3 py-2 bg-secondary/5  rounded-10 lg:col-span-12">
                        <div class="grid grid-cols-2 gap-4 mt-6 xl:mt-8 xxxxxl:gap-6">
                            ...
                            <div class="col-span-2 md:col-span-1">
                                ...
                                <select name="securety_type"
                                    class="w-full text-sm bg-secondary/5 dark:bg-bg3 border rounded-10 px-3 md:px-6 py-2 md:py-3 capitalize">
                                    <option value="">Please Select</option>
                                    <option value="fd_to_self"
                                        {{ old('securety_type', $application->securety_type ?? '') == 'fd_to_self' ? 'selected' : '' }}>
                                        FD TO SELF</option>
                                    <option value="rd_to_self"
                                        {{ old('securety_type', $application->securety_type ?? '') == 'rd_to_self' ? 'selected' : '' }}>
                                        RD TO SELF</option>
                                    <option value="dd_to_self"
                                        {{ old('securety_type', $application->securety_type ?? '') == 'dd_to_self' ? 'selected' : '' }}>
                                        DD TO SELF</option>
                                    <option value="fd_bank"
                                        {{ old('securety_type', $application->securety_type ?? '') == 'fd_bank' ? 'selected' : '' }}>
                                        FD BANK</option>
                                    <option value="rd_bank"
                                        {{ old('securety_type', $application->securety_type ?? '') == 'rd_bank' ? 'selected' : '' }}>
                                        RD BANK</option>
                                    <option value="lic"
                                        {{ old('securety_type', $application->securety_type ?? '') == 'lic' ? 'selected' : '' }}>
                                        LIC</option>
                                    <option value="nsc"
                                        {{ old('securety_type', $application->securety_type ?? '') == 'nsc' ? 'selected' : '' }}>
                                        NSC</option>
                                    <option value="other_government_security"
                                        {{ old('securety_type', $application->securety_type ?? '') == 'other_government_security' ? 'selected' : '' }}>
                                        OTHER GOVERNMENT SECURITY</option>
                                </select>
                                @error('securety_type')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="col-span-2 md:col-span-1">
                                ...
                                <input type="number" id="security_amount" name="security_amount"
                                    ...
                                    placeholder="0"
                                    value="{{ old('security_amount', $application->security_amount ?? 0) }}">
                                ...
                                <div class="overflow-x-auto">
                                    <table class="w-full text-sm text-left">
                                        <tbody>
                                            ...
                                            <tr class="border-b">
                                                <td class="font-semibold uppercase py-2 pr-4">Maximum Loan Limit Against
                                                    Security</td>
