...
<div class="main-inner">
    ...
    <div class="flex flex-wrap gap-3">
        <a href="{{route('loanagainst.account.transaction',$goldLoan->id)}}" class="btn-secondary uppercase text-sm px-2 py-2 rounded-10 ">
            View Transaction
        </a>
        @if(
            ...
            <a href="{{route('loanagainst.account.pay-emi',$goldLoan->id)}}" class="btn-primary uppercase text-sm px-2 py-2 rounded-10 ">
                Pay Emi
            </a>
            @if(strtolower($goldLoan->scheme->gold_loan_setting) == 'flat_advanced_interest')
                <a href="{{ route('loanagainst.account.extension',$goldLoan->id) }}" class="btn-error uppercase text-sm px-2 py-2 rounded-10 ">
                    LOAN EXTENSION
                </a>
            @endif
        ...
        @if(
            ...
            <a href="{{ route('loanagainst.account.pay', $goldLoan->id) }}"
            class="btn-primary uppercase px-2 py-2  text-sm rounded-10">
                Pay
            </a>
        @endif  

        <a href="{{ route('loanagainst.account.fourcloser', $goldLoan->id) }}" class="btn-error uppercase text-sm px-2 py-2 rounded-10 ">
            Fore CloseLoan
        </a>
        
        <a href="{{ route('loanagainst.account.linksaving', $goldLoan->id) }}" class="btn-primary uppercase text-sm px-2 py-2 rounded-10 ">
            link saving account(Auto Debit)
        </a>

        <div class="relative inline-block text-left">
            <!-- Button -->
            <button type="button" class="btn-secondary uppercase px-2 py-2 rounded-10 text-sm flex items-center gap-2"
            ...
            <div id="debitCharges"
                ...
                <div class="py-1">
                    <a href="{{route('loanagainst.debitChargesList.list',$goldLoan->id)}}"
                        class="flex items-center uppercase gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                        Other Charges List
                    </a>
                    <a href="{{route('loanagainst.debitOtherCharges.form',$goldLoan->id)}}"
                        class="flex items-center uppercase gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                        Debit Other Charges
                    </a>
                    <a href="{{route('loanagainst.clear-due.form',$goldLoan->id)}}"
                        class="flex items-center uppercase gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                        Clear Dues
                    </a>
                </div>
        ...
        <form id="remove-account-form-{{ $goldLoan->id }}" action="{{ route('loanagainst.remove', $goldLoan->id) }}" method="POST" class="inline">
            @csrf
        ...
        <div class="relative inline-block text-left">
            <!-- Button -->
            <button type="button" class="btn-secondary px-2 py-2 rounded-10 text-sm flex items-center gap-2"
        ...
        <a href="{{ route('loanagainst.account.audit-trail') }}" class="btn-primary uppercase text-sm  px-2 py-2 rounded-10 ">
            Show audit trail
        </a>
    ...
    <div class="flex flex-col dark:bg-bg3 lg:flex-row justify-between mt-7 gap-5">
        ...
        <div class=" w-full overflow-x-auto   overflow-hidden">
            ...
            <div class="box shadow-md mt-5 dark:bg-bg3 dark:border-lightbg1 rounded-lg overflow-hidden">
                ...
                <div class="border-b flex items-center bg-secondary/5 text-black justify-between px-4 py-2 rounded-10 ">
                    ...
                    <div class=" flex gap-3">
                        <a href="javascript:void(0)" onclick="openModal()" class="p-2 rounded-10 uppercase btn-primary">
            ...
            <div class="box shadow-md mt-5 dark:bg-bg3 dark:border-lightbg1 rounded-lg overflow-hidden">
                <div class="border-b flex items-center bg-secondary/5 text-black justify-between px-4 py-2 rounded-10 ">
                    <h3 class="text-lg font-semibold uppercase text-black  capitalize">ALLOCATED PASSBOOK
                    </h3>
                    <div class=" flex gap-3">
                        <a href="" class="p-2 rounded-10 uppercase btn-primary">
            ...
            <div class="flex flex-row gap-4 dark:bg-bg3 rounded-10">
                <div class="w-full box dark:bg-bg3 p-2 rounded-10 shadow-md border border-gray-200">
                    <div class="flex justify-center gap-2  border-gray-200 px-4 py-3 bg-gray-50 rounded-t-2xl border-b">
                        ...
                        <h3 class="font-semibold uppercase text-center sm:text-lg">
                            ...
                            <table class="min-w-full border-collapse whitespace-nowrap text-sm text-center">
                                <thead class="bg-gray-100">
                                    <tr class="bg-secondary/5">
                                        <th class="px-4 uppercase py-2"></th>
                                        <th class="px-4 uppercase py-2">NET P.</th>
                                        <th class="px-4 uppercase py-2">EMI P.</th>
                                        <th class="px-4 uppercase py-2">EMI INT.</th>
                                        <th class="px-4 uppercase py-2">EMI CHRGS.</th>
                                        <th class="px-4 uppercase py-2">OVERDUE INT.</th>
                                        <th class="px-4 uppercase py-2">OTHER CHRGS.</th>
                                        <th class="px-4 uppercase py-2">ADV. AMOUNT</th>
                                        <th class="px-4 uppercase py-2">DISCOUNT</th>
                                    </tr>
                                </thead>
                                <tbody>
            ...
            <div class="box dark:bg-bg3 shadow-md mt-5 rounded-lg overflow-hidden">
                ...
                <div class="overflow-x-auto mt-2 " id="Guarantor">
                    <form action="" class="mt-1    ">
                        <label for="" class="block mb-2 font-semibold uppercase">Branch</label>
                        <div class="col-sm-7">
                            <div class="flex items-center gap-2">
                    ...
                    <form action="" class="mt-1  ">
                        <label for="" class="block mb-2 font-semibold uppercase">Advisor/ Staff</label>
                        <div class="col-sm-7">
                            <div class="flex items-center gap-2">
                                <select id="bonus-rate" name="bonus_rate_value"
                                    class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-2 md:py-3"
                    ...
                    <form action="" class="mt-1   ">
                        <label for="" class="block mb-2 font-semibold uppercase">Guarantor 1</label>
                        <div class="col-sm-7">
                            <div class="flex items-center gap-2">
                                <select id="bonus-rate" name="bonus_rate_value"
                                    class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-2 md:py-3"
                    ...
                    <form action="" class="mt-1 ">
                        <label for="" class="block mb-2 font-semibold uppercase">Guarantor 2</label>
                        <div class="col-sm-7">
                            <div class="flex items-center gap-2">
                                <select id="bonus-rate" name="bonus_rate_value"
                                    class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-2 md:py-3"
                    ...
                    <form action="" class="mt-1 ">
                        <label for="" class="block mb-2 font-semibold uppercase">Guarantor 3</label>
                        <div class="col-sm-7">
                            <div class="flex items-center gap-2">
                                <select id="bonus-rate" name="bonus_rate_value"
                                    class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-2 md:py-3"
                    ...
                    <form action="" class="mt-1 ">
                        <label for="" class="block mb-2 font-semibold uppercase">Guarantor 4</label>
                        <div class="col-sm-7">
                            <div class="flex items-center gap-2">
                                <select id="bonus-rate" name="bonus_rate_value"
                                    class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-2 md:py-3"
                ...
                <div class="overflow-x-auto">
                    ...
                    <table class="w-full border-collapse whitespace-nowrap  text-sm" id="emiTable">
                        ...
                        <thead class="bg-secondary/5">
                            <tr>
                                <th class="p-2 uppercase border ">EMI No.</th>
                                <th class="p-2 uppercase border ">EMI DATE</th>
                                <th class="p-2 uppercase border ">EMI DUE DATE</th>
                                <th class="p-2 uppercase border ">PRINCIPAL</th>
                                <th class="p-2 uppercase border ">INTEREST</th>
                                <th class="p-2 uppercase border ">OTHER CHRG.</th>
                                <th class="p-2 uppercase border ">EMI</th>
                                <th class="p-2 uppercase border ">BAL. PRINCIPAL</th>
                                <th class="p-2 uppercase border ">REMAINING AMT</th>
                                <th class="p-2 uppercase border ">PAID DATE</th>
                                <th class="p-2 uppercase border ">STATUS</th>
                                <th class="p-2 uppercase border ">PROCESSED</th>
                                <th class="p-2 uppercase border ">ACTIONS</th>
                            </tr>
                        </thead>
                    ...
                    <table class="w-full border-collapse whitespace-nowrap  text-sm">
                        ...
                        <tbody>
                            @forelse($currentStatement as $row)
                                <tr class="border-b">
                                    <td class="p-2 border">{{ Carbon::parse($row->date)->format('d/m/Y h:i A') }}</td>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    processButtons.forEach(btn => {
        btn.addEventListener("click", function () {
            ...
            fetch("{{ route('loanagainst.emi.saveEmiStatus') }}", {
                method: "POST",
                headers: {
