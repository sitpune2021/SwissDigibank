        ...
        <div class="flex flex-col dark:bg-bg3 lg:flex-row justify-between mt-7 gap-5">
            ...
            <div class="w-full overflow-hidden">
                <div class="box dark:bg-bg3 border mb-4 border-gray-200 shadow-md rounded-lg">
                    <form action="{{ route('bussiness.payEmi') }}" method="POST">
                        @csrf
                        ...
                        <div class="col-span-2 md:col-span-1">
                            ...
                            <input type="text" id="current_debt" name="current_debt" readonly
                                value="{{ $currentDebt ?? 0 }}"
                        ...
                        <div class="col-span-2 md:col-span-1">
                            ...
                            <input type="number" id="amount_collected" name="amount_collected" step="0.01"
                                min="0"
                                value="{{ old('amount_collected', number_format($payableAmount ?? 0, 2, '.', '')) }}"
                                class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-10 px-3 md:px-6 py-2 md:py-3"
                                placeholder="0.00">

                            <x-number-to-word for="amount_collected" />
            ...
            <div class="w-full">
                <div class="box bg-white dark:bg-bg3 border shadow-md rounded-lg mb-4">
                    ...
                    <div class="flex justify-between items-center px-4 py-2 bg-secondary/5 text-black rounded-10">
                        <h3 class="text-black font-semibold text-lg">BUSINESS LOAN ACCOUNT INFO</h3>
                        <!-- Toggle Button -->
