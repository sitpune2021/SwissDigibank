    ...
    <div class="form-container">
        ...
        <table>
            <tr>
                ...
                <td colspan="2"></td>
                <td>Account No : </td>
                <td style=" border: 1px solid #000; vertical-align: top;">{{$account->dd_no ??''}}</td>
            </tr>
            <tr>
                <td><label style="display:flex; align-items:center;"><input type="checkbox" style="width: 20px; height: 20px;">: RD</label></td>
                <td><label style="display:flex; align-items:center;"><input type="checkbox" style="width: 20px; height: 20px;"checked>: DD</label></td>
