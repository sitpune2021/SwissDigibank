    ...
    <div class="box mb-4 xxxl:mb-6">
        <!-- <form action="{{route('add.promotor')}}" method="POST" class="grid grid-cols-2 gap-4 xxxl:gap-6">
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="first_name" id="first_name" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter first name" value="">
                    @error('first_name')
                    <span class="text-red-500 text-xs">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input name="middle_name" id="middle_name" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter middle name">
                    @error('middle_name')
                    <span class="text-red-500 text-xs">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="lastname" id="lastname" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter last name" value="">
                    @error('lastname')
                    <span class="text-red-500 text-xs">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="voter_no" id="voter_no" placeholder="Enter Voter ID No" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ old('voter_no') }}">
                    @error('voter_no')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="ration_no" id="ration_no" placeholder="Enter Ration Card No" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ old('ration_no') }}">
                    @error('ration_no')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="meter_no" id="meter_no" placeholder="Enter Meter No." class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ old('meter_no') }}">
                    @error('meter_no')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="ci_no" id="ci_no" placeholder="Enter CI No." class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ old('ci_no') }}">
                    @error('ci_no')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="ci_relation" id="ci_relation" placeholder="Enter CI Relation." class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ old('ci_relation') }}">
                    @error('ci_relation')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="dl_no" id="dl_no" placeholder="Enter DL No." class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ old('dl_no') }}">
                    @error('dl_no')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="nomine_name" id="nomine_name" placeholder="Enter Nominee Name" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ old('nomine_name') }}">
                    @error('nomine_name')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="nomine_relation" id="nomine_relation" placeholder="Enter Nominee Relation" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ old('nomine_relation') }}">
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="nomine_mobile" id="nomine_mobile" placeholder="Enter Nominee Mobile" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ old('nomine_mobile') }}">
                    @error('nomine_mobile')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="nomine_aadhar" id="nomine_aadhar" placeholder="Enter Nominee Aadhar No." class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ old('nomine_aadhar') }}">
                    @error('nomine_aadhar')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="nomine_voter" id="nomine_voter" placeholder="Enter Nominee Voter ID No." class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ old('nomine_voter') }}">
                    @error('nomine_voter')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="nomine_pan" id="nomine_pan" placeholder="Enter Nominee Pan No." class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ old('nomine_pan') }}">
                    @error('nomine_pan')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" name="nomine_address" id="nomine_address" placeholder="Enter Nominee Address" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" value="{{ old('nomine_address') }}">
        ...
        <form action="{{route('add.promotor')}}" method="POST" class="grid grid-cols-2 gap-4 xxxl:gap-6 max-w-screen-md mx-auto">
            @csrf
            <div class="flex items-start gap-1">
                <label for="branch" class="w-30 text-sm font-medium">Branch<span class="text-red-500">*</span></label>
                <div class="w-full">
                    <input type="hidden" id="oldState" value="{{ old('branch') }}">
                    <select name="branch" id="branchDropdown" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3">
                        <!-- <option value="">Select Branch</option> -->
                    </select>
                    @error('branch')
            ...
            <div class="flex items-start gap-1">
                <label for="enrollment_date" class="w-30 text-sm font-medium">Enrollment Date<span class="text-red-500">*</span></label>
                <div class="w-full">
                    <div class="relative bg-secondary/5 py-3 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl">
                        <input name="enrollment_date"
                            value="{{ old('enrollment_date') }}"
                            id="date2" class="border-none" placeholder="Select Date" class="w-50 text-sm border px-3 py-2" autocomplete="off" />
                        <i
                            class="las la-calendar absolute ltr:right-4 rtl:left-4 top-1/2 -translate-y-1/2 cursor-pointer"></i>
                    </div>
                    @error('enrollment_date')
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text"
                        ...
                        name="first_name" id="first_name" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter first name">
                    @error('first_name')
                    <span class="text-red-500 text-xs">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input name="middle_name" value="{{ old('middle_name') }}"
                        id="middle_name" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter middle name">
                    @error('middle_name')
                    <span class="text-red-500 text-xs">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" value="{{ old('lastname') }}"
                        name="lastname" id="lastname" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter last name">
                    @error('lastname')
                    <span class="text-red-500 text-xs">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="w-full">
                    <div class="relative bg-secondary/5 py-3 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl">
                        <input name="dob" value="{{ old('dob') }}"
                            id="date" class="border-none" placeholder="Select Date" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" autocomplete="off" />
                        <i
                            class="las la-calendar absolute ltr:right-4 rtl:left-4 top-1/2 -translate-y-1/2 cursor-pointer"></i>
                    </div>
                    @error('dob')
            ...
            <div class="flex items-start gap-4">
                <label for="occupation" class="w-48 text-sm font-medium">Occupation<span class="text-red-500">*</span></label>
                <div class="w-full">
                    <input type="text" value="{{ old('occupation') }}"
                        name="occupation" id="occupation" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter occupation">
                    @error('occupation')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" value="{{ old('father_name') }}"
                        name="father_name" id="father_name" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter father name">
                    @error('father_name')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" value="{{ old('mother_name') }}"
                        name="mother_name" id="mother_name" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter mother name">
                    @error('mother_name')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                <label for="mariatal_status" class="w-48 text-sm font-medium">Marital Status</label>
                <div class="w-full">
                    <input type="hidden" id="oldMariatalStatus" value="{{ old('mariatal_status') }}">
                    <select name="mariatal_status" id="mariatal_status" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3">
                        <!-- <option value="">Select Mariatal Status</option> -->
                    </select>
                    @error('mariatal_status')
            ...
            <div class="flex items-start gap-4">
                <label for="member_religion" class="w-48 text-sm font-medium">Member Religion</label>
                <div class="w-full"><input type="hidden" id="oldReligion" value="{{ old('member_religion') }}">
                    <select name="member_religion" value="{{ old('member_religion') }}"
                        id="member_religion" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3">
                        <!-- <option value="">Select Member Religion</option> -->
                    </select>
                    @error('member_religion')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
            ...
            <div class="flex items-start gap-4">
                <label for="spouse" class="w-48 text-sm font-medium">Husband/ Wife Name</label>
                <div class="w-full">
                    <input type="text" value="{{ old('spouse') }}"
                        name="spouse" id="spouse" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter Spouse">
                    @error('spouse')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                <label for="landline_no" class="w-48 text-sm font-medium">Landline No.</label>
                <div class="w-full">
                    <input type="text" value="{{ old('landline_no') }}"
                        name="landline_no" id="landline_no" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter branch landline no">
                    @error('landline_no')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text" value="{{ old('email') }}"
                        name="email" id="email"
                        placeholder="Enter Email" class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3">
                    @error('email')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full">
                    <input type="text"
                        ...
                        class="w-full text-sm bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3" placeholder="Enter mobile no" value="{{ old('mobile_no') }}">
                    @error('mobile_no')
                    <span class="text-red-500 text-xs ml-52 block">{{ $message }}</span>
                    @enderror
                </div>
